...
function f_submit_miner_conf() {
	...
	jQuery.ajax({
		...
		timeout: 30000,
		cache: false,
		data: {_ant_pool1url:_ant_pool1url,_ant_pool1user:_ant_pool1user, _ant_pool1pw:_ant_pool1pw,_ant_pool2url:_ant_pool2url, _ant_pool2user:_ant_pool2user,
			_ant_pool2pw:_ant_pool2pw,_ant_pool3url:_ant_pool3url, _ant_pool3user:_ant_pool3user, _ant_pool3pw:_ant_pool3pw, _ant_nobeeper:_ant_nobeeper, _ant_notempoverctrl:_ant_notempoverctrl,
			_ant_fan_customize_switch:_ant_fan_customize_switch,_ant_fan_customize_value:_ant_fan_customize_value, _ant_freq:_ant_freq,_ant_voltage:_ant_voltage
		},
...
<option value="805"> 805M </option>
<option value="810"> 810M </option>
<option value="815"> 815M </option>
<option value="825"> 825M </option>
						...
						<div class="cbi-value" id="cbi-cgminer-default-vol">
							<label class="cbi-value-title" for="cbid.cgminer.default.vol">Voltage</label>
							<div class="cbi-value-field">
	                            <select id="ant_voltage" class="cbi-input-text">
		                            <option value="700"> 0.70V </option>
		                            <option value="710"> 0.71V </option>
		                            <option value="720"> 0.72V </option>
		                            <option value="730"> 0.73V </option>
		                            <option value="740"> 0.74V </option>
		                            <option value="750"> 0.75V </option>
		                            <option value="760"> 0.76V </option>
		                            <option value="770"> 0.77V </option>
		                            <option value="780"> 0.78V </option>
		                            <option value="790"> 0.79V </option>
		                            <option value="800"> 0.80V </option>
								</select>
							</div>
						</div>
	...
	<div style="text-align: center; bottom: 0; left: 0; height: 1.5em; font-size: 80%; margin: 0; padding: 5px 0px 2px 8px; background-color: #918ca0; width: 100%;">
		<font style="color:#fff;">Copyright &copy; 2013-2021, Bitmain Technologies</font>
	</div>
</body>
</html>
EOT
