...

{
  ...
  __libc_start_main(FUN_0001373c,in_stack_00000000,&stack0x00000004,0x13b21,&DAT_00013b5d,param_1);
...
undefined4 FUN_00010c70(void *param_1,size_t param_2,uchar *param_3,void *param_4)
...
undefined4 FUN_00010de8(FILE *param_1,int param_2,undefined4 *param_3,undefined1 param_4,char param_5,char param_6)
...

{
  ...
  return CONCAT44(param_2 >> (param_3 & 0xff) |
                  param_2 << uVar1 | param_1 << (uVar1 - 0x20 & 0xff) | param_1 >> (0x20 - uVar1 & 0xff),
...
undefined8 FUN_00011598(uint param_1,uint param_2,uint param_3,uint param_4,uint param_5,int param_6)

{
  ...
  uVar2 = (param_1 ^ param_3) * param_6 + (param_2 ^ param_4) * param_5 + (int)((ulonglong)lVar1 >> 0x20);
  param_3 = param_3 ^ (uint)lVar1 ^ uVar2 >> 0xf;
  lVar1 = (ulonglong)param_3 * (ulonglong)param_5;
  uVar2 = param_3 * param_6 + (param_4 ^ uVar2) * param_5 + (int)((ulonglong)lVar1 >> 0x20);
...

{
  ...
  if (param_2 < 8) {
    if (param_2 < 4) {
      ...
      lVar6 = FUN_00011598(param_2 + uVar2 * 8,(uVar2 >> 0x1d) + (uint)CARRY4(param_2,uVar2 * 8),uVar3,0,
    ...
    lVar6 = FUN_00011598((int)lVar8,(int)((ulonglong)lVar8 >> 0x20),(int)lVar1,(int)((ulonglong)lVar1 >> 0x20),iVar5,
                         iVar4);
  }
  return lVar6;
}
...

{
  ...
  lVar5 = FUN_00011514((int)(lVar5 + -0x651e95c4d06fbfb1),(int)((ulonglong)(lVar5 + -0x651e95c4d06fbfb1) >> 0x20),0x12);
  lVar6 = lVar6 + lVar5 + lVar4 * -0x4b6d499041670d8d;
  uVar1 = FUN_00011598((int)lVar8,(int)((ulonglong)lVar8 >> 0x20),(int)lVar6,(int)((ulonglong)lVar6 >> 0x20),iVar2,iVar3
                      );
  return uVar1;
}
...

{
  ...
  lVar9 = FUN_00011514((int)(lVar5 + lVar6),(int)((ulonglong)(lVar5 + lVar6) >> 0x20),0x2b);
  lVar10 = FUN_00011514((int)lVar7,(int)((ulonglong)lVar7 >> 0x20),0x1e);
  lVar8 = lVar8 * -0x651e95c4d06fbfb1 + lVar9 + lVar10;
  lVar6 = FUN_00011514((int)(lVar6 + -0x651e95c4d06fbfb1),(int)((ulonglong)(lVar6 + -0x651e95c4d06fbfb1) >> 0x20),0x12);
  lVar7 = lVar7 + lVar6 + lVar5;
  lVar6 = FUN_00011598((int)lVar8,(int)((ulonglong)lVar8 >> 0x20),(int)lVar7,(int)((ulonglong)lVar7 >> 0x20),iVar3,iVar4
                      );
  ...
  lVar5 = FUN_00011514((int)(lVar10 + lVar5),(int)((ulonglong)(lVar10 + lVar5) >> 0x20),0x12);
  lVar8 = lVar8 + lVar5 + lVar9 * lVar1;
  uVar2 = FUN_00011598((int)lVar7,(int)((ulonglong)lVar7 >> 0x20),(int)lVar8,(int)((ulonglong)lVar8 >> 0x20),iVar3,iVar4
                      );
  return uVar2;
}
...
int * FUN_00011fbc(int *param_1,undefined4 param_2,uint param_3,int param_4,uint param_5,int param_6,uint param_7,
                  int param_8,uint param_9,int param_10,uint param_11,int param_12,uint param_13,int param_14)

{
  ...
  lVar5 = FUN_00011514(param_13 + uVar2 + param_9,
                       param_14 + iVar3 + (uint)CARRY4(param_13,uVar2) + param_10 +
                       (uint)CARRY4(param_13 + uVar2,param_9),0x15);
  uVar4 = uVar2 + param_5 + param_7;
  iVar1 = iVar3 + param_6 + (uint)CARRY4(uVar2,param_5) + param_8 + (uint)CARRY4(uVar2 + param_5,param_7);
...
undefined4
FUN_000120dc(undefined4 param_1,int param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5,undefined4 param_6)

{
  ...
  FUN_00011fbc(param_1,(int)((ulonglong)uVar4 >> 0x20),(int)uVar1,(int)((ulonglong)uVar1 >> 0x20),uVar2,uVar3,uVar4,
...

{
  ...
  if (param_2 < 0x11) {
    ...
    do {
      ...
      lVar12 = FUN_00011514((int)lVar11,(int)((ulonglong)lVar11 >> 0x20),0x25);
      ...
      lVar11 = FUN_00011514((int)lVar12,(int)((ulonglong)lVar12 >> 0x20),0x2a);
      ...
      lVar12 = FUN_00011514((int)lVar12,(int)((ulonglong)lVar12 >> 0x20),0x21);
      local_38 = lVar12 * -0x4b6d499041670d8d;
      FUN_000120dc(&local_60,local_74,(int)((ulonglong)local_58 * 0xbe98f273),
                   iStack_54 * -0x41670d8d + local_58 * -0x4b6d4991 + (int)((ulonglong)local_58 * 0xbe98f273 >> 0x20),
                   local_70 + (uint)local_28,iStack_6c + local_28._4_4_ + (uint)CARRY4(local_70,(uint)local_28));
      iVar3 = local_74 + 0x20;
      lVar12 = local_38 + CONCAT44(uStack_64,local_68);
      lVar11 = FUN_00011490(local_74 + 0x10);
      FUN_000120dc(&local_70,iVar3,(int)lVar12,(int)((ulonglong)lVar12 >> 0x20),lVar11 + local_30);
      uVar6 = (uint)local_38;
    ...
    local_28 = FUN_00011514((int)lVar13,(int)((ulonglong)lVar13 >> 0x20),0x25);
    local_28 = local_28 * CONCAT44(local_4c,local_50);
    lVar11 = local_30 + CONCAT44(iStack_54,local_58);
    lVar12 = FUN_00011490(local_74 + 0x30);
    lVar12 = lVar12 + lVar11;
    lVar12 = FUN_00011514((int)lVar12,(int)((ulonglong)lVar12 >> 0x20),0x2a);
    local_30 = lVar12 * CONCAT44(local_4c,local_50);
    local_28._0_4_ = (uint)local_28 ^ local_68 * 9;
    local_28._4_4_ =
         (uStack_64 << 3 | local_68 >> 0x1d) + uStack_64 + (uint)CARRY4(local_68 * 8,local_68) ^ local_28._4_4_;
    ...
    local_38 = FUN_00011514(local_70 + (uint)local_38,iStack_6c + local_38._4_4_ + (uint)CARRY4(local_70,(uint)local_38)
                            ,0x21);
    local_38 = local_38 * CONCAT44(local_4c,local_50);
    FUN_000120dc(&local_88,local_74,(int)((ulonglong)local_58 * (ulonglong)local_50),
                 iStack_54 * local_50 + local_58 * local_4c + (int)((ulonglong)local_58 * (ulonglong)local_50 >> 0x20),
                 local_70 + (uint)local_28,iStack_6c + local_28._4_4_ + (uint)CARRY4(local_70,(uint)local_28));
    local_60 = local_88;
    iStack_5c = uStack_84;
    local_58 = uStack_80;
    ...
    lVar12 = local_38 + CONCAT44(uStack_64,local_68);
    lVar11 = FUN_00011490(local_74 + 0x10);
    FUN_000120dc(&local_88,iVar3,(int)lVar12,(int)((ulonglong)lVar12 >> 0x20),lVar11 + local_30);
    local_70 = local_88;
    iStack_6c = uStack_84;
    local_68 = uStack_80;
    uStack_64 = uStack_7c;
    ...
    local_28._0_4_ = uVar6;
    local_28._4_4_ = uVar5;
    lVar12 = FUN_00011598(local_60,iStack_5c,local_88,uStack_84,local_50,local_4c);
    ...
    lVar11 = FUN_00011598(local_58,iStack_54,local_68,uStack_64,local_50,local_4c);
    lVar11 = lVar11 + CONCAT44(local_28._4_4_,(uint)local_28);
    uVar10 = FUN_00011598((int)lVar12,(int)((ulonglong)lVar12 >> 0x20),(int)lVar11,(int)((ulonglong)lVar11 >> 0x20),
                          local_50,local_4c);
  }
  return uVar10;
}
...
int FUN_00012c40(char *param_1,char *param_2,char *param_3,char *param_4,char param_5,char param_6,char param_7)
          ...
          if (local_9 == param_4[0x518]) {
            ...
            if (local_14 == local_24) {
              ...
              if (local_3c == (FILE *)0x0) {
                ...
                local_44 = FUN_00010c70(param_4 + 0x18,local_40,param_4 + 0x418,&local_4d0);
                if (local_44 == 0) {
                  if (param_5 != '\0') {
                  ...
                  for (local_1c = 0; local_1c < (int)(uint)local_9; local_1c = local_1c + 1) {
                    ...
                    FUN_00010de8(local_28,local_58,auStack_8f0 + (local_1c + 1) * 0x20,param_4[local_1c * 5 + 0x51d],0,
                                 param_5);
                  }
                  for (local_20 = 0; local_20 < (int)(uint)local_9; local_20 = local_20 + 1) {
                    FUN_00010de8(local_28,0x100,auStack_8f0 + (local_9 + 1 + local_20) * 0x20,
...

{
  ...
  if (param_1 < 2) {
    ...
    case 0x66:
      local_10 = FUN_00012c40(local_190,local_110,local_210,auStack_a10,local_9,local_a,local_b);
    }
  }
  else {
    FUN_000108f8(*param_2);
...
void FUN_00013b20(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
