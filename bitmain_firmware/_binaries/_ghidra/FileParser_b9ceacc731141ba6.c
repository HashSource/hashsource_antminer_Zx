...

{
    ...
    __libc_start_main(&LAB_00010804, in_stack_00000000, &stack0x00000004,
                      0x117b1, &DAT_000117ed, param_1);
...
undefined4 FUN_0001136c(FILE *param_1, int param_2, undefined4 *param_3,
                        undefined4 param_4, char param_5, byte param_6)

{
    ...
    LAB_0001159c:
        ...
        local_49c = CONCAT13(local_49c._3_1_,
                             (int3)((uint) * (undefined4 *)pcVar7 >> 8));
...
LAB_00011424:
    ...
    *param_3 = local_4a8;
    ...
    param_3[3] = local_49c;
    param_3[4] = CONCAT13(
        cStack_495, CONCAT12(uStack_496, CONCAT11(cStack_497, uStack_498)));
    param_3[5] = CONCAT13(
        uStack_491, CONCAT12(uStack_492, CONCAT11(cStack_493, local_494)));
    param_3[6] = CONCAT13(
        cStack_48d, CONCAT12(uStack_48e, CONCAT11(cStack_48f, uStack_490)));
    param_3[7] = local_48c;
    return 0;
}
...
void FUN_000117b0(undefined4 param_1, undefined4 param_2, undefined4 param_3,
                  undefined4 param_4)
