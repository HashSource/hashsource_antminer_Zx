                ...
                if (pcVar12 != (char *)0x0) {
                    while (((&PTR_s_undefined_0000bba0)[iVar6] != (char *)0x0 &&
                            (iVar7 = strcmp(pcVar12,
                                            (&PTR_s_undefined_0000bba0)[iVar6]),
                             iVar7 != 0))) {
                        iVar6 = iVar6 + 1;
                    }
                }
...

{
    ...
    if (param_1 < 0) {
        /* WARNING: Subroutine does not return */
        FUN_0000ae34("fd >= 0",
                     "/home/lzq/work/Zynq7000/rootfs_angstrom/A8_buildenv/"
                     "build/tmp-angstrom_v2013_06-eglibc/work/"
        ...
        LAB_0000a254:
            ...
            LAB_0000a274:
                ...
                LAB_0000a428:
                    ...
                    if (DAT_00016004 < 0)
                        goto LAB_0000a284;
                    __snprintf_chk(acStack_8c, 0x10, 1, 0x10, &DAT_0000d1fc,
                                   param_1);
                    local_7d = 0;
                ...
                LAB_0000a284:
                    ...
                    if (((!bVar17 ||
                        ...
                        __snprintf_chk(acStack_7c, 0x10, 1, 0x10, &DAT_0000d1fc,
                                       param_1);
                        local_6d = 0;
                        _Var9 = getpid();
