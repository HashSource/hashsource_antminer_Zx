// Decompiled: bitmain_axi.ko_cb31a26d91da7a44_debug
...
undefined8 axi_fpga_dev_mmap(undefined4 param_1,int *param_2,undefined4 param_3)

{
  int iVar1;
  uint uVar2;
  
  uVar2 = param_2[9] & 0xffffffc3;
  param_2[10] = param_2[10] | 0x4044000;
  param_2[9] = uVar2;
  iVar1 = remap_pfn_range(param_2,*param_2,0x40000,param_2[1] - *param_2,uVar2,param_2,param_3);
  if (iVar1 != 0) {
...
undefined8 init_module(char *param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar3 = (char *)alloc_chrdev_region(&axi_fpga_dev_num,0,1,"axi_fpga_dev",param_1,param_2,param_3);
  if ((int)pcVar3 < 0) {
    pcVar4 = "alloc axi_fpga_dev fail!\n";
LAB_000100e4:
    printk(pcVar4);
  }
  else {
    ...
    if (p_axi_fpga_dev == 0) {
      ...
      *(undefined1 **)(p_axi_fpga_dev + 0x24) = &__this_module;
      pcVar3 = (char *)cdev_add(iVar2,uVar1,1);
      if (pcVar3 != (char *)0x0) {
        pcVar4 = "add axi_fpga_dev fail!\n";
        goto LAB_000100e4;
      }
      param_1 = pcVar3;
      base_vir_mem_addr = __request_region(&iomem_resource,0x40000000,0x1400,"axi_fpga_vir_mem");
      if (base_vir_mem_addr != 0) {
        ...
        if (base_vir_addr == (undefined4 *)0x0) {
          ...
          if (axi_fpga_class < 0xfffff001) {
            param_1 = "axi_fpga_dev";
            device_create(axi_fpga_class,0,axi_fpga_dev_num,0);
            goto LAB_000101b8;
          }
...
LAB_000101b8:
  return CONCAT44(param_1,pcVar3);
}
