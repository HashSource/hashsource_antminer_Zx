...
LAB_00010b30:
  ...
  if (*pcVar6 == '-') {
    cVar1 = pcVar6[1];
    if (cVar1 == '?') {
      if (pcVar6[2] == '\0') goto LAB_00010b68;
    }
    else if (cVar1 == 'h') {
      if (pcVar6[2] == '\0') goto LAB_00010b68;
      goto LAB_00010a40;
    ...
    if ((cVar1 != 'o') || (pcVar6[2] != '\0')) goto LAB_00010a58;
    DAT_00022080 = 1;
...
LAB_00010a58:
  ...
  if (iVar2 + 1 < param_1) {
    ...
    if ((iVar2 + 2 < param_1) && (pcVar3 = (char *)FUN_00010c70(param_2[iVar2 + 2]), *pcVar3 != '\0')) {
...

{
  ...
  __libc_start_main(main,in_stack_00000000,&stack0x00000004,0x1120d,0x11249,param_1);
...
LAB_00010e40:
              ...
              *pcVar1 = '\0';
              pcVar7 = pcVar1 + 1;
              if (iVar5 == 0) {
                if (pcVar7 == (char *)0x0) goto LAB_00010e60;
              ...
              else if (pcVar7 == (char *)0x0) goto LAB_00010e40;
              printf("   [%s] => %s\n",param_1,pcVar7);
            }
          }
          else {
            pcVar4 = pcVar1 + 1;
            *pcVar1 = '\0';
            if (*param_1 != '\0') goto LAB_00010d80;
          }
          param_1 = pcVar4;
          iVar5 = iVar5 + 1;
        ...
        pcVar6 = pcVar1 + 1;
        *pcVar1 = '\0';
        if (*param_1 != '\0') goto LAB_00010d5c;
      }
      param_1 = pcVar6;
    } while (param_1 != (char *)0x0);
  }
...

{
  ...
  local_38.sa_data._4_2_ = SUB42((uint)*(undefined4 *)*phVar1->h_addr_list >> 0x10,0);
