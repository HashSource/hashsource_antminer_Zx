...
LAB_00010aa6:
    ...
    if (cVar1 == '-') {
      cVar8 = pcVar7[1];
      if ((cVar8 == '?') || (cVar8 == 'h')) {
        if (pcVar7[2] == '\0') goto LAB_000109e8;
        goto LAB_00010a06;
      }
      iVar2 = strcmp(pcVar7,"--help");
      if (iVar2 == 0) goto LAB_000109e8;
LAB_00010a88:
      if ((cVar8 != 'o') || (pcVar7[2] != '\0')) goto LAB_00010a1c;
      DAT_000211b0 = 1;
      if (param_1 == 2) goto LAB_00010aa6;
      iVar2 = 2;
    }
    else {
LAB_00010a06:
...
LAB_00010a1c:
    ...
    if (iVar2 + 1 < param_1) {
      ...
      if ((iVar2 + 2 < param_1) && (pcVar4 = (char *)FUN_00010bcc(param_2[iVar2 + 2]), *pcVar4 != '\0')) {
...

{
  ...
  __libc_start_main(0x109c5,in_stack_00000000,&stack0x00000004,0x10ec5,0x10f05,param_1);
  ...
  do {
    ...
    do {
      ...
      if (pcVar1 == (char *)0x0) {
        ...
        pcVar5 = (char *)0x0;
        pcVar1 = (char *)0x0;
        if (pcVar2 != (char *)0x0) goto LAB_00010c90;
LAB_00010d02:
        if (iVar6 == 0) {
LAB_00010d04:
          pcVar8 = (char *)0x0;
...
LAB_00010d12:
        ...
        *pcVar1 = '\0';
        if (*param_1 != '\0') {
          pcVar2 = strchr(param_1,0x3d);
          pcVar1 = pcVar5;
          if (pcVar2 == (char *)0x0) goto LAB_00010d02;
LAB_00010c90:
          pcVar8 = pcVar2 + 1;
          *pcVar2 = '\0';
          if (iVar6 == 0) {
            pcVar5 = pcVar1;
            if (pcVar8 == (char *)0x0) goto LAB_00010d04;
...
LAB_00010cbe:
          ...
          pcVar5 = pcVar1;
          if (pcVar8 == (char *)0x0) goto LAB_00010d12;
          printf("   [%s] => %s\n",param_1,pcVar8);
        }
      }
      param_1 = pcVar5;
