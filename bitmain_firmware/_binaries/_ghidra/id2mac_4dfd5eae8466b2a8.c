...

{
  ...
  __libc_start_main(FUN_00010438,in_stack_00000000,&stack0x00000004,0x108b1,&DAT_000108ed,param_1);
...

{
  ...
  if (sVar2 == 0) {
    ...
    do {
      pbVar12 = pbVar10 + 1;
      uVar6 = *(uint *)(&DAT_00021040 + ((uint)*pbVar10 ^ uVar6 >> 8) * 4) & 0xffff ^ (uVar6 & 0xff) << 8;
      pbVar10 = pbVar12;
    ...
    do {
      pbVar12 = pbVar10 + 1;
      uVar4 = *(uint *)(&DAT_000108fc + ((uint)*pbVar10 ^ uVar4 >> 0x18) * 4) ^ uVar4 << 8;
      pbVar10 = pbVar12;
    } while (pbVar12 != param_1 + sVar2);
    uVar3 = uVar4 >> 0x18;
    uVar8 = uVar6 >> 8;
  ...
  sprintf(param_2,"%02x:%02x:%02x:%02x:%02x:%02x",uVar6,uVar8,uVar4,uVar11,uVar13,uVar3);
  return;
}
...

{
  ...
  DAT_00021450 = (DAT_00021458 >> 5 | DAT_0002145c << 0x1b) ^ DAT_00021458 ^ uVar6 ^ (uVar6 >> 0x12 | uVar5 << 0xe);
  ...
  DAT_00021458 = uVar2 ^ (uVar2 >> 0x12 | uVar6 << 0xe) ^ DAT_00021450 ^ (DAT_00021450 >> 5 | DAT_00021454 << 0x1b);
...
void FUN_000108b0(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
