...
{
    __libc_start_main(FUN_00008a84, param_2, &stack0x00000004, FUN_00008acc,
                      &DAT_00008b30, param_1);
...

{
    ...
    while (bVar1 = 0 < local_18, local_18 = local_18 + -1, bVar1) {
        local_a =
            (ushort) *
                (undefined4 *)(&DAT_00011130 +
                               ((uint)(local_a >> 8) ^ (uint)*local_14) * 4) ^
            local_a << 8;
        local_14 = local_14 + 1;
    }
    return local_a;
...

{
    ...
    while (bVar1 = local_18 != 0, local_18 = local_18 + -1, bVar1) {
        local_c =
            local_c << 8 ^
            *(uint *)(&DAT_00008b40 + (local_c >> 0x18 ^ (uint)*local_14) * 4);
        local_14 = local_14 + 1;
    }
    return local_c;
}
...

{
    ...
    sprintf(param_2, "%02x:%02x:%02x:%02x:%02x:%02x", local_a & 0xfe,
            (uint)bStack_9, uVar3 & 0xff, uVar3 >> 8 & 0xff,
...

{
    ...
    *param_1 = uVar2;
    ...
    param_1[2] = (uVar2 >> 5 | uVar4 << 0x1b) ^ uVar1 ^ uVar2 ^
                 (uVar1 >> 0x12 | uVar3 << 0xe);
    param_1[3] = uVar4 >> 5 ^ uVar3 ^ uVar4 ^ uVar3 >> 0x12;
    return CONCAT44(uVar4 + param_1[3] + (uint)CARRY4(uVar2, param_1[2]),
                    uVar2 + param_1[2]);
}
...

{
    ...
    if (DAT_00011540 == 0) {
        ...
        } while ((DAT_00011548 == 0 && DAT_0001154c == 0) &&
                 (local_14 = 0, DAT_00011550 == 0 && DAT_00011554 == 0));
        DAT_00011540 = 1;
        local_14 = 0;
    }
...
void FUN_00008acc(undefined4 param_1, undefined4 param_2, undefined4 param_3,
                  undefined4 param_4)
