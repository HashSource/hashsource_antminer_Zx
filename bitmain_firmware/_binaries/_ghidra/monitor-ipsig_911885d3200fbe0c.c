// Decompiled: monitor-ipsig_911885d3200fbe0c
...
{
  __libc_start_main(FUN_00009898,param_2,&stack0x00000004,FUN_0000992c,&DAT_00009990,param_1);
...

{
  ...
  iVar1 = DAT_00011e0c;
  sVar2 = strlen(acStack_78);
  local_14 = sendto(iVar1,acStack_78,sVar2,0,(sockaddr *)&DAT_00011e4c,0x10);
  if (local_14 < 0) {
    printf("send error....");
  }
  else {
...

{
  ...
  sVar1 = sendto(DAT_00011e0c,param_1,10,0,(sockaddr *)&DAT_00011e4c,0x10);
  if (sVar1 < 0) {
    printf("send error....");
    uVar2 = extraout_r3;
  }
...

{
  ...
  fStack_98.fds_bits[iVar1 >> 5] = fStack_98.fds_bits[iVar1 >> 5] | 1 << (DAT_00011e0c % 0x20 & 0xffU);
  local_14 = (char *)0x0;
  local_14 = (char *)calloc(0x1e,1);
  iVar1 = select(DAT_00011e0c + 1,&fStack_98,(fd_set *)0x0,(fd_set *)0x0,&local_a0);
  if (iVar1 != -1) {
    if (iVar1 == 0) {
      ...
      if ((fStack_98.fds_bits[iVar1 >> 5] >> (DAT_00011e0c % 0x20 & 0xffU) & 1U) != 0) {
        local_a4 = 0x10;
        local_18 = recvfrom(DAT_00011e0c,local_14,0x1e,0,(sockaddr *)&DAT_00011e3c,&local_a4);
        if (0 < local_18) {
          printf("rev:\n%s\t",local_14);
          DAT_00011e38 = 0;
...

{
  ...
  printf("monitor-ipsig compile %s--%s\n","Jun 16 2020","14:30:46",0,param_2,param_1);
  iVar1 = FUN_00009120();
  do {
...
void FUN_0000992c(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
