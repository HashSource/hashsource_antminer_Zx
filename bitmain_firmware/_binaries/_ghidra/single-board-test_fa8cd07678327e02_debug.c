...

{
    ...
    __libc_start_main(0x174cd, in_stack_00000000, &stack0x00000004, 0x33e75,
                      0x33eb5, param_1);
        ...
        if (4 < index) {
            if (index == 5) {
                if (((use_syslog) || (opt_log_output)) || (2 < opt_log_level)) {
                    builtin_strncpy(
                        tmp42,
                        "get bt8d value failed!!!,use default to continue",
                        0x30);
                    tmp42[0x30] = '\n';
                    tmp42[0x31] = '\0';
...
int makeup_set_config_cmd(uint8_t *str, uint32_t str_len, uint8_t all,
                          uint8_t chip_addr, uint8_t regaddr, uint32_t regdata)

{
    ...
    if (str_len < 0xb) {
        ...
        set_config_cmd.regdata =
            (uint8_t[4])(regdata << 0x18 | (regdata >> 8 & 0xff) << 0x10 |
                         (regdata >> 0x10 & 0xff) << 8 | regdata >> 0x18);
...
int makeup_get_status_cmd(uint8_t *str, uint32_t str_len, uint8_t all,
...
int bm174x_pack_ioctl_pkg(uint8_t *str, uint32_t str_len, uint32_t oper_type,
                          void *param)

{
    ...
    case 0:
        ...
        iVar1 =
            makeup_get_status_cmd(str, str_len, *(uint8_t *)((int)param + 1),
                                  *param, *(uint8_t *)((int)param + 2));
        break;
    case 1:
        /* WARNING: Load size is inaccurate */
        iVar1 = makeup_set_config_cmd(
            str, str_len, *(uint8_t *)((int)param + 1), *param,
            *(uint8_t *)((int)param + 2), *(uint32_t *)((int)param + 4));
        break;
    case 2:
...
void bm174x_write_register(int fd, int mode, uint8_t chip_addr,
...

{
    ...
    nonce_shift_reg.core_timeout.core_timeout._0_1_ =
        (undefined1)reg_value.nonce_shift;
    nonce_shift_reg.core_timeout.core_timeout._1_3_ =
        (undefined3)(reg_value.nonce_shift >> 8);
    nonce_shift_reg.core_timeout.core_timeout._0_1_ =
        nonce_shift_reg.core_timeout.core_timeout._0_1_ & 0xe0 |
        (byte)nonce_shift & 0x1f;
    item.chip_addr = '\0';
    item.all = '\x01';
    item.addr = 'P';
...

{
    ...
    vmount_reg.core_timeout.core_timeout._0_1_ =
        (undefined1)reg_value.analog_mux_control;
    vmount_reg.core_timeout.core_timeout._1_3_ =
        (undefined3)(reg_value.analog_mux_control >> 8);
    vmount_reg.core_timeout.core_timeout._0_1_ =
...

{
    ...
    pt_ctrl_reg.core_timeout.core_timeout._1_3_ =
        (undefined3)(reg_value.pt_ctrl >> 8);
    ...
    pt_ctrl_reg.core_timeout.core_timeout._2_2_ =
        (undefined2)(reg_value.pt_ctrl >> 0x10);
...

{
    ...
    pt_result_reg.core_timeout.core_timeout._1_1_ =
        pt_result_reg.core_timeout.core_timeout._1_1_ & 0xf0 |
        (byte)ptr_grp_num & 0xf;
...
int bm174x_i2c_recv(int fd, uint8_t chip_addr, uint8_t i2c_dev_addr,
                    uint8_t i2c_reg_addr, int len)

{
    ...
    i2c_reg.reg_bin =
        CONCAT22(CONCAT11((char)(reg_value.general_i2c_command >> 0x18),
                          i2c_dev_addr << 1),
                 i2c_reg.core_timeout.core_timeout._0_2_) |
        0x1000000;
    item.all = '\0';
...
void bm174x_i2c_send(int fd, uint8_t chip_addr, uint8_t i2c_dev_addr,
                     uint8_t i2c_reg_addr, uint8_t *reg_data, int len)

{
    ...
    for (i = 0; i < len; i = i + 1) {
        i2c_reg.core_timeout.core_timeout._3_1_ =
            (undefined1)(reg_value.general_i2c_command >> 0x18);
        i2c_reg.reg_bin =
            CONCAT31(CONCAT21(CONCAT11(i2c_reg.core_timeout.core_timeout._3_1_,
                                       i2c_dev_addr << 1),
                              i2c_reg_addr),
                     reg_data[i]) |
            0x1010000;
...

{
    ...
    if (bVar1 == (str[8] & 0x1f)) {
        ...
        item.reg_data = (uint)str[5] << 8 | (uint)str[3] << 0x18 |
                        (uint)str[4] << 0x10 | (uint)str[6];
        item.age = 3;
        add_reg_item(item);
    } else if (((use_syslog != false) || (opt_log_output != false)) ||
               (-1 < opt_log_level)) {
...
int bm174x_nonce_integrality(uint8_t chipid, uint8_t nonce_array_id,
                             int chainid)

{
    ...
    for (i = 0; i < 0x10; i = i + 1) {
        uVar1 = CRC16_v1(
            g_nonce_list[(uint)chipid + (uint)nonce_array_id][0][i], 0x59);
        crc16 = uVar1 >> 8 | uVar1 << 8;
        iVar2 = memcmp(
            &crc16,
            g_nonce_list[(uint)nonce_array_id + (uint)chipid][0][i] + 0x59, 2);
        if (iVar2 != 0) {
            if (((use_syslog != false) || (opt_log_output != false)) ||
                (-1 < opt_log_level)) {
                snprintf(tmp42, 0x400,
                         ...
                         (uint)g_nonce_list[(uint)chipid + (uint)nonce_array_id]
                                           [0][i][0x59],
                         (uint)g_nonce_list[(uint)chipid + (uint)nonce_array_id]
                                           [0][i][0x5a]);
                _applog(0, tmp42, false);
    ...
    for (i = 0; i < 0x10; i = i + 1) {
        if ((g_nonce_list[(uint)nonce_array_id + (uint)chipid][0][i][0] &
             0xf) != i) {
            if (((use_syslog != false) || (opt_log_output != false)) ||
                (-1 < opt_log_level)) {
    ...
    while (true) {
        if (0xe < i) {
            nonce_p =
                (uint8_t *)(g_nonce + (uint)nonce_array_id + (uint)chipid);
            for (i = 0; i < 0xf; i = i + 1) {
                memcpy(nonce_p,
                       g_nonce_list[(uint)nonce_array_id + (uint)chipid][0][i] +
                           4,
                       0x55);
                nonce_p = nonce_p + 0x55;
            }
            memcpy(nonce_p,
                   g_nonce_list[(uint)nonce_array_id + (uint)chipid][0][0xf] +
                       4,
                   0x45);
            ...
            memcpy(g_nonce[(uint)nonce_array_id + (uint)chipid][0].sha256,
                   g_nonce_list[(uint)nonce_array_id + (uint)chipid][0][0xf] +
                       0x4d,
                   4);
            g_nonce[(uint)nonce_array_id + (uint)chipid][0].chain_id =
                (uint8_t)chainid;
            return 0;
        }
        if (g_nonce_list[(uint)chipid + (uint)nonce_array_id][0][i][3] !=
            g_nonce_list[(uint)chipid + (uint)nonce_array_id][0][i + 1][3])
            break;
        i = i + 1;
    }
    if (((use_syslog != false) || (opt_log_output != false)) ||
        (-1 < opt_log_level)) {
        snprintf(
            tmp42, 0x400, "nonceID is different %02x != %02x chipid=%d\n",
...
int bm174x_nonce_handle(uint8_t *str, int len, uint32_t chainid,
                        int addr_interval)

{
    ...
    if ((bVar1 & 0xf) == 0xf) {
        ...
        if (iVar3 < 0) {
            if (((use_syslog != false) || (opt_log_output != false)) ||
                (0 < opt_log_level)) {
                bm174x_nonce_handle::total_error =
                    bm174x_nonce_handle::total_error + 1;
...

{
    ...
    (*runtime->read_register)(runtime->chain_status[runtime->chain_id].fd, 1,
                              '\0', '\0');
...

{
    ...
    for (i = 0; i < runtime->chain_status[chainid].design_asic_num; i = i + 1) {
        (*runtime->set_address)(runtime->chain_status[chainid].fd,
                                (char)runtime->addr_interval *(char)i);
    }
    return;
}
    ...
    if (actual_asic_number == 1) {
        ...
        if ((actual_asic_number < 5) || (8 < actual_asic_number)) {
            if ((actual_asic_number < 9) || (0x10 < actual_asic_number)) {
                if ((actual_asic_number < 0x11) ||
                    (0x20 < actual_asic_number)) {
                    if ((actual_asic_number < 0x21) ||
                        (0x40 < actual_asic_number)) {
                        if ((actual_asic_number < 0x41) ||
                            (0x80 < actual_asic_number)) {
                            if ((opt_debug) &&
                                (((use_syslog || (opt_log_output)) ||
                                  (3 < opt_log_level)))) {
                                snprintf(tmp42, 0x400,
                                         "actual_asic_number = %d, but it is "
                                         "error\n",
                                         actual_asic_number);
...

{
    ...
    for (i = 0; i < runtime->chain_status[runtime->chain_id].design_asic_num;
         i = i + 1) {
        (*runtime->i2c_enable)(runtime->chain_status[chainid].fd,
                               (char)runtime->addr_interval *(char)i);
    }
    return;
}
...

{
    ...
    check_loop = 3;
    do {
        (*runtime->i2c_status)(runtime->chain_status[iVar3].fd,
                               (uint8_t)chip_addr);
        item.reg_data = 0;
        item.age = 0;
...
int user_read_iic(runtime_base_t *runtime, int chip_addr, uint8_t i2c_dev_addr,
                  uint8_t i2c_reg_addr, uint8_t *i2c_reg_data, int len)

{
    ...
    if (iVar1 == 0) {
        iVar1 = (*runtime->i2c_recv)(iVar3, (uint8_t)chip_addr, i2c_dev_addr,
                                     i2c_reg_addr, len);
        if (iVar1 == 0) {
            ...
            for (i = 0; i < len; i = i + 1) {
                ...
                if ((iVar1 < 1) || ((itemreg.reg_data & 0xc0000000) != 0)) {
                    if ((use_syslog != false) ||
                        ((opt_log_output != false || (0 < opt_log_level)))) {
                        snprintf(tmp42, 0x400,
                                 "Read i2c failed chipaddr=%02x, "
                                 "i2c-regaddr=%02x i2c-regdata=%08x\n",
...
void user_send_work(runtime_base_t *runtime, uint8_t *header, int sno_valid,
                    int test_patten)

{
    ...
    memset(&work, 0, 0x92);
    work._2_1_ = work._2_1_ & 0xee | (byte)((sno_valid & 1U) << 4) |
                 (byte)test_patten & 1;
...

{
    ...
    iVar1 = runtime->chain_id;
    (*runtime->set_ticket_mask)(runtime->chain_status[iVar1].fd,
                                app_conf->ticket_mask);
    usleep(100000);
    (*runtime->set_core_timeout)(runtime->chain_status[iVar1].fd,
                                 app_conf->core_timeout);
    usleep(100000);
    (*runtime->set_frequency)(runtime->chain_status[iVar1].fd,
                              app_conf->bringup_freq);
    usleep(100000);
    (*runtime->set_nonce_shift)(runtime->chain_status[iVar1].fd, 0,
                                &runtime->nonce_shift);
    usleep(100000);
...

{
    ...
    while (read_timeout_counter < 0xf) {
        ...
        if (iVar2 < 1) {
            ...
            pt_result_reg.core_timeout.core_timeout._2_2_ =
                (undefined2)(item.reg_data >> 0x10);
            if ((pt_result_reg.core_timeout.core_timeout._2_2_ & 0xfff) ==
                0x800) {
                if (((use_syslog != false) || (opt_log_output != false)) ||
                    (1 < opt_log_level)) {
            ...
            if ((opt_debug != false) &&
                ...
                snprintf(tmp42, 0x400,
                         ...
                         (ushort)pt_result_reg.core_timeout.core_timeout._2_2_ &
                             0xfff);
                _applog(4, tmp42, false);
            }
        }
...

{
    ...
    (*runtime->set_ticket_mask)(runtime->chain_status[iVar4].fd,
                                app_conf->ticket_mask);
    usleep(100000);
    (*runtime->set_core_timeout)(runtime->chain_status[iVar4].fd,
                                 app_conf->core_timeout);
    usleep(100000);
    (*runtime->set_frequency)(runtime->chain_status[iVar4].fd, freq);
    usleep(100000);
    (*runtime->set_nonce_shift)(runtime->chain_status[iVar4].fd, 0,
                                &runtime->nonce_shift);
    iVar4 =
        g_patten.sol_bin_len + g_patten.work_bin_len + g_patten.nonce_bin_len;
    g_patten.start = 1;
    sleep(1);
    which_asic = 0;
    do {
        ...
        for (which_core = 0; which_core < g_patten.core_num;
             which_core = which_core + 1) {
            for (which_patten = 0; which_patten < g_patten.patten_num;
                 which_patten = which_patten + 1) {
                pthread_mutex_lock((pthread_mutex_t *)&g_patten.patten_mutex);
                g_patten.cur_work = g_patten.patten_start +
                                    iVar4 * which_core * g_patten.patten_num +
                                    iVar4 * g_patten.patten_num * which_asic *
                                        g_patten.core_num +
                                    iVar4 * which_patten;
                ...
                do {
                    usleep(50000);
                    pthread_mutex_lock(
                        (pthread_mutex_t *)&g_patten.patten_mutex);
                    uVar2 = g_patten.is_nonce_match[g_patten.cur_patten +
                                                    g_patten.patten_num *
                                                        (g_patten.core_num *
                                                             g_patten.cur_asic +
                                                         g_patten.cur_core)];
                ...
                if (uVar2 != '\x01') {
                    ...
                    dump_str(stderr, (char *)0x0, g_patten.cur_work,
                             g_patten.work_bin_len);
                }
            }
        }
...

{
    ...
    do {
        ...
        if (0 < runtime->chain_status[iVar2].real_asic_num)
            break;
        sleep(1);
        if (((use_syslog != false) || (opt_log_output != false)) ||
            (1 < opt_log_level)) {
    ...
    if (check_times < 1) {
        ...
        if (runtime->baudrate != 0x1c200) {
            sleep(1);
            (*runtime->set_baud)(runtime->chain_status[iVar2].fd,
                                 runtime->baudrate);
            sleep(1);
            uart_exit(runtime->chain_status[iVar2].fd);
            sleep(1);
            iVar1 = uart_init(runtime->chain_status[iVar2].comport,
                              runtime->baudrate);
...

{
    ...
    for (sensorid = 0; sensorid < app_conf->sensor_num;
         sensorid = sensorid + 1) {
    ...
    if ((bVar1 < 0x30) || (0x39 < bVar1)) {
        if ((bVar1 < 0x61) || (0x66 < bVar1)) {
            if ((bVar1 < 0x41) || (0x46 < bVar1)) {
                if ((use_syslog) ||
                    ((opt_log_output || (-1 < opt_log_level)))) {
                    snprintf(tmp42, 0x400,
...

{
    ...
    for (addr = 0; addr < len_local; addr = addr + 0x10) {
        ...
        for (i = 0; (i < 0x10 &&
                     (pos = (i >> 3) + wordlen * 2 + 3, addr + i < len_local));
             i = i + 1) {
            v = p_local[i + addr];
...
uint32_t print_solver_line(uint8_t *soln, uint8_t *header,
                           int fixed_nonce_bytes, char *job_id)

{
    ...
    printf("sol: %s ", job_id);
    printf("%02x%02x%02x%02x ", (uint)header[100], (uint)header[0x65],
           (uint)header[0x66], (uint)header[0x67]);
    pcVar1 =
        s_hexdump(header + fixed_nonce_bytes + 0x6c, 0x20 - fixed_nonce_bytes);
    printf("%s ", pcVar1);
...
LAB_00015218:
    ...
    if ((sVar1 == -1) &&
        ((piVar2 = __errno_location(),
          *piVar2 == 0xb || (piVar2 = __errno_location(), *piVar2 == 0xb)))) {
        if (pos == 0) {
            return 0;
        }
        if (((use_syslog != false) || (opt_log_output != false)) ||
        ...
        if (buf[pos - 1] == '\n') {
            ...
            if (pvVar4 != (void *)0x0) {
                if (((use_syslog != false) || (opt_log_output != false)) ||
                    (0 < opt_log_level)) {
                    snprintf(tmp42, 0x400,
                             "%s strange: more than 1 line was read\n",
                             "read_last_line");
                    _applog(1, tmp42, false);
                }
...
void mining_parse_job(char *str, uint8_t *target, int target_len, char *job_id,
                      int job_id_len, uint8_t *header, int header_len,
...

{
    ...
    if (str[str_i] != ' ') {
        /* WARNING: Subroutine does not return */
        __assert_fail("str[str_i] == \' \'", "bm174x/equihash-miner.c", 0x152,
                      "mining_parse_job");
    }
    i = 0;
    uVar1 = str_i;
    ...
    if (str[str_i] != ' ') {
        /* WARNING: Subroutine does not return */
        __assert_fail("str[str_i] == \' \'", "bm174x/equihash-miner.c", 0x158,
                      "mining_parse_job");
    }
    if ((uint)job_id_len <= i) {
        /* WARNING: Subroutine does not return */
        __assert_fail("i < job_id_len", "bm174x/equihash-miner.c", 0x159,
                      "mining_parse_job");
    }
    job_id[i] = '\0';
    i = 0;
    ...
    if (str[str_i] != ' ') {
        /* WARNING: Subroutine does not return */
        __assert_fail("str[str_i] == \' \'", "bm174x/equihash-miner.c", 0x160,
                      "mining_parse_job");
    }
    str_i = uVar1 + 3;
    *fixed_nonce_bytes = 0;
    ...
    if (str[str_i] != '\0') {
        /* WARNING: Subroutine does not return */
        __assert_fail("!str[str_i]", "bm174x/equihash-miner.c", 0x16b,
                      "mining_parse_job");
    }
    if ((opt_debug != false) &&
        (((use_syslog != false || (opt_log_output != false)) ||
...

{
    ...
    do {
        ...
        mining_parse_job(line, g_work_info.target, 0x20, g_work_info.job_id,
                         0x100, g_work_info.header, 0x8c,
...

{
    ...
    iVar2 = ((((iVar1 << 5 | (uint)tv.tv_sec >> 0x1b) - iVar1) -
              (uint)((uint)(tv.tv_sec * 0x20) < (uint)tv.tv_sec)) *
                 0x200 |
             (uint)(tv.tv_sec * 0x1f) >> 0x17) +
            iVar1 + (uint)CARRY4(tv.tv_sec * 0x3e00, tv.tv_sec);
    return CONCAT44(
        (tv.tv_usec >> 0x1f) + iVar1 +
            (((iVar2 * 0x40 | (uint)(tv.tv_sec * 0x3e01) >> 0x1a) - iVar2) -
             (uint)((uint)(tv.tv_sec * 0xf8040) < (uint)(tv.tv_sec * 0x3e01))) +
            (uint)CARRY4(tv.tv_sec, tv.tv_sec * 999999) +
            (uint)CARRY4(tv.tv_usec, tv.tv_sec * 1000000),
        tv.tv_usec + tv.tv_sec * 1000000);
}

void equihash_nonce_submit(uint8_t *nonce, uint8_t *verify,
                           int fixed_nonce_bytes, char *job_id)

{
    ...
    equihash_nonce_submit::total._4_4_ =
        equihash_nonce_submit::total._4_4_ + (uint)bVar3;
    if (((use_syslog) || (opt_log_output)) || (2 < opt_log_level)) {
        equihash_nonce_submit::golden_nonce =
            equihash_nonce_submit::golden_nonce + 1;
    ...
    equihash_nonce_submit::total_shares._0_4_ =
        (uint)equihash_nonce_submit::total_shares + 1;
    ...
    uVar2 = equihash_nonce_submit::status_period._4_4_ +
            ...
            CARRY4((uint)equihash_nonce_submit::status_period,
                   (uint)equihash_nonce_submit::t0);
    bVar3 = equihash_nonce_submit::t1._4_4_ <= uVar2;
    if (uVar2 == equihash_nonce_submit::t1._4_4_) {
        bVar3 = (uint)equihash_nonce_submit::t1 <=
                (uint)equihash_nonce_submit::status_period +
                    (uint)equihash_nonce_submit::t0;
    }
    if (!bVar3) {
        ...
        printf("status: %lld %lld\n", (uint)equihash_nonce_submit::total,
               (uint)equihash_nonce_submit::total,
               equihash_nonce_submit::total._4_4_,
               (uint)equihash_nonce_submit::total_shares,
               equihash_nonce_submit::total_shares._4_4_);
        fflush(stdout);
...

{
    ...
    runtime->nonce_submit =
        (_func_void_uint8_t_ptr_uint8_t_ptr_int_char_ptr *)0x15995;
    return;
}
...

{
    ...
    iVar1 = pthread_create(&p_miner, (pthread_attr_t *)0x0,
                           (__start_routine *)0x15829, runtime);
    if (iVar1 == 0) {
        if (((use_syslog != false) || (opt_log_output != false)) ||
            (-1 < opt_log_level)) {
...

{
    ...
    return __bsx << 0x18 | (__bsx >> 8 & 0xff) << 0x10 |
           (__bsx >> 0x10 & 0xff) << 8 | __bsx >> 0x18;
}

void compressArray(uchar *in, size_t in_len, uchar *out, size_t out_len,
...

{
    ...
    if (bit_len < 8) {
        /* WARNING: Subroutine does not return */
        __assert_fail("bit_len >= 8", "bm174x/equihash-verify.c", 0x14,
                      "compressArray");
    }
    if (0x20 < bit_len + 7) {
        /* WARNING: Subroutine does not return */
        __assert_fail("8 * sizeof(uint32_t) >= 7 + bit_len",
                      "bm174x/equihash-verify.c", 0x15, "compressArray");
    }
    ...
    if (sVar1 != out_len) {
        ...
        __assert_fail("out_len == bit_len * in_len / (8 * in_width)",
                      "bm174x/equihash-verify.c", 0x18, "compressArray");
    }
    acc_bits = 0;
    acc_value = 0;
    j = 0;
    for (i = 0; i < out_len; i = i + 1) {
        if (acc_bits < 8) {
            ...
            for (x = byte_pad; x < uVar2; x = x + 1) {
                acc_value = ((1 << (bit_len & 0xff)) - 1U >>
                                 (((uVar2 - x) + 0x1fffffff) * 8 & 0xff) &
                             (uint)in[x + j])
                                << (((uVar2 - x) + 0x1fffffff) * 8 & 0xff) |
                            acc_value;
            }
...

{
    ...
    if (bit_len < 8) {
        /* WARNING: Subroutine does not return */
        __assert_fail("bit_len >= 8", "bm174x/equihash-verify.c", 0x3e,
                      "expandArray");
    }
    if (0x20 < bit_len + 7) {
        /* WARNING: Subroutine does not return */
        __assert_fail("8 * sizeof(uint32_t) >= 7 + bit_len",
                      "bm174x/equihash-verify.c", 0x3f, "expandArray");
    }
    uVar2 = byte_pad + (bit_len + 7 >> 3);
    ...
    if (sVar1 != out_len) {
        ...
        __assert_fail("out_len == 8 * out_width * in_len / bit_len",
                      "bm174x/equihash-verify.c", 0x42, "expandArray");
    }
    acc_bits = 0;
    acc_value = 0;
    j = 0;
        ...
        if (bit_len <= acc_bits) {
            ...
            for (x_1 = byte_pad; x_1 < uVar2; x_1 = x_1 + 1) {
                out[x_1 + j] =
                    ...
                    (byte)(acc_value >>
                           (acc_bits + ((uVar2 - x_1) + 0x1fffffff) * 8 &
                            0xff));
            }
            j = uVar2 + j;
        }
...
int getIndices(uint8_t *hash, size_t len, size_t lenIndices, size_t cBitLen,
...

{
    ...
    if (cBitLen + 8 < 0x28) {
        ...
        if (maxLen < out_len) {
            ...
            compressArray(hash + len, lenIndices, data, out_len, cBitLen + 1,
                          4 - (cBitLen + 8 >> 3));
        }
        return out_len;
    }
    ...
    __assert_fail("((cBitLen + 1) + 7) / 8 <= sizeof(uint32_t)",
                  "bm174x/equihash-verify.c", 0x6c, "getIndices");
}
    ...
    do {
        ...
        if (0x1ff < i) {
            for (j_1 = 0; j_1 < 0x200; j_1 = j_1 + 1) {
                ...
                expandArray(tmpHash + (iVar8 >> 3), iVar9 >> 3, hash, out_len,
                            bit_len, 0);
            ...
            if (iVar8 == 0) {
                ...
                for (i_2 = 0; puVar1 = x, i_2 < 9; i_2 = i_2 + 1) {
                    qsort(x, x_size, out_len + indicesLen,
                          (__compar_fn_t)0x16055);
                    xc_size = 0;
                    for (j_2 = 0; j_2 < x_size; j_2 = j_2 + 2) {
                        ...
                        memcpy(xc + (j_2 >> 1) * (out_len + indicesLen * 2),
                               tmp_hash, out_len);
                        memcpy(xc + out_len +
                                   (j_2 >> 1) * (out_len + indicesLen * 2),
                               x + out_len + j_2 * (indicesLen + out_len),
                               indicesLen);
                        memcpy(xc + indicesLen +
                                   (j_2 >> 1) * (out_len + indicesLen * 2) +
                                   out_len,
                               x + out_len + (j_2 + 1) * (indicesLen + out_len),
                               indicesLen);
                        xc_size = xc_size + 1;
                    }
                ...
                for (j_3 = 0; j_3 < 0x200; j_3 = j_3 + 1) {
                    ...
                    expandArray(tmpHash + (iVar8 >> 3), iVar9 >> 3, hash_1,
                                out_len, bit_len, 0);
                ...
                for (i_6 = 0; puVar1 = x, i_6 < 9; i_6 = i_6 + 1) {
                    ...
                    for (j_4 = 0; j_4 < x_size; j_4 = j_4 + 2) {
                        for (index_1 = 0; index_1 < out_len;
                             index_1 = index_1 + 1) {
                            tmp_hash[index_1] =
                                x[index_1 +
                                  (j_4 + 1) * (indicesLen + out_len)] ^
                                x[index_1 + j_4 * (indicesLen + out_len)];
                        }
                        memcpy(xc + (j_4 >> 1) * (out_len + indicesLen * 2),
                               tmp_hash, out_len);
                        memcpy(xc + out_len +
                                   (j_4 >> 1) * (out_len + indicesLen * 2),
                               x + out_len + j_4 * (indicesLen + out_len),
                               indicesLen);
                        memcpy(xc + indicesLen +
                                   (j_4 >> 1) * (out_len + indicesLen * 2) +
                                   out_len,
                               x + out_len + (j_4 + 1) * (indicesLen + out_len),
                               indicesLen);
                        xc_size = xc_size + 1;
                    }
                    indicesLen = indicesLen << 1;
...
int equihash_nonce_verify(nonce_verify_info_t *verify_info, int *tm,
                          uint32_t shift)

{
    ...
    memcpy((void *)((int)verify_info + (verify_info->work_len - shift) + -4),
           verify_info->nonce, verify_info->nonce_len);
    valData.n = 200;
    valData.k = 9;
    ...
    uVar2 = targetValidator(verify_info->work, verify_info->sol,
                            verify_info->target);
    *tm = uVar2;
    return iVar1;
}
                ...
                if (iVar1 == 0) {
                    ...
                    if (iVar1 != 0) {
                        if (((use_syslog != false) ||
                            ...
                            builtin_strncpy(
                                tmp42,
                                "please assign ctrl type: keyboard or button\n",
                                0x2c);
                            tmp42[0x2c] = '\0';
                            _applog(2, tmp42, false);
                        }
...

{
    ...
    if ((iVar1 < 0) && (((use_syslog != false || (opt_log_output != false)) ||
                         (1 < opt_log_level)))) {
...
int ISL_page_enable(uint8_t which_chain, uint8_t which_i2c,
                    uint8_t i2c_dev_addr, uint8_t which_page)

{
    ...
    write_dc_dc(&which_chain_local, which_i2c, i2c_dev_addr, '\0',
                &which_page_local, 1);
    return 0;
}
...
int ISL_set_on_off_config(uint8_t which_chain, uint8_t which_i2c,
                          uint8_t i2c_dev_addr, uint8_t config)

{
    ...
    which_i2c_local = which_i2c;
    which_chain_local = which_chain;
    write_dc_dc(&which_chain_local, which_i2c, i2c_dev_addr, '\x02',
                &config_local, 1);
    return 0;
}

int ISL_set_clear_faults(uint8_t which_chain, uint8_t which_i2c,
...
int ISL_set_write_protect(uint8_t which_chain, uint8_t which_i2c,
                          uint8_t i2c_dev_addr, uint8_t mode)

{
    ...
    which_i2c_local = which_i2c;
    which_chain_local = which_chain;
    write_dc_dc(&which_chain_local, which_i2c, i2c_dev_addr, '\x10',
                &mode_local, 1);
    return 0;
}

int ISL_set_vout_command(uint8_t which_chain, uint8_t which_i2c,
                         uint8_t i2c_dev_addr, uint16_t voltage)

{
    ...
    printf("uint16 = 0x%04x[%u], cmd0=%02x cmd1=%02x\n", (uint)voltage,
           (uint)voltage, (uint)(byte)voltage, (uint)(byte)(voltage >> 8));
    write_dc_dc(&which_chain_local, which_i2c, i2c_dev_addr, '!', cmd, 2);
    return 0;
}

int ISL_set_apply_settings(uint8_t which_chain, uint8_t which_i2c,
                           uint8_t i2c_dev_addr)
...
int ISL_get_voltage(uint8_t which_chain, uint8_t which_i2c,
                    uint8_t i2c_dev_addr, uint16_t *voltage)
...
int ISL_read_reg_default(uint8_t which_chain, uint8_t which_i2c,
                         uint8_t i2c_dev_addr)
...
uint16_t ISL_set_voltage(uint8_t which_chain, uint8_t which_i2c,
                         uint8_t i2c_dev_addr, uint16_t voltage)
...

{
    ...
    if ((buf != (char *)0x0) && (0 < cgpu.lcd_fd)) {
        if ((line < 4) && (size < 0x41)) {
            ...
            line_local = line;
            for (size_local = size; size_local != 0;
...

{
    ...
    i2c_write((uint)data | (uint)which_i2c << 0x1a | 0xa00000 |
              (uint)which_chain << 0x10);
    return;
}
...

{
    ...
    uVar1 = i2c_read((uint)which_chain << 0x10 | (uint)which_i2c << 0x1a |
                     0xa00000);
    return uVar1;
}

int write_dc_dc(void *args, uint8_t which_i2c, uint8_t i2c_dev_addr,
...

{
    ...
    if ((read_back_data[1] == '2') && (read_back_data[2] == '\x01')) {
        ...
        printf("--- %s failed! read_back_data[0] = 0x%02x, read_back_data[1] = "
               ...
               "0x%02x\n\n",
               "write_dc_dc", read_back_data._0_4_ & 0xff,
...
int read_dc_dc(void *args, uint8_t which_i2c, uint8_t i2c_dev_addr, uint8_t reg,
...

{
    ...
    if ((read_back_data[1] == '2') && (read_back_data[2] == '\x01')) {
        ...
        printf(
            ...
            "read_dc_dc", read_back_data._0_4_ & 0xff, (uint)read_back_data[1],
...
int set_PIC16F1704_flash_pointer(uint which_i2c, uchar which_chain,
                                 uchar flash_addr_h, uchar flash_addr_l)

{
    ...
    if ((read_back_data[0] == '\x01') && (read_back_data[1] == '\x01')) {
        if ((use_syslog != false) ||
            ((opt_log_output != false || (1 < opt_log_level)))) {
        ...
        if (((use_syslog != false) || (opt_log_output != false)) ||
            ...
            snprintf(tmp42, 0x400,
                     ...
                     "set_PIC16F1704_flash_pointer", (uint)read_back_data[0],
    ...
    if ((read_back_data[0] == '\x02') && (read_back_data[1] == '\x01')) {
        ...
        if (((use_syslog != false) || (opt_log_output != false)) ||
            ...
            snprintf(tmp42, 0x400,
                     "--- %s failed! read_back_data[0] = 0x%02x, "
                     "read_back_data[1] = 0x%02x\n\n",
                     "send_data_to_PIC16F1704", (uint)read_back_data[0],
                     (uint)read_back_data[1]);
            _applog(2, tmp42, false);
        }
        iVar2 = 0;
...
int read_PIC16F1704_flash_pointer(uint which_i2c, uchar which_chain,
                                  uchar *flash_addr_h, uchar *flash_addr_l)

{
    ...
    if ((read_back_data[1] == '\b') && (read_back_data[0] == '\x06')) {
        ...
        if (((uchar)((ushort)sVar1 >> 8) == read_back_data[4]) &&
            ((uchar)sVar1 == read_back_data[5])) {
            ...
            *flash_addr_l = read_back_data[3];
            if (((use_syslog != false) || (opt_log_output != false)) ||
                ...
                snprintf(tmp42, 0x400,
                         ...
                         "0x%02x\n\n",
                         "read_PIC16F1704_flash_pointer", (uint)*flash_addr_h,
                         (uint)*flash_addr_l);
                _applog(2, tmp42, false);
            }
            iVar3 = 1;
            ...
            if (((use_syslog != false) || (opt_log_output != false)) ||
                ...
                snprintf(tmp42, 0x400,
                         ...
                         read_back_data._0_4_ & 0xff, 8,
                         (uint)read_back_data[2], (uint)read_back_data[3],
                         (uint)read_back_data[4], (uint)read_back_data[5]);
                _applog(2, tmp42, false);
            }
            iVar3 = 0;
        }
        ...
        if (((use_syslog != false) || (opt_log_output != false)) ||
            ...
            snprintf(
                ...
                "read_PIC16F1704_flash_pointer", read_back_data._0_4_ & 0xff,
                (uint)read_back_data[1], (uint)read_back_data[2],
...

{
    ...
    if (((use_syslog != false) || (opt_log_output != false)) ||
        ...
        snprintf(
            ...
            (uint)read_back_data._0_4_ >> 8 & 0xff,
    ...
    if ((read_back_data[1] == '\x03') && (read_back_data[0] == '\x14')) {
        uVar1 = (ushort)read_back_data[0x11] + (ushort)read_back_data[0x10] +
                ...
                (ushort)read_back_data[5] + (ushort)read_back_data[4] +
                (ushort)read_back_data[3] + read_back_data[2] + 0x17;
        if (((uchar)(uVar1 >> 8) == read_back_data[0x12]) &&
            ((uchar)uVar1 == read_back_data[0x13])) {
            for (i = '\0'; i < 0x10; i = i + '\x01') {
    ...
    if ((read_back_data[0] == '\x04') && (read_back_data[1] == '\x01')) {
        ...
        if (((use_syslog != false) || (opt_log_output != false)) ||
            ...
            snprintf(tmp42, 0x400,
                     "--- %s failed! read_back_data[0] = 0x%02x, "
                     "read_back_data[1] = 0x%02x\n\n",
                     "erase_PIC16F1704_flash", (uint)read_back_data[0],
                     (uint)read_back_data[1]);
            _applog(2, tmp42, false);
        }
        iVar2 = 0;
    ...
    if ((read_back_data[0] == '\x05') && (read_back_data[1] == '\x01')) {
        ...
        if (((use_syslog != false) || (opt_log_output != false)) ||
            ...
            snprintf(tmp42, 0x400,
                     ...
                     "read_back_data[1] = 0x%02x\n\n",
                     "write_data_into_PIC16F1704_flash",
                     (uint)read_back_data[0], (uint)read_back_data[1]);
            _applog(2, tmp42, false);
        }
        iVar2 = 0;
    }
    ...
    if ((read_back_data[0] == '\a') && (read_back_data[1] == '\x01')) {
        ...
        if (((use_syslog != false) || (opt_log_output != false)) ||
            ...
            snprintf(tmp42, 0x400,
                     "--- %s failed! read_back_data[0] = 0x%02x, "
                     "read_back_data[1] = 0x%02x\n\n",
                     "reset_PIC16F1704_pic", (uint)read_back_data[0],
                     (uint)read_back_data[1]);
            _applog(2, tmp42, false);
        }
        iVar2 = 0;
    ...
    if ((read_back_data[0] == '\x10') && (read_back_data[1] == '\x01')) {
        ...
        if (((use_syslog != false) || (opt_log_output != false)) ||
            ...
            snprintf(tmp42, 0x400,
                     "--- %s failed! read_back_data[0] = 0x%02x, "
                     "read_back_data[1] = 0x%02x\n\n",
                     "set_PIC16F1704_voltage", (uint)read_back_data[0],
                     (uint)read_back_data[1]);
            _applog(2, tmp42, false);
        }
        iVar2 = 0;
    ...
    if ((read_back_data[0] == '\x12') && (read_back_data[1] == '\x01')) {
        ...
        if (((use_syslog != false) || (opt_log_output != false)) ||
            ...
            snprintf(tmp42, 0x400,
                     "--- %s failed! read_back_data[0] = 0x%02x, "
                     "read_back_data[1] = 0x%02x\n\n",
                     "write_hash_ID_PIC16F1704", (uint)read_back_data[0],
                     (uint)read_back_data[1]);
            _applog(2, tmp42, false);
        }
        iVar2 = 0;
...

{
    ...
    if ((read_back_data[1] == '\x13') && (read_back_data[0] == '\x10')) {
        uVar1 = (ushort)read_back_data[0xd] + (ushort)read_back_data[0xc] +
                (ushort)read_back_data[0xb] + (ushort)read_back_data[10] +
                (ushort)read_back_data[9] + (ushort)read_back_data[8] +
                (ushort)read_back_data[7] + (ushort)read_back_data[6] +
                (ushort)read_back_data[5] + (ushort)read_back_data[4] +
                (ushort)read_back_data[3] + read_back_data[2] + 0x23;
        if (((uchar)(uVar1 >> 8) == read_back_data[0xe]) &&
            ((uchar)uVar1 == read_back_data[0xf])) {
            for (i = '\0'; i < 0xc; i = i + '\x01') {
                buf[i] = read_back_data[i + 2];
            }
            if (((use_syslog != false) || (opt_log_output != false)) ||
    ...
    if ((read_back_data[0] == '\x15') && (read_back_data[1] == '\x01')) {
        ...
        if (((use_syslog != false) || (opt_log_output != false)) ||
            ...
            snprintf(tmp42, 0x400,
                     "--- %s failed! read_back_data[0] = 0x%02x, "
                     "read_back_data[1] = 0x%02x\n\n",
                     "enable_PIC16F1704_dc_dc", (uint)read_back_data[0],
                     (uint)read_back_data[1]);
            _applog(2, tmp42, false);
        }
        iVar2 = 0;
...
int get_PIC16F1704_software_version(uint which_i2c, uchar which_chain,
                                    uchar *version)

{
    ...
    if ((read_back_data[1] == '\x17') && (read_back_data[0] == '\x05')) {
        ...
        if (((uchar)(uVar1 >> 8) == read_back_data[3]) &&
            ((uchar)uVar1 == read_back_data[4])) {
...
int PIC16F1704_i2c_forward_send(uint32_t i2c, uint8_t chain, uint8_t dev_addr,
                                int rw_flag, uint8_t reg_addr, int len,
                                uint8_t *data)

{
    ...
    if (rw_flag == 1) {
        ...
        if ((((recv_data._0_4_ & 0xff) != body_len + 2U) ||
             (recv_data[1] != '&')) ||
            (recv_data[2] != '\x01')) {
            if (((use_syslog != false) || (opt_log_output != false)) ||
                (1 < opt_log_level)) {
...

{
    ...
    i2c_local = i2c;
    for (i = 0; i < 4; i = i + 1) {
        PIC16F1704_i2c_forward_send(i2c_local, chain_local, "PQTU"[i], 0, '\0',
                                    1, (uint8_t *)0x0);
        PIC16F1704_i2c_forward_send(i2c_local, chain_local, "PQTU"[i], 0, '!',
                                    2, (uint8_t *)&vol_local);
    }
    return;
}
...

{
    ...
    for (i = 0; i < 4; i = i + 1) {
        ...
        read_vol[10] = '\0';
        read_vol[0xb] = '\0';
        iVar1 = PIC16F1704_i2c_forward_send(i2c, chain, "PQTU"[i], 1, '!', 2,
                                            read_vol);
        if (iVar1 == 0) {
            if (((use_syslog != false) || (opt_log_output != false)) ||
                (1 < opt_log_level)) {
...
int write_temperature_offset_PIC16F1704(uint which_i2c, uchar which_chain,
                                        uchar *buf)
...
int read_temperature_offset_PIC16F1704(uint which_i2c, uchar which_chain,
                                       uchar *buf)

{
    ...
    if ((read_back_data[1] == '#') && (read_back_data[0] == '\f')) {
        uVar1 = (ushort)read_back_data[9] + (ushort)read_back_data[8] +
                (ushort)read_back_data[7] + (ushort)read_back_data[6] +
                (ushort)read_back_data[5] + (ushort)read_back_data[4] +
                (ushort)read_back_data[3] + read_back_data[2] + 0x2f;
        if (((uchar)(uVar1 >> 8) == read_back_data[10]) &&
            ((uchar)uVar1 == read_back_data[0xb])) {
            for (i = '\0'; i < 8; i = i + '\x01') {
                buf[i] = read_back_data[i + 2];
            }
            if (((use_syslog != false) || (opt_log_output != false)) ||
    ...
    if (__stream == (FILE *)0x0) {
        ...
        if (iVar2 == 0) {
            ...
            if (iVar2 == 0) {
                ...
                iVar2 = set_PIC16F1704_flash_pointer(which_i2c, which_chain,
                                                     '\x06', '\0');
                if (iVar2 == 0) {
                    if (((use_syslog != false) || (opt_log_output != false)) ||
                        (1 < opt_log_level)) {
                    ...
                    for (i = 0; i < 0x130; i = i + 1) {
                        ...
                        buf._12_4_ =
                            *(undefined4 *)(program_data + iVar2 + 0xc);
                        if (((use_syslog != false) ||
                             (opt_log_output != false)) ||
                            (1 < opt_log_level)) {
                            snprintf(tmp42, 0x400,
                                     "send pic program time: %d\n", i);
                            _applog(2, tmp42, false);
                        }
                        send_data_to_PIC16F1704(which_i2c, which_chain, buf);
                        write_data_into_PIC16F1704_flash(which_i2c,
                                                         which_chain);
                    }
                    iVar2 = reset_PIC16F1704_pic(which_i2c, which_chain);
                    if (iVar2 == 0) {
    ...
    if ((read_back_data[0] == '$') && (read_back_data[1] == '\x01')) {
        ...
        if (((use_syslog != false) || (opt_log_output != false)) ||
            ...
            snprintf(tmp42, 0x400,
                     "--- %s failed! read_back_data[0] = 0x%02x, "
                     "read_back_data[1] = 0x%02x\n\n",
                     "save_freq_PIC16F1704", (uint)read_back_data[0],
                     (uint)read_back_data[1]);
            _applog(2, tmp42, false);
        }
        iVar3 = 0;
...

{
    ...
    if ((read_back_data[1] == '%') && (read_back_data[0] == '\x06')) {
        ...
        if (((uchar)(uVar1 >> 8) == read_back_data[4]) &&
            ((uchar)uVar1 == read_back_data[5])) {
...
void set_temperature_offset_value(uint which_i2c, uchar which_chain,
                                  uchar *value)
...
int write_PIC16F1705_iic_slave(uint which_i2c, uchar which_chain, uchar *buf,
                               uchar buf_len)
    ...
    if ((read_back_data[1] == '&') && (read_back_data[2] == '\x01')) {
        ...
        if (((use_syslog != false) || (opt_log_output != false)) ||
            ...
            snprintf(
                ...
                "write_PIC16F1705_iic_slave", read_back_data._0_4_ & 0xff,
                (uint)read_back_data[1], (uint)read_back_data[2],
                (uint)read_back_data._0_4_ >> 0x18, (uint)read_back_data[4]);
            _applog(2, tmp42, false);
        }
...
int read_PIC16F1705_iic_slave(uint which_i2c, uchar which_chain, uchar *buf,
                              uchar buf_len, uchar *read_back_buf)
...
int write_data_to_PIC16F1704_flash(int which_chain, int which_i2c, uchar *buf,
                                   int buf_len)

{
    ...
    send_data[0xb] = '\0';
    if ((opt_debug) &&
        (((use_syslog || (opt_log_output)) || (3 < opt_log_level)))) {
    ...
    if (((use_syslog != false) || (opt_log_output != false)) ||
        (1 < opt_log_level)) {
        snprintf(
            tmp42, 0x400, "--- %s: crc_data[0] = 0x%x, crc_data[1] = 0x%x\n",
    ...
    putchar(10);
    if (((read_back_data[0] == '\x05') && (read_back_data[1] == '3')) &&
...
int read_data_from_PIC16F1704_flash(int which_chain, int which_i2c, uchar *buf,
                                    uchar read_len)

{
    ...
    if (((read_back_data[1] == '4') &&
         ((uint)read_back_data[0] == read_len + 5)) &&
        (read_back_data[2] == '\x01')) {
        crc = 0;
        ...
        if (((use_syslog != false) || (opt_log_output != false)) ||
            ...
            snprintf(
                ...
                "\n--- %s failed! read_back_data[0] = 0x%02x, "
                "read_back_data[1] = 0x%02x, read_back_data[2] = 0x%02x\n\n",
                "read_data_from_PIC16F1704_flash", (uint)read_back_data[0],
                (uint)read_back_data[1], (uint)read_back_data[2]);
            _applog(0, tmp42, false);
        }
        iVar4 = 0;
                ...
                if (-1 < (int)uVar1) {
                    ...
                    for (i = 0; i < (int)(length >> 2); i = i + 1) {
                        send_data = (uint)send_buf[i * 4 + 2] << 8 |
                                    (uint)send_buf[i * 4] << 0x18 |
                                    (uint)send_buf[i * 4 + 1] << 0x10 |
                                    (uint)send_buf[i * 4 + 3];
                    ...
                    if (uVar1 != 0) {
                        if (uVar1 == 2) {
                            send_data = (uint)send_buf[i * 4 + 1] << 0x10 |
                                        (uint)send_buf[i * 4] << 0x18;
                        } else if (uVar1 == 3) {
                            send_data = (uint)send_buf[i * 4 + 2] << 8 |
                                        (uint)send_buf[i * 4] << 0x18 |
                            ...
                            send_data = (uint)send_buf[i * 4] << 0x18;
                                   ...
                                   (1 < opt_log_level)) {
                            snprintf(tmp42, 0x400,
                                     "%s: the uart%d send left data is 4*N "
                                     "length, error!!!\n",
                                     "uart_send", (uint)which_uart);
                            _applog(2, tmp42, false);
                        }
                    ...
                    pthread_mutex_unlock(
                        (pthread_mutex_t *)(uart_send_mutex + which_uart));
                    return length;
                }
                if (0x14 < send_counter)
                    break;
...

{
    ...
    default:
        ...
        pthread_mutex_unlock(
            (pthread_mutex_t *)(uart_send_mutex + which_chain));
        return 1;
    }
    if ((opt_debug != false) &&
        (((use_syslog != false || (opt_log_output != false)) ||
...

{
    ...
    if (uVar1 == 0) {
        pthread_mutex_unlock(
            (pthread_mutex_t *)(uart_receive_mutex + which_chain));
        uVar1 = 0;
    } else {
        ...
        if (buf_00 == (uchar *)0x0) {
            ...
            if (uVar2 == uVar1) {
                ...
                if (((use_syslog != false) || (opt_log_output != false)) ||
                    (1 < opt_log_level)) {
                    snprintf(tmp42, 0x400,
                             "%s: uart%d clear rx fifo error. nbytes = %d, len "
                             "= %d\n",
                             "clear_uart_rx_fifo", (uint)which_chain, uVar1,
                             uVar2);
                    _applog(2, tmp42, false);
                }
                free(buf_00);
...

{
    ...
    if (baud == 0xe1000) {
        ...
        if (baud == 0x1c200) {
            ...
            LAB_0001f802:
                printf(
                    "%s: the baud is not recommand value, so use 115200 baud\n",
                    "baud2bt8d");
                return -1;
            }
            bt8d = '\x06';
...

{
    ...
    while (runtime_00->start_recv != 0) {
        for (i = 0; i < runtime_00->sensor_num; i = i + 1) {
            ...
            user_read_iic(runtime_00, chip_addr_00, 'L', '\x01',
                          chip_temp + iVar1, 1);
            if (((use_syslog != false) || (opt_log_output != false)) ||
                (1 < opt_log_level)) {
                snprintf(tmp42, 0x400, "ASIC %d chip temp %d\n", iVar1,
                         (uint)chip_temp[iVar1]);
                _applog(2, tmp42, false);
            }
            user_read_iic(runtime_00, chip_addr_00, 'L', '\0', pcb_temp + iVar1,
                          1);
            if (((use_syslog != false) || (opt_log_output != false)) ||
                (1 < opt_log_level)) {
...

{
    ...
    usleep(50000);
    pthread_create(&cgpu.read_temp, (pthread_attr_t *)0x0,
                   (__start_routine *)0x1ff09, (void *)0x0);
    return;
}
...

{
    ...
    if (app_conf->pcba_enable_level == 1) {
        pattern_result = 1;
        if ((double)(g_patten.total_rate * 100.0) <
            *app_conf->pcba_level_rate) {
            if ((double)(g_patten.total_rate * 100.0) <
                app_conf->pcba_level_rate[1]) {
                if ((double)(g_patten.total_rate * 100.0) <
                    app_conf->pcba_level_rate[2]) {
                    pattern_level = 4;
                    pattern_result = -1;
                    if (((use_syslog != false) || (opt_log_output != false)) ||
                        (1 < opt_log_level)) {
        ...
        pattern_level = 1;
        if (g_patten.total_rate * 100.0 <
            (float)(longlong)app_conf->pcba_pattern_pass_rate) {
            pattern_result = -1;
            if (((use_syslog != false) || (opt_log_output != false)) ||
                (1 < opt_log_level)) {
                builtin_strncpy(tmp42, "Pattern NG.\n", 0xc);
...

{
    ...
    str[0x10] = '\0';
    show_result();
    sprintf(str, "Pattern %d %d %d   ", *g_patten.asic_recv_nonces,
            g_patten.asic_recv_nonces[1], g_patten.asic_recv_nonces[2]);
...

{
    ...
    do {
        ...
        str[0xe] = '\0';
        str[0xf] = '\0';
        sprintf(str, "nonce=%d %d %d", *g_patten.asic_recv_nonces,
                g_patten.asic_recv_nonces[1], g_patten.asic_recv_nonces[2]);
        sVar1 = strlen(str);
...

{
    ...
    if (((use_syslog != false) || (opt_log_output != false)) ||
        (1 < opt_log_level)) {
        snprintf(
            tmp42, 0x400, "%s: Expect ASIC number: %d\n",
    ...
    if (runtime_00->chain_status[runtime_00->chain_id].real_asic_num ==
        ...
        if (app_conf->pcba_only_find_asic == 0) {
            ...
            user_i2c_enable(cgpu.runtime, gChain);
            (*runtime_00->set_core_timeout)(runtime_00->chain_status[gChain].fd,
                                            app_conf->core_timeout);
            usleep(10000);
            (*runtime_00->set_ticket_mask)(runtime_00->chain_status[gChain].fd,
                                           app_conf->ticket_mask);
            usleep(10000);
            (*runtime_00->set_frequency)(runtime_00->chain_status[gChain].fd,
                                         app_conf->pcba_freq);
            usleep(10000);
            (*runtime_00->set_nonce_shift)(runtime_00->chain_status[gChain].fd,
                                           0, &runtime_00->nonce_shift);
            usleep(10000);
            puts("re read asic address:");
            (*runtime_00->read_register)(
                runtime_00->chain_status[runtime_00->chain_id].fd, 1, '\0',
                '\0');
            iVar1 = 0;
        } else {
        ...
        if (g_patten.asic_num <= which_asic) {
            ...
            while (true) {
                ...
                for (i = 0; g_patten.patten_num * g_patten.core_num - i != 0 &&
                            i <= g_patten.patten_num * g_patten.core_num;
                     i = i + 1) {
...

{
    ...
    while (nonceNum != 0) {
        nonceNum = nonceNum + -1;
        pop_nonce(&nonce_tmp);
        asic_index_00 = __aeabi_idiv(nonce_tmp.chip_addr,
                                     *(undefined4 *)((int)args + 0x6f0));
...

{
    ...
    do {
        ...
        pthread_create(&send_id, (pthread_attr_t *)0x0,
                       (__start_routine *)0x21339, args);
...

{
    ...
    if ((vol < 0x385) && (0x2ed < vol)) {
        if (vol == 800) {
            ...
            for (which_asic = 0; which_asic < 3; which_asic = which_asic + 1) {
                uVar1 = ISL_set_voltage(gChain, '\0', isl_dev_addr[which_asic],
                                        vol);
                if (((use_syslog != false) || (opt_log_output != false)) ||
                    (1 < opt_log_level)) {
...

{
        ...
        if (iVar1 < 1) {
            if (((use_syslog != false) || (opt_log_output != false)) ||
                ...
                builtin_strncpy(tmp42,
                                "Don\'t support current baudrate, set to 11520",
                                0x2c);
                tmp42[0x2c] = '0';
                tmp42[0x2d] = '\n';
                tmp42[0x2e] = '\0';
    ...
    pthread_create(&runtime->chain_status[iVar2].p_dispatch,
                   (pthread_attr_t *)0x0, (__start_routine *)0x330a5, runtime);
    sleep(1);
    pthread_create(&runtime->p_scanhash, (pthread_attr_t *)0x0,
                   (__start_routine *)0x213c5, runtime);
    runtime->start_recv = 1;
    if (((use_syslog != false) || (opt_log_output != false)) ||
        (1 < opt_log_level)) {
...

{
    ...
    pthread_join(runtime->chain_status[runtime->chain_id].p_dispatch,
                 (void **)0x0);
...

{
    ...
    init_pcba_args();
    pthread_create(&cgpu.show_id, (pthread_attr_t *)0x0,
                   (__start_routine *)0x20a31, (void *)0x0);
    init_fpga();
    set_fpga_baud('\x1a');
    check_chain();
    if (gChain == 0xff) {
        ...
        pthread_create(&cgpu.pic_heart_beat_id, (pthread_attr_t *)0x0,
                       (__start_routine *)0x1b3e9, chain_info + gChain);
...

{
    ...
    for (i_1 = 0; i_1 < (int)sVar2; i_1 = i_1 + 1) {
        if (((0x2f < (byte)str[i_1]) && ((byte)str[i_1] < 0x3a)) ||
            (str[i_1] == '.')) {
                ...
                if (pcVar2 == (char *)0x0) {
                    ...
                    if (pcVar2 == (char *)0x0) {
                        ...
                        if (pcVar2 == (char *)0x0) {
                            ...
                            if (pcVar2 == (char *)0x0) {
                                ...
                                if (pcVar2 == (char *)0x0) {
                                    ...
                                    if (pcVar2 == (char *)0x0) {
                                        ...
                                        if (pcVar2 == (char *)0x0) {
                                            pcVar2 =
                                                strstr(str, "BringupFreq=");
                                            if (pcVar2 == (char *)0x0) {
                                                pcVar2 = strstr(
                                                    str, "BringupVoltage=");
                                                if (pcVar2 == (char *)0x0) {
                                                    pcVar2 = strstr(
                                                        str, "BringupWorkInterv"
                                                             "alS=");
                                                    if (pcVar2 == (char *)0x0) {
                                                        pcVar2 = strstr(
                                                            str, "BringupAutoJH"
                                                ...
                                                __isoc99_sscanf(
                                                    pcVar2 + 0xc, &DAT_00036910,
                                                    &m_conf->bringup_freq);
                                            }
                                        } else {
                                            __isoc99_sscanf(
                                                pcVar2 + 0xe, &DAT_00036910,
                                                &m_conf->chip_alarm_temp);
                                        }
                                    } else {
                                        __isoc99_sscanf(pcVar2 + 0xc,
                                                        &DAT_0003697c,
                                                        &m_conf->core_timeout);
                                    }
                                } else {
                                    __isoc99_sscanf(pcVar2 + 0xb, &DAT_00036910,
                                                    &m_conf->ticket_mask);
                                }
                            } else {
                            ...
                            __isoc99_sscanf(pcVar2 + 0xd, &DAT_00036910,
                                            &m_conf->enable_cp210x);
                        }
                    } else {
                        iVar1 = parse_config_ini_array(pcVar2 + 10,
                                                       &m_conf->sensor_pos);
                        m_conf->sensor_num = iVar1;
                    }
                } else {
                    iVar1 =
                        parse_config_ini_array(pcVar2 + 8, &m_conf->comport);
...

{
    ...
    snprintf(datetime, 0x40, " [%d-%02d-%02d %02d:%02d:%02d.%03d] ",
...

{
    ...
    g_patten.total_pattens =
        g_patten.patten_num * g_patten.core_num * g_patten.asic_num;
    g_patten.patten_start = (uchar *)malloc(
        g_patten.patten_num * g_patten.core_num * g_patten.asic_num * 0x5d0);
    if (g_patten.patten_start == (uchar *)0x0) {
        printf("%s[%d] malloc failed\n", "patten_info_init", 0x1d);
        /* WARNING: Subroutine does not return */
        exit(1);
    }
    memset(g_patten.patten_start, 0,
           g_patten.patten_num * g_patten.core_num * g_patten.asic_num * 0x5d0);
    g_patten.is_nonce_match = (uchar *)malloc(
        g_patten.patten_num * g_patten.core_num * g_patten.asic_num);
    ...
    memset(g_patten.is_nonce_match, 0,
           g_patten.patten_num * g_patten.core_num * g_patten.asic_num);
    ...
    pthread_mutex_init((pthread_mutex_t *)&g_patten.patten_mutex,
...

{
    ...
    do {
        ...
        for (which_core = 0; which_core < g_patten.core_num;
             which_core = which_core + 1) {
            memset(fname, 0, 0x80);
            sprintf(fname, "%s/%s/%s/%s-0x%02x/%s-0x%02x.txt", root_path,
                    0x4b840, 0x4b850, 0x4b860, which_asic, 0x4b870, which_core);
            printf("fname %s\n", fname);
            ...
            for (which_patten = 0; which_patten < g_patten.patten_num;
                ...
                p = g_patten.patten_start +
                    ...
                    iVar2 * g_patten.patten_num * which_asic *
                        g_patten.core_num +
                    iVar2 * which_patten;
                ...
                hex2bin(p + g_patten.work_bin_len, pcVar1 + 6,
                        g_patten.nonce_bin_len);
                pcVar1 = strstr(buff, "sol");
                hex2bin(p + g_patten.nonce_bin_len + g_patten.work_bin_len,
                        pcVar1 + 4, g_patten.sol_bin_len);
            }
            fclose(__stream);
        }
        which_asic = which_asic + 1;
...

{
    ...
    if (g_patten.cur_asic == asic_index) {
        pthread_mutex_lock((pthread_mutex_t *)&g_patten.patten_mutex);
        iVar1 = memcmp(g_patten.cur_work + g_patten.work_bin_len, nonce,
                       g_patten.nonce_bin_len);
        iVar2 = memcmp(g_patten.cur_work + g_patten.nonce_bin_len +
                           g_patten.work_bin_len,
                       sol, g_patten.sol_bin_len);
        if ((iVar1 == 0) && (iVar2 == 0)) {
            g_patten.is_nonce_match[g_patten.cur_patten +
                                    g_patten.patten_num *
                                        (g_patten.core_num * g_patten.cur_asic +
                                         g_patten.cur_core)] = '\x01';
            g_patten.recv_nonces = g_patten.recv_nonces + 1;
            g_patten.total_rate = (float)(longlong)g_patten.recv_nonces /
                                  (float)(longlong)g_patten.total_pattens;
            ...
            dump_str(stderr, "Not Match Expect:",
...

{
    ...
    if (RVar1 == RT_RINGBUFFER_EMPTY) {
        ...
        uVar2 = rb->buffer_size;
               ...
               ((uint) * (ushort *)&rb->field_0x6 << 0x10) >> 0x11) {
        uVar2 =
            (*(ushort *)&rb->field_0x6 >> 1) - (*(ushort *)&rb->field_0x4 >> 1);
    } else {
        uVar2 = ((*(ushort *)&rb->field_0x6 >> 1) -
...

{
    ...
    *(ushort *)&rb->field_0x4 = *(ushort *)&rb->field_0x4 & 1;
    rb->field_0x4 =
        rb->field_0x4 & 0xfe |
        (byte)(((uint) * (ushort *)&rb->field_0x4 << 0x10) >> 0x11) & 1;
    *(ushort *)&rb->field_0x6 = *(ushort *)&rb->field_0x6 & 1;
    rb->field_0x6 =
        rb->field_0x6 & 0xfe |
        (byte)(((uint) * (ushort *)&rb->field_0x6 << 0x10) >> 0x11) & 1;
    rb->buffer_ptr = pool;
    rb->buffer_size = size & 0xfffc;
    rb->ringbuffer_type = ringbuffer_type;
    pthread_mutex_init((pthread_mutex_t *)&rb->ringbuf_lock,
                       (pthread_mutexattr_t *)0x0);
    if (rb->ringbuffer_type == BLOCK_TYPE) {
        pthread_cond_init((pthread_cond_t *)&rb->notfull,
                          (pthread_condattr_t *)0x0);
        pthread_cond_init((pthread_cond_t *)&rb->notempty,
                          (pthread_condattr_t *)0x0);
    }
    return;
}
...

{
    ...
    if (rb->ringbuffer_type == POLL_TYPE) {
        ...
        if (rb->ringbuffer_type == BLOCK_TYPE) {
            while (size < length) {
                pthread_cond_wait((pthread_cond_t *)&rb->notfull,
                                  (pthread_mutex_t *)&rb->ringbuf_lock);
                uVar1 = rb->buffer_size;
                uVar2 = rt_ringbuffer_data_len(rb);
                size = uVar1 - uVar2;
            }
    ...
    if ((int)(uint)length_local <
        (int)((uint)rb->buffer_size -
              (((uint) * (ushort *)&rb->field_0x6 << 0x10) >> 0x11))) {
        memcpy(rb->buffer_ptr +
                   (((uint) * (ushort *)&rb->field_0x6 << 0x10) >> 0x11),
               ptr, (uint)length_local);
        *(ushort *)&rb->field_0x6 =
            *(ushort *)&rb->field_0x6 & 1 |
            (ushort)(((uint)length_local +
                          (((uint) * (ushort *)&rb->field_0x6 << 0x10) >>
                           0x11) &
                      0x7fff)
                     << 1);
        ...
        rb->field_0x6 =
            rb->field_0x6 & 0xfe |
            ~(byte)(((uint)(byte)rb->field_0x6 << 0x1f) >> 0x1f) & 1;
        *(ushort *)&rb->field_0x6 =
            *(ushort *)&rb->field_0x6 & 1 |
            (ushort)(((uint)length_local +
                          ((((uint) * (ushort *)&rb->field_0x6 << 0x10) >>
...
uint32_t rt_ringbuffer_put_force(rt_ringbuffer *rb, uint8_t *ptr,
                                 uint16_t length)
    ...
    if ((int)(uint)length_local <
        ...
        *(ushort *)&rb->field_0x6 =
        ...
        if (uVar1 < length_local) {
            *(ushort *)&rb->field_0x4 =
                *(ushort *)&rb->field_0x4 & 1 |
                (ushort)((((uint) * (ushort *)&rb->field_0x6 << 0x10) >> 0x11)
                         << 1);
        }
        pthread_cond_signal((pthread_cond_t *)&rb->notempty);
        pthread_mutex_unlock((pthread_mutex_t *)&rb->ringbuf_lock);
        ...
        *(ushort *)&rb->field_0x6 =
        ...
        if (uVar1 < length_local) {
            rb->field_0x4 =
                rb->field_0x4 & 0xfe |
                ~(byte)(((uint)(byte)rb->field_0x4 << 0x1f) >> 0x1f) & 1;
            *(ushort *)&rb->field_0x4 =
                *(ushort *)&rb->field_0x4 & 1 |
                (ushort)((((uint) * (ushort *)&rb->field_0x6 << 0x10) >> 0x11)
                         << 1);
...

{
    ...
    if (rb->ringbuffer_type == POLL_TYPE) {
        ...
        if (rb->ringbuffer_type == BLOCK_TYPE) {
            while (size < length) {
                pthread_cond_wait((pthread_cond_t *)&rb->notempty,
                                  (pthread_mutex_t *)&rb->ringbuf_lock);
                uVar1 = rt_ringbuffer_data_len(rb);
                size = (uint32_t)uVar1;
            }
    ...
    if ((int)(uint)length_local <
        (int)((uint)rb->buffer_size -
              (((uint) * (ushort *)&rb->field_0x4 << 0x10) >> 0x11))) {
        memcpy(ptr,
               rb->buffer_ptr +
                   (((uint) * (ushort *)&rb->field_0x4 << 0x10) >> 0x11),
               (uint)length_local);
        *(ushort *)&rb->field_0x4 =
        ...
        memcpy(ptr,
               ...
               (uint)rb->buffer_size -
                   (((uint) * (ushort *)&rb->field_0x4 << 0x10) >> 0x11));
        memcpy(ptr + ((uint)rb->buffer_size -
                      (((uint) * (ushort *)&rb->field_0x4 << 0x10) >> 0x11)),
               rb->buffer_ptr,
               (uint)length_local -
                   ((uint)rb->buffer_size -
...
uint32_t rt_ringbuffer_prefetch(rt_ringbuffer *rb, uint8_t *ptr,
                                uint16_t length)
...

{
    ...
    snprintf(datetime, 0x40, " [%d-%02d-%02d %02d:%02d:%02d.%03d] ",
             ...
             ptVar2->tm_hour, ptVar2->tm_min, ptVar2->tm_sec, iVar1);
...

{
    ...
    while (true) {
        ...
        if ((hex2bin_tbl[bVar1] < 0) || (hex2bin_tbl[*pbVar2] < 0))
            break;
        *p_local = (byte)hex2bin_tbl[*pbVar2] |
                   (byte)((hex2bin_tbl[bVar1] & 0xffU) << 4);
...

{
    ...
    *(uint *)dest_p = uVar1 << 0x18 | (uVar1 >> 8 & 0xff) << 0x10 |
                      (uVar1 >> 0x10 & 0xff) << 8 | uVar1 >> 0x18;
    uVar1 = *(uint *)((int)src_p + 0x18);
    *(uint *)((int)dest_p + 4) = uVar1 << 0x18 | (uVar1 >> 8 & 0xff) << 0x10 |
                                 (uVar1 >> 0x10 & 0xff) << 8 | uVar1 >> 0x18;
    uVar1 = *(uint *)((int)src_p + 0x14);
    *(uint *)((int)dest_p + 8) = uVar1 << 0x18 | (uVar1 >> 8 & 0xff) << 0x10 |
                                 (uVar1 >> 0x10 & 0xff) << 8 | uVar1 >> 0x18;
    uVar1 = *(uint *)((int)src_p + 0x10);
    *(uint *)((int)dest_p + 0xc) = uVar1 << 0x18 | (uVar1 >> 8 & 0xff) << 0x10 |
                                   (uVar1 >> 0x10 & 0xff) << 8 | uVar1 >> 0x18;
    uVar1 = *(uint *)((int)src_p + 0xc);
    *(uint *)((int)dest_p + 0x10) = uVar1 << 0x18 |
                                    (uVar1 >> 8 & 0xff) << 0x10 |
                                    (uVar1 >> 0x10 & 0xff) << 8 | uVar1 >> 0x18;
    uVar1 = *(uint *)((int)src_p + 8);
    *(uint *)((int)dest_p + 0x14) = uVar1 << 0x18 |
                                    (uVar1 >> 8 & 0xff) << 0x10 |
                                    (uVar1 >> 0x10 & 0xff) << 8 | uVar1 >> 0x18;
    uVar1 = *(uint *)((int)src_p + 4);
    *(uint *)((int)dest_p + 0x18) = uVar1 << 0x18 |
                                    (uVar1 >> 8 & 0xff) << 0x10 |
                                    (uVar1 >> 0x10 & 0xff) << 8 | uVar1 >> 0x18;
    /* WARNING: Load size is inaccurate */
    uVar1 = *src_p;
    *(uint *)((int)dest_p + 0x1c) = uVar1 << 0x18 |
                                    (uVar1 >> 8 & 0xff) << 0x10 |
                                    (uVar1 >> 0x10 & 0xff) << 8 | uVar1 >> 0x18;
    return;
}
...

{
    ...
    uVar1 = -c & 0x3f;
    return CONCAT44(w_local._4_4_ << uVar1 |
                        (uint)w_local << (uVar1 - 0x20 & 0xff) |
                        (uint)w_local >> (0x20 - uVar1 & 0xff) |
                        w_local._4_4_ >> (c & 0xff),
                    (uint)w_local << uVar1 | (uint)w_local >> (c & 0xff) |
                        w_local._4_4_ << (0x20 - c & 0xff) |
...

{
    ...
    *(uint *)((int)S->t + 0xc) =
        *(int *)((int)S->t + 0xc) + (uint)CARRY4((uint)bVar2, uVar1);
    return 0;
}
...

{
    ...
    v[0]._4_4_ = m[0]._4_4_ + v[0]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0], uVar1);
    uVar6 =
        rotr64(CONCAT44(v[0]._4_4_ ^ v[0xc]._4_4_, (uint)v[0] ^ uVar2), 0x20);
    ...
    v[0xc] = uVar6;
    uVar6 = rotr64(CONCAT44(v[8]._4_4_ ^ v[4]._4_4_, (uint)v[8] ^ (uint)v[4]),
                   0x18);
    ...
    v[0]._4_4_ = m[1]._4_4_ + v[0]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[1], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xc]._4_4_, (uint)v[0] ^ (uint)v[0xc]), 0x10);
    v[0xc]._0_4_ = (uint)uVar6;
    v[0xc]._4_4_ = (uint)(uVar6 >> 0x20);
    bVar5 = CARRY4((uint)v[0xc], (uint)v[8]);
    v[8]._0_4_ = (uint)v[0xc] + (uint)v[8];
    v[8]._4_4_ = v[0xc]._4_4_ + v[8]._4_4_ + bVar5;
    v[0xc] = uVar6;
    v[4] = rotr64(CONCAT44(v[8]._4_4_ ^ v[4]._4_4_, (uint)v[8] ^ (uint)v[4]),
                  0x3f);
    bVar5 = CARRY4((uint)v[1], (uint)v[5]);
    uVar2 = (uint)v[1] + (uint)v[5];
    v[1]._0_4_ = (uint)m[2] + uVar2;
    v[1]._4_4_ = m[2]._4_4_ + v[1]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[2], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xd]._4_4_, (uint)v[1] ^ (uint)v[0xd]), 0x20);
    ...
    v[0xd] = uVar6;
    uVar6 = rotr64(CONCAT44(v[9]._4_4_ ^ v[5]._4_4_, (uint)v[9] ^ (uint)v[5]),
                   0x18);
    ...
    v[1]._4_4_ = m[3]._4_4_ + v[1]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[3], uVar2);
    v[5] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xd]._4_4_, (uint)v[1] ^ (uint)v[0xd]), 0x10);
    v[0xd]._0_4_ = (uint)uVar6;
    v[0xd]._4_4_ = (uint)(uVar6 >> 0x20);
    bVar5 = CARRY4((uint)v[0xd], (uint)v[9]);
    v[9]._0_4_ = (uint)v[0xd] + (uint)v[9];
    v[9]._4_4_ = v[0xd]._4_4_ + v[9]._4_4_ + bVar5;
    v[0xd] = uVar6;
    v[5] = rotr64(CONCAT44(v[9]._4_4_ ^ v[5]._4_4_, (uint)v[9] ^ (uint)v[5]),
                  0x3f);
    bVar5 = CARRY4((uint)v[2], (uint)v[6]);
    uVar2 = (uint)v[2] + (uint)v[6];
    v[2]._0_4_ = (uint)m[4] + uVar2;
    v[2]._4_4_ = m[4]._4_4_ + v[2]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[4], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xe]._4_4_, (uint)v[2] ^ (uint)v[0xe]), 0x20);
    ...
    v[0xe] = uVar6;
    uVar6 = rotr64(CONCAT44(v[10]._4_4_ ^ v[6]._4_4_, (uint)v[10] ^ (uint)v[6]),
                   0x18);
    ...
    v[2]._4_4_ = m[5]._4_4_ + v[2]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[5], uVar2);
    v[6] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xe]._4_4_, (uint)v[2] ^ (uint)v[0xe]), 0x10);
    v[0xe]._0_4_ = (uint)uVar6;
    v[0xe]._4_4_ = (uint)(uVar6 >> 0x20);
    bVar5 = CARRY4((uint)v[0xe], (uint)v[10]);
    v[10]._0_4_ = (uint)v[0xe] + (uint)v[10];
    v[10]._4_4_ = v[0xe]._4_4_ + v[10]._4_4_ + bVar5;
    v[0xe] = uVar6;
    v[6] = rotr64(CONCAT44(v[10]._4_4_ ^ v[6]._4_4_, (uint)v[10] ^ (uint)v[6]),
                  0x3f);
    bVar5 = CARRY4((uint)v[3], (uint)v[7]);
    uVar2 = (uint)v[3] + (uint)v[7];
    v[3]._0_4_ = (uint)m[6] + uVar2;
    v[3]._4_4_ = m[6]._4_4_ + v[3]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[6], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xf]._4_4_, (uint)v[3] ^ (uint)v[0xf]), 0x20);
    ...
    v[0xf] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0xb]._4_4_ ^ v[7]._4_4_, (uint)v[0xb] ^ (uint)v[7]), 0x18);
    v[7]._0_4_ = (uint)uVar6;
    v[7]._4_4_ = (uint)(uVar6 >> 0x20);
    bVar5 = CARRY4((uint)v[3], (uint)v[7]);
    uVar2 = (uint)v[3] + (uint)v[7];
    v[3]._0_4_ = (uint)m[7] + uVar2;
    v[3]._4_4_ = m[7]._4_4_ + v[3]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[7], uVar2);
    v[7] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xf]._4_4_, (uint)v[3] ^ (uint)v[0xf]), 0x10);
    v[0xf]._0_4_ = (uint)uVar6;
    v[0xf]._4_4_ = (uint)(uVar6 >> 0x20);
    bVar5 = CARRY4((uint)v[0xf], (uint)v[0xb]);
    v[0xb]._0_4_ = (uint)v[0xf] + (uint)v[0xb];
    ...
    v[0xf] = uVar6;
    v[7] = rotr64(
        CONCAT44(v[0xb]._4_4_ ^ v[7]._4_4_, (uint)v[0xb] ^ (uint)v[7]), 0x3f);
    bVar5 = CARRY4((uint)v[0], (uint)v[5]);
    uVar2 = (uint)v[0] + (uint)v[5];
    v[0]._0_4_ = (uint)m[8] + uVar2;
    v[0]._4_4_ = m[8]._4_4_ + v[0]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[8], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xf]._4_4_, (uint)v[0] ^ (uint)v[0xf]), 0x20);
    v[0xf]._0_4_ = (uint)uVar6;
    v[0xf]._4_4_ = (uint)(uVar6 >> 0x20);
    ...
    v[0xf] = uVar6;
    uVar6 = rotr64(CONCAT44(v[10]._4_4_ ^ v[5]._4_4_, (uint)v[10] ^ (uint)v[5]),
                   0x18);
    v[5]._0_4_ = (uint)uVar6;
    v[5]._4_4_ = (uint)(uVar6 >> 0x20);
    bVar5 = CARRY4((uint)v[0], (uint)v[5]);
    ...
    v[0]._4_4_ = m[9]._4_4_ + v[0]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[9], uVar2);
    v[5] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xf]._4_4_, (uint)v[0] ^ (uint)v[0xf]), 0x10);
    v[0xf]._0_4_ = (uint)uVar6;
    v[0xf]._4_4_ = (uint)(uVar6 >> 0x20);
    bVar5 = CARRY4((uint)v[0xf], (uint)v[10]);
    v[10]._0_4_ = (uint)v[0xf] + (uint)v[10];
    v[10]._4_4_ = v[0xf]._4_4_ + v[10]._4_4_ + bVar5;
    v[0xf] = uVar6;
    v[5] = rotr64(CONCAT44(v[10]._4_4_ ^ v[5]._4_4_, (uint)v[10] ^ (uint)v[5]),
                  0x3f);
    bVar5 = CARRY4((uint)v[1], (uint)v[6]);
    uVar2 = (uint)v[1] + (uint)v[6];
    v[1]._0_4_ = (uint)m[10] + uVar2;
    v[1]._4_4_ = m[10]._4_4_ + v[1]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[10], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xc]._4_4_, (uint)v[1] ^ (uint)v[0xc]), 0x20);
    v[0xc]._0_4_ = (uint)uVar6;
    v[0xc]._4_4_ = (uint)(uVar6 >> 0x20);
    ...
    v[0xc] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0xb]._4_4_ ^ v[6]._4_4_, (uint)v[0xb] ^ (uint)v[6]), 0x18);
    v[6]._0_4_ = (uint)uVar6;
    v[6]._4_4_ = (uint)(uVar6 >> 0x20);
    bVar5 = CARRY4((uint)v[1], (uint)v[6]);
    uVar2 = (uint)v[1] + (uint)v[6];
    v[1]._0_4_ = (uint)m[0xb] + uVar2;
    v[1]._4_4_ = m[0xb]._4_4_ + v[1]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xb], uVar2);
    v[6] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xc]._4_4_, (uint)v[1] ^ (uint)v[0xc]), 0x10);
    v[0xc]._0_4_ = (uint)uVar6;
    v[0xc]._4_4_ = (uint)(uVar6 >> 0x20);
    bVar5 = CARRY4((uint)v[0xc], (uint)v[0xb]);
    v[0xb]._0_4_ = (uint)v[0xc] + (uint)v[0xb];
    ...
    v[0xc] = uVar6;
    v[6] = rotr64(
        CONCAT44(v[0xb]._4_4_ ^ v[6]._4_4_, (uint)v[0xb] ^ (uint)v[6]), 0x3f);
    bVar5 = CARRY4((uint)v[2], (uint)v[7]);
    uVar2 = (uint)v[2] + (uint)v[7];
    v[2]._0_4_ = (uint)m[0xc] + uVar2;
    v[2]._4_4_ = m[0xc]._4_4_ + v[2]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xc], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xd]._4_4_, (uint)v[2] ^ (uint)v[0xd]), 0x20);
    v[0xd]._0_4_ = (uint)uVar6;
    v[0xd]._4_4_ = (uint)(uVar6 >> 0x20);
    ...
    v[0xd] = uVar6;
    uVar6 = rotr64(CONCAT44(v[8]._4_4_ ^ v[7]._4_4_, (uint)v[8] ^ (uint)v[7]),
                   0x18);
    v[7]._0_4_ = (uint)uVar6;
    v[7]._4_4_ = (uint)(uVar6 >> 0x20);
    bVar5 = CARRY4((uint)v[2], (uint)v[7]);
    ...
    v[2]._4_4_ = m[0xd]._4_4_ + v[2]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xd], uVar2);
    v[7] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xd]._4_4_, (uint)v[2] ^ (uint)v[0xd]), 0x10);
    v[0xd]._0_4_ = (uint)uVar6;
    v[0xd]._4_4_ = (uint)(uVar6 >> 0x20);
    bVar5 = CARRY4((uint)v[0xd], (uint)v[8]);
    v[8]._0_4_ = (uint)v[0xd] + (uint)v[8];
    v[8]._4_4_ = v[0xd]._4_4_ + v[8]._4_4_ + bVar5;
    v[0xd] = uVar6;
    v[7] = rotr64(CONCAT44(v[8]._4_4_ ^ v[7]._4_4_, (uint)v[8] ^ (uint)v[7]),
                  0x3f);
    bVar5 = CARRY4((uint)v[3], (uint)v[4]);
    uVar2 = (uint)v[3] + (uint)v[4];
    v[3]._0_4_ = (uint)m[0xe] + uVar2;
    v[3]._4_4_ = m[0xe]._4_4_ + v[3]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xe], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xe]._4_4_, (uint)v[3] ^ (uint)v[0xe]), 0x20);
    v[0xe]._0_4_ = (uint)uVar6;
    v[0xe]._4_4_ = (uint)(uVar6 >> 0x20);
    ...
    v[0xe] = uVar6;
    uVar6 = rotr64(CONCAT44(v[9]._4_4_ ^ v[4]._4_4_, (uint)v[9] ^ (uint)v[4]),
                   0x18);
    v[4]._0_4_ = (uint)uVar6;
    v[4]._4_4_ = (uint)(uVar6 >> 0x20);
    bVar5 = CARRY4((uint)v[3], (uint)v[4]);
    ...
    v[3]._4_4_ = m[0xf]._4_4_ + v[3]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xf], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xe]._4_4_, (uint)v[3] ^ (uint)v[0xe]), 0x10);
    v[0xe]._0_4_ = (uint)uVar6;
    v[0xe]._4_4_ = (uint)(uVar6 >> 0x20);
    bVar5 = CARRY4((uint)v[0xe], (uint)v[9]);
    v[9]._0_4_ = (uint)v[0xe] + (uint)v[9];
    ...
    v[0]._4_4_ = m[0xe]._4_4_ + v[0]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xe], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xc]._4_4_, (uint)v[0] ^ (uint)v[0xc]), 0x20);
    v[0xc]._0_4_ = (uint)uVar6;
    v[0xc]._4_4_ = (uint)(uVar6 >> 0x20);
    bVar5 = CARRY4((uint)v[0xc], (uint)v[8]);
    v[8]._0_4_ = (uint)v[0xc] + (uint)v[8];
    ...
    v[0]._4_4_ = m[10]._4_4_ + v[0]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[10], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xc]._4_4_, (uint)v[0] ^ (uint)v[0xc]), 0x10);
    ...
    v[1]._4_4_ = m[4]._4_4_ + v[1]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[4], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xd]._4_4_, (uint)v[1] ^ (uint)v[0xd]), 0x20);
    v[0xd]._0_4_ = (uint)uVar6;
    ...
    v[1]._4_4_ = m[8]._4_4_ + v[1]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[8], uVar2);
    v[5] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xd]._4_4_, (uint)v[1] ^ (uint)v[0xd]), 0x10);
    ...
    v[2]._4_4_ = m[9]._4_4_ + v[2]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[9], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xe]._4_4_, (uint)v[2] ^ (uint)v[0xe]), 0x20);
    v[0xe]._0_4_ = (uint)uVar6;
    ...
    v[2]._4_4_ = m[0xf]._4_4_ + v[2]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xf], uVar2);
    v[6] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xe]._4_4_, (uint)v[2] ^ (uint)v[0xe]), 0x10);
    ...
    v[3]._4_4_ = m[0xd]._4_4_ + v[3]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xd], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xf]._4_4_, (uint)v[3] ^ (uint)v[0xf]), 0x20);
    v[0xf]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[0] + (uint)v[5];
    v[0]._0_4_ = (uint)m[1] + uVar2;
    v[0]._4_4_ = m[1]._4_4_ + v[0]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[1], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xf]._4_4_, (uint)v[0] ^ (uint)v[0xf]), 0x20);
    v[0xf]._0_4_ = (uint)uVar6;
    ...
    v[0]._4_4_ = m[0xc]._4_4_ + v[0]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xc], uVar2);
    v[5] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xf]._4_4_, (uint)v[0] ^ (uint)v[0xf]), 0x10);
    ...
    v[1]._4_4_ = m[0]._4_4_ + v[1]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xc]._4_4_, (uint)v[1] ^ (uint)v[0xc]), 0x20);
    v[0xc]._0_4_ = (uint)uVar6;
    v[0xc]._4_4_ = (uint)(uVar6 >> 0x20);
    ...
    uVar2 = (uint)v[1] + (uint)v[6];
    v[1]._0_4_ = (uint)m[2] + uVar2;
    v[1]._4_4_ = m[2]._4_4_ + v[1]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[2], uVar2);
    v[6] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xc]._4_4_, (uint)v[1] ^ (uint)v[0xc]), 0x10);
    ...
    v[2]._4_4_ = m[0xb]._4_4_ + v[2]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xb], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xd]._4_4_, (uint)v[2] ^ (uint)v[0xd]), 0x20);
    v[0xd]._0_4_ = (uint)uVar6;
    ...
    v[2]._4_4_ = m[7]._4_4_ + v[2]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[7], uVar2);
    v[7] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xd]._4_4_, (uint)v[2] ^ (uint)v[0xd]), 0x10);
    ...
    v[3]._4_4_ = m[5]._4_4_ + v[3]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[5], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xe]._4_4_, (uint)v[3] ^ (uint)v[0xe]), 0x20);
    v[0xe]._0_4_ = (uint)uVar6;
    ...
    v[3]._4_4_ = m[3]._4_4_ + v[3]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[3], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xe]._4_4_, (uint)v[3] ^ (uint)v[0xe]), 0x10);
    ...
    v[0]._4_4_ = m[0xb]._4_4_ + v[0]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xb], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xc]._4_4_, (uint)v[0] ^ (uint)v[0xc]), 0x20);
    ...
    uVar2 = (uint)v[0] + (uint)v[4];
    v[0]._0_4_ = (uint)m[8] + uVar2;
    v[0]._4_4_ = m[8]._4_4_ + v[0]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[8], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xc]._4_4_, (uint)v[0] ^ (uint)v[0xc]), 0x10);
    ...
    v[1]._4_4_ = m[0xc]._4_4_ + v[1]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xc], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xd]._4_4_, (uint)v[1] ^ (uint)v[0xd]), 0x20);
    v[0xd]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[1] + (uint)v[5];
    v[1]._0_4_ = (uint)m[0] + uVar2;
    v[1]._4_4_ = m[0]._4_4_ + v[1]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0], uVar2);
    v[5] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xd]._4_4_, (uint)v[1] ^ (uint)v[0xd]), 0x10);
    ...
    v[2]._4_4_ = m[2]._4_4_ + v[2]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[2], uVar2);
    v[6] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xe]._4_4_, (uint)v[2] ^ (uint)v[0xe]), 0x10);
    ...
    uVar2 = (uint)v[3] + (uint)v[7];
    v[3]._0_4_ = (uint)m[0xf] + uVar2;
    v[3]._4_4_ = m[0xf]._4_4_ + v[3]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xf], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xf]._4_4_, (uint)v[3] ^ (uint)v[0xf]), 0x20);
    v[0xf]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[0] + (uint)v[5];
    v[0]._0_4_ = (uint)m[10] + uVar2;
    v[0]._4_4_ = m[10]._4_4_ + v[0]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[10], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xf]._4_4_, (uint)v[0] ^ (uint)v[0xf]), 0x20);
    v[0xf]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[0] + (uint)v[5];
    v[0]._0_4_ = (uint)m[0xe] + uVar2;
    v[0]._4_4_ = m[0xe]._4_4_ + v[0]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xe], uVar2);
    v[5] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xf]._4_4_, (uint)v[0] ^ (uint)v[0xf]), 0x10);
    ...
    uVar2 = (uint)v[1] + (uint)v[6];
    v[1]._0_4_ = (uint)m[3] + uVar2;
    v[1]._4_4_ = m[3]._4_4_ + v[1]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[3], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xc]._4_4_, (uint)v[1] ^ (uint)v[0xc]), 0x20);
    v[0xc]._0_4_ = (uint)uVar6;
    ...
    v[1]._4_4_ = m[6]._4_4_ + v[1]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[6], uVar2);
    v[6] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xc]._4_4_, (uint)v[1] ^ (uint)v[0xc]), 0x10);
    ...
    v[2]._4_4_ = m[1]._4_4_ + v[2]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[1], uVar2);
    v[7] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xd]._4_4_, (uint)v[2] ^ (uint)v[0xd]), 0x10);
    ...
    v[3]._4_4_ = m[9]._4_4_ + v[3]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[9], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xe]._4_4_, (uint)v[3] ^ (uint)v[0xe]), 0x20);
    v[0xe]._0_4_ = (uint)uVar6;
    ...
    v[3]._4_4_ = m[4]._4_4_ + v[3]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[4], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xe]._4_4_, (uint)v[3] ^ (uint)v[0xe]), 0x10);
    ...
    v[0]._4_4_ = m[7]._4_4_ + v[0]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[7], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xc]._4_4_, (uint)v[0] ^ (uint)v[0xc]), 0x20);
    ...
    uVar2 = (uint)v[0] + (uint)v[4];
    v[0]._0_4_ = (uint)m[9] + uVar2;
    v[0]._4_4_ = m[9]._4_4_ + v[0]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[9], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xc]._4_4_, (uint)v[0] ^ (uint)v[0xc]), 0x10);
    ...
    v[1]._4_4_ = m[1]._4_4_ + v[1]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[1], uVar2);
    v[5] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xd]._4_4_, (uint)v[1] ^ (uint)v[0xd]), 0x10);
    ...
    uVar2 = (uint)v[2] + (uint)v[6];
    v[2]._0_4_ = (uint)m[0xd] + uVar2;
    v[2]._4_4_ = m[0xd]._4_4_ + v[2]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xd], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xe]._4_4_, (uint)v[2] ^ (uint)v[0xe]), 0x20);
    v[0xe]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[2] + (uint)v[6];
    v[2]._0_4_ = (uint)m[0xc] + uVar2;
    v[2]._4_4_ = m[0xc]._4_4_ + v[2]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xc], uVar2);
    v[6] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xe]._4_4_, (uint)v[2] ^ (uint)v[0xe]), 0x10);
    ...
    v[3]._4_4_ = m[0xb]._4_4_ + v[3]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xb], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xf]._4_4_, (uint)v[3] ^ (uint)v[0xf]), 0x20);
    v[0xf]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[3] + (uint)v[7];
    v[3]._0_4_ = (uint)m[0xe] + uVar2;
    v[3]._4_4_ = m[0xe]._4_4_ + v[3]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xe], uVar2);
    v[7] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xf]._4_4_, (uint)v[3] ^ (uint)v[0xf]), 0x10);
    ...
    v[0]._4_4_ = m[2]._4_4_ + v[0]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[2], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xf]._4_4_, (uint)v[0] ^ (uint)v[0xf]), 0x20);
    v[0xf]._0_4_ = (uint)uVar6;
    ...
    v[0]._4_4_ = m[6]._4_4_ + v[0]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[6], uVar2);
    v[5] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xf]._4_4_, (uint)v[0] ^ (uint)v[0xf]), 0x10);
    ...
    v[1]._4_4_ = m[5]._4_4_ + v[1]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[5], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xc]._4_4_, (uint)v[1] ^ (uint)v[0xc]), 0x20);
    v[0xc]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[2] + (uint)v[7];
    v[2]._0_4_ = (uint)m[4] + uVar2;
    v[2]._4_4_ = m[4]._4_4_ + v[2]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[4], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xd]._4_4_, (uint)v[2] ^ (uint)v[0xd]), 0x20);
    v[0xd]._0_4_ = (uint)uVar6;
    ...
    v[2]._4_4_ = m[0]._4_4_ + v[2]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0], uVar2);
    v[7] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xd]._4_4_, (uint)v[2] ^ (uint)v[0xd]), 0x10);
    ...
    v[3]._4_4_ = m[8]._4_4_ + v[3]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[8], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xe]._4_4_, (uint)v[3] ^ (uint)v[0xe]), 0x10);
    ...
    uVar2 = (uint)v[1] + (uint)v[5];
    v[1]._0_4_ = (uint)m[5] + uVar2;
    v[1]._4_4_ = m[5]._4_4_ + v[1]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[5], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xd]._4_4_, (uint)v[1] ^ (uint)v[0xd]), 0x20);
    v[0xd]._0_4_ = (uint)uVar6;
    ...
    v[1]._4_4_ = m[7]._4_4_ + v[1]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[7], uVar2);
    v[5] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xd]._4_4_, (uint)v[1] ^ (uint)v[0xd]), 0x10);
    ...
    v[3]._4_4_ = m[10]._4_4_ + v[3]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[10], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xf]._4_4_, (uint)v[3] ^ (uint)v[0xf]), 0x20);
    v[0xf]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[1] + (uint)v[6];
    v[1]._0_4_ = (uint)m[0xc] + uVar2;
    v[1]._4_4_ = m[0xc]._4_4_ + v[1]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xc], uVar2);
    v[6] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xc]._4_4_, (uint)v[1] ^ (uint)v[0xc]), 0x10);
    ...
    v[2]._4_4_ = m[6]._4_4_ + v[2]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[6], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xd]._4_4_, (uint)v[2] ^ (uint)v[0xd]), 0x20);
    v[0xd]._0_4_ = (uint)uVar6;
    ...
    v[2]._4_4_ = m[8]._4_4_ + v[2]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[8], uVar2);
    v[7] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xd]._4_4_, (uint)v[2] ^ (uint)v[0xd]), 0x10);
    ...
    uVar2 = (uint)v[3] + (uint)v[4];
    v[3]._0_4_ = (uint)m[0xd] + uVar2;
    v[3]._4_4_ = m[0xd]._4_4_ + v[3]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xd], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xe]._4_4_, (uint)v[3] ^ (uint)v[0xe]), 0x10);
    ...
    uVar2 = (uint)v[0] + (uint)v[4];
    v[0]._0_4_ = (uint)m[2] + uVar2;
    v[0]._4_4_ = m[2]._4_4_ + v[0]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[2], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xc]._4_4_, (uint)v[0] ^ (uint)v[0xc]), 0x20);
    ...
    uVar2 = (uint)v[0] + (uint)v[4];
    v[0]._0_4_ = (uint)m[0xc] + uVar2;
    v[0]._4_4_ = m[0xc]._4_4_ + v[0]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xc], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xc]._4_4_, (uint)v[0] ^ (uint)v[0xc]), 0x10);
    ...
    uVar2 = (uint)v[1] + (uint)v[5];
    v[1]._0_4_ = (uint)m[6] + uVar2;
    v[1]._4_4_ = m[6]._4_4_ + v[1]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[6], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xd]._4_4_, (uint)v[1] ^ (uint)v[0xd]), 0x20);
    v[0xd]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[1] + (uint)v[5];
    v[1]._0_4_ = (uint)m[10] + uVar2;
    v[1]._4_4_ = m[10]._4_4_ + v[1]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[10], uVar2);
    v[5] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xd]._4_4_, (uint)v[1] ^ (uint)v[0xd]), 0x10);
    ...
    uVar2 = (uint)v[2] + (uint)v[6];
    v[2]._0_4_ = (uint)m[0] + uVar2;
    v[2]._4_4_ = m[0]._4_4_ + v[2]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xe]._4_4_, (uint)v[2] ^ (uint)v[0xe]), 0x20);
    v[0xe]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[2] + (uint)v[6];
    v[2]._0_4_ = (uint)m[0xb] + uVar2;
    v[2]._4_4_ = m[0xb]._4_4_ + v[2]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xb], uVar2);
    v[6] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xe]._4_4_, (uint)v[2] ^ (uint)v[0xe]), 0x10);
    ...
    uVar2 = (uint)v[3] + (uint)v[7];
    v[3]._0_4_ = (uint)m[8] + uVar2;
    v[3]._4_4_ = m[8]._4_4_ + v[3]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[8], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xf]._4_4_, (uint)v[3] ^ (uint)v[0xf]), 0x20);
    v[0xf]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[3] + (uint)v[7];
    v[3]._0_4_ = (uint)m[3] + uVar2;
    v[3]._4_4_ = m[3]._4_4_ + v[3]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[3], uVar2);
    v[7] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xf]._4_4_, (uint)v[3] ^ (uint)v[0xf]), 0x10);
    ...
    v[0]._4_4_ = m[4]._4_4_ + v[0]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[4], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xf]._4_4_, (uint)v[0] ^ (uint)v[0xf]), 0x20);
    v[0xf]._0_4_ = (uint)uVar6;
    ...
    v[0]._4_4_ = m[0xd]._4_4_ + v[0]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xd], uVar2);
    v[5] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xf]._4_4_, (uint)v[0] ^ (uint)v[0xf]), 0x10);
    ...
    uVar2 = (uint)v[1] + (uint)v[6];
    v[1]._0_4_ = (uint)m[7] + uVar2;
    v[1]._4_4_ = m[7]._4_4_ + v[1]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[7], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xc]._4_4_, (uint)v[1] ^ (uint)v[0xc]), 0x20);
    v[0xc]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[2] + (uint)v[7];
    v[2]._0_4_ = (uint)m[0xf] + uVar2;
    v[2]._4_4_ = m[0xf]._4_4_ + v[2]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xf], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xd]._4_4_, (uint)v[2] ^ (uint)v[0xd]), 0x20);
    v[0xd]._0_4_ = (uint)uVar6;
    ...
    v[2]._4_4_ = m[0xe]._4_4_ + v[2]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xe], uVar2);
    v[7] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xd]._4_4_, (uint)v[2] ^ (uint)v[0xd]), 0x10);
    ...
    v[3]._4_4_ = m[1]._4_4_ + v[3]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[1], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xe]._4_4_, (uint)v[3] ^ (uint)v[0xe]), 0x20);
    v[0xe]._0_4_ = (uint)uVar6;
    ...
    v[0]._4_4_ = m[5]._4_4_ + v[0]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[5], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xc]._4_4_, (uint)v[0] ^ (uint)v[0xc]), 0x10);
    ...
    v[1]._4_4_ = m[0xf]._4_4_ + v[1]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xf], uVar2);
    v[5] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xd]._4_4_, (uint)v[1] ^ (uint)v[0xd]), 0x10);
    ...
    uVar2 = (uint)v[2] + (uint)v[6];
    v[2]._0_4_ = (uint)m[0xe] + uVar2;
    v[2]._4_4_ = m[0xe]._4_4_ + v[2]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xe], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xe]._4_4_, (uint)v[2] ^ (uint)v[0xe]), 0x20);
    v[0xe]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[3] + (uint)v[7];
    v[3]._0_4_ = (uint)m[4] + uVar2;
    v[3]._4_4_ = m[4]._4_4_ + v[3]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[4], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xf]._4_4_, (uint)v[3] ^ (uint)v[0xf]), 0x20);
    v[0xf]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[0] + (uint)v[5];
    v[0]._0_4_ = (uint)m[0] + uVar2;
    v[0]._4_4_ = m[0]._4_4_ + v[0]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xf]._4_4_, (uint)v[0] ^ (uint)v[0xf]), 0x20);
    v[0xf]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[0] + (uint)v[5];
    v[0]._0_4_ = (uint)m[7] + uVar2;
    v[0]._4_4_ = m[7]._4_4_ + v[0]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[7], uVar2);
    v[5] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xf]._4_4_, (uint)v[0] ^ (uint)v[0xf]), 0x10);
    ...
    uVar2 = (uint)v[2] + (uint)v[7];
    v[2]._0_4_ = (uint)m[9] + uVar2;
    v[2]._4_4_ = m[9]._4_4_ + v[2]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[9], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xd]._4_4_, (uint)v[2] ^ (uint)v[0xd]), 0x20);
    v[0xd]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[2] + (uint)v[7];
    v[2]._0_4_ = (uint)m[2] + uVar2;
    v[2]._4_4_ = m[2]._4_4_ + v[2]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[2], uVar2);
    v[7] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xd]._4_4_, (uint)v[2] ^ (uint)v[0xd]), 0x10);
    ...
    uVar2 = (uint)v[3] + (uint)v[4];
    v[3]._0_4_ = (uint)m[0xb] + uVar2;
    v[3]._4_4_ = m[0xb]._4_4_ + v[3]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xb], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xe]._4_4_, (uint)v[3] ^ (uint)v[0xe]), 0x10);
    ...
    uVar2 = (uint)v[0] + (uint)v[4];
    v[0]._0_4_ = (uint)m[0xd] + uVar2;
    v[0]._4_4_ = m[0xd]._4_4_ + v[0]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xd], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xc]._4_4_, (uint)v[0] ^ (uint)v[0xc]), 0x20);
    ...
    v[1]._4_4_ = m[0xe]._4_4_ + v[1]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xe], uVar2);
    v[5] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xd]._4_4_, (uint)v[1] ^ (uint)v[0xd]), 0x10);
    ...
    uVar2 = (uint)v[2] + (uint)v[6];
    v[2]._0_4_ = (uint)m[1] + uVar2;
    v[2]._4_4_ = m[1]._4_4_ + v[2]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[1], uVar2);
    v[6] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xe]._4_4_, (uint)v[2] ^ (uint)v[0xe]), 0x10);
    ...
    uVar2 = (uint)v[3] + (uint)v[7];
    v[3]._0_4_ = (uint)m[9] + uVar2;
    v[3]._4_4_ = m[9]._4_4_ + v[3]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[9], uVar2);
    v[7] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xf]._4_4_, (uint)v[3] ^ (uint)v[0xf]), 0x10);
    ...
    uVar2 = (uint)v[0] + (uint)v[5];
    v[0]._0_4_ = (uint)m[5] + uVar2;
    v[0]._4_4_ = m[5]._4_4_ + v[0]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[5], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xf]._4_4_, (uint)v[0] ^ (uint)v[0xf]), 0x20);
    v[0xf]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[1] + (uint)v[6];
    v[1]._0_4_ = (uint)m[0xf] + uVar2;
    v[1]._4_4_ = m[0xf]._4_4_ + v[1]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xf], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xc]._4_4_, (uint)v[1] ^ (uint)v[0xc]), 0x20);
    v[0xc]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[1] + (uint)v[6];
    v[1]._0_4_ = (uint)m[4] + uVar2;
    v[1]._4_4_ = m[4]._4_4_ + v[1]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[4], uVar2);
    v[6] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xc]._4_4_, (uint)v[1] ^ (uint)v[0xc]), 0x10);
    ...
    v[3]._4_4_ = m[2]._4_4_ + v[3]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[2], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xe]._4_4_, (uint)v[3] ^ (uint)v[0xe]), 0x20);
    v[0xe]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[3] + (uint)v[4];
    v[3]._0_4_ = (uint)m[10] + uVar2;
    v[3]._4_4_ = m[10]._4_4_ + v[3]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[10], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xe]._4_4_, (uint)v[3] ^ (uint)v[0xe]), 0x10);
    ...
    uVar2 = (uint)v[0] + (uint)v[4];
    v[0]._0_4_ = (uint)m[6] + uVar2;
    v[0]._4_4_ = m[6]._4_4_ + v[0]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[6], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xc]._4_4_, (uint)v[0] ^ (uint)v[0xc]), 0x20);
    ...
    v[0]._4_4_ = m[0xf]._4_4_ + v[0]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xf], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xc]._4_4_, (uint)v[0] ^ (uint)v[0xc]), 0x10);
    ...
    v[1]._4_4_ = m[9]._4_4_ + v[1]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[9], uVar2);
    v[5] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xd]._4_4_, (uint)v[1] ^ (uint)v[0xd]), 0x10);
    ...
    v[2]._4_4_ = m[3]._4_4_ + v[2]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[3], uVar2);
    v[6] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xe]._4_4_, (uint)v[2] ^ (uint)v[0xe]), 0x10);
    ...
    v[3]._4_4_ = m[0]._4_4_ + v[3]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xf]._4_4_, (uint)v[3] ^ (uint)v[0xf]), 0x20);
    v[0xf]._0_4_ = (uint)uVar6;
    ...
    v[1]._4_4_ = m[0xd]._4_4_ + v[1]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xd], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xc]._4_4_, (uint)v[1] ^ (uint)v[0xc]), 0x20);
    v[0xc]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[2] + (uint)v[6];
    v[2]._0_4_ = (uint)m[7] + uVar2;
    v[2]._4_4_ = m[7]._4_4_ + v[2]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[7], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xe]._4_4_, (uint)v[2] ^ (uint)v[0xe]), 0x20);
    v[0xe]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[2] + (uint)v[6];
    v[2]._0_4_ = (uint)m[6] + uVar2;
    v[2]._4_4_ = m[6]._4_4_ + v[2]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[6], uVar2);
    v[6] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xe]._4_4_, (uint)v[2] ^ (uint)v[0xe]), 0x10);
    ...
    uVar2 = (uint)v[3] + (uint)v[7];
    v[3]._0_4_ = (uint)m[1] + uVar2;
    v[3]._4_4_ = m[1]._4_4_ + v[3]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[1], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xf]._4_4_, (uint)v[3] ^ (uint)v[0xf]), 0x20);
    v[0xf]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[3] + (uint)v[7];
    v[3]._0_4_ = (uint)m[5] + uVar2;
    v[3]._4_4_ = m[5]._4_4_ + v[3]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[5], uVar2);
    v[7] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xf]._4_4_, (uint)v[3] ^ (uint)v[0xf]), 0x10);
    ...
    uVar2 = (uint)v[0] + (uint)v[5];
    v[0]._0_4_ = (uint)m[0xf] + uVar2;
    v[0]._4_4_ = m[0xf]._4_4_ + v[0]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xf], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xf]._4_4_, (uint)v[0] ^ (uint)v[0xf]), 0x20);
    v[0xf]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[0] + (uint)v[5];
    v[0]._0_4_ = (uint)m[0xb] + uVar2;
    v[0]._4_4_ = m[0xb]._4_4_ + v[0]._4_4_ + v[5]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xb], uVar2);
    v[5] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[0]._4_4_ ^ v[0xf]._4_4_, (uint)v[0] ^ (uint)v[0xf]), 0x10);
    ...
    uVar2 = (uint)v[1] + (uint)v[6];
    v[1]._0_4_ = (uint)m[9] + uVar2;
    v[1]._4_4_ = m[9]._4_4_ + v[1]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[9], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xc]._4_4_, (uint)v[1] ^ (uint)v[0xc]), 0x20);
    v[0xc]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[1] + (uint)v[6];
    v[1]._0_4_ = (uint)m[0xe] + uVar2;
    v[1]._4_4_ = m[0xe]._4_4_ + v[1]._4_4_ + v[6]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0xe], uVar2);
    v[6] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[1]._4_4_ ^ v[0xc]._4_4_, (uint)v[1] ^ (uint)v[0xc]), 0x10);
    ...
    uVar2 = (uint)v[2] + (uint)v[7];
    v[2]._0_4_ = (uint)m[3] + uVar2;
    v[2]._4_4_ = m[3]._4_4_ + v[2]._4_4_ + v[7]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[3], uVar2);
    uVar6 = rotr64(
        CONCAT44(v[2]._4_4_ ^ v[0xd]._4_4_, (uint)v[2] ^ (uint)v[0xd]), 0x20);
    v[0xd]._0_4_ = (uint)uVar6;
    ...
    uVar2 = (uint)v[3] + (uint)v[4];
    v[3]._0_4_ = (uint)m[0] + uVar2;
    v[3]._4_4_ = m[0]._4_4_ + v[3]._4_4_ + v[4]._4_4_ + bVar5 +
                 (uint)CARRY4((uint)m[0], uVar2);
    v[4] = uVar6;
    uVar6 = rotr64(
        CONCAT44(v[3]._4_4_ ^ v[0xe]._4_4_, (uint)v[3] ^ (uint)v[0xe]), 0x10);
    ...
    v[9]._4_4_ = v[0xe]._4_4_ + v[9]._4_4_ + bVar5;
    v[0xe] = uVar6;
    v[4] = rotr64(CONCAT44(v[9]._4_4_ ^ v[4]._4_4_, (uint)v[9] ^ (uint)v[4]),
                  0x3f);
    for (i = 0; i < 8; i = i + 1) {
...

{
    ...
    while ((uint)inlen_local != 0 || inlen_local._4_4_ != 0) {
        ...
        if (bVar2) {
            ...
            inlen_local =
                CONCAT44(inlen_local._4_4_ - (uint)((uint)inlen_local < __n),
...

{
    ...
    for (i = 0; i < (int)block_nb; i = i + 1) {
        for (j = 0; j < 0x10; j = j + 1) {
            w[j] = CONCAT13(message[j * 4 + i * 0x40],
                            CONCAT12(message[j * 4 + 1 + i * 0x40],
                                     CONCAT11(message[j * 4 + 2 + i * 0x40],
                                              message[j * 4 + 3 + i * 0x40])));
        }
        for (j = 0x10; j < 0x40; j = j + 1) {
            w[j] =
                ((w[j + -2] >> 0x11 | w[j + -2] << 0xf) ^
                 (w[j + -2] >> 0x13 | w[j + -2] << 0xd) ^ w[j + -2] >> 10) +
                w[j + -7] +
                (w[j + -0xf] >> 3 ^ (w[j + -0xf] >> 7 | w[j + -0xf] << 0x19) ^
                 (w[j + -0xf] >> 0x12 | w[j + -0xf] << 0xe)) +
                w[j + -0x10];
        }
        for (j = 0; j < 8; j = j + 1) {
            wv[j] = ctx->h[j];
        ...
        for (j = 0; j < 0x40; j = j + 1) {
            iVar2 =
                w[j] + wv[7] +
                ((wv[4] >> 0x19 | wv[4] << 7) ^ (wv[4] >> 6 | wv[4] << 0x1a) ^
                 (wv[4] >> 0xb | wv[4] << 0x15)) +
            ...
            if (j == 0) {
                ...
                W[i & 0xf] =
                    ...
                    ((W[i - 2 & 0xf] >> 0x11 | W[i - 2 & 0xf] << 0xf) ^
                     (W[i - 2 & 0xf] >> 0x13 | W[i - 2 & 0xf] << 0xd) ^
                     W[i - 2 & 0xf] >> 10) +
                    W[i - 7 & 0xf];
                uVar8 = W[i & 0xf];
            }
            T[7 - i & 7] =
                ((uVar3 >> 6 | uVar3 << 0x1a) ^ (uVar4 >> 0xb | uVar4 << 0x15) ^
                 (uVar5 >> 0x19 | uVar5 << 7)) +
                ((uVar6 ^ uVar9) & uVar1 ^ uVar2) + uVar7 + uVar8 +
                T[7 - i & 7];
            T[3 - i & 7] = T[3 - i & 7] + T[7 - i & 7];
            T[7 - i & 7] = T[7 - i & 7] +
                           ((T[1 - i & 7] | T[-i & 7]) & T[2 - i & 7] |
                            T[-i & 7] & T[1 - i & 7]) +
                           ((T[-i & 7] >> 2 | T[-i & 7] << 0x1e) ^
                            (T[-i & 7] >> 0xd | T[-i & 7] << 0x13) ^
                            (T[-i & 7] >> 0x16 | T[-i & 7] << 10));
        }
    }
    for (j = 0; j < 8; j = j + 1) {
...

{
    ...
    for (i = 0; i < 0x10; i = i + 1) {
        data32[i] = (uint)p->buffer[i * 4 + 3] +
                    ...
                    (uint)p->buffer[i * 4] * 0x1000000 +
                    (uint)p->buffer[i * 4 + 1] * 0x10000;
    }
...

{
    ...
    uVar1 = (uint)data[3] | (uint)data[2] << 8 | (uint)*data << 0x18 |
            (uint)data[1] << 0x10;
    ...
    uVar38 = ctx->state[6];
    iVar39 =
        ((uVar36 >> 6 | uVar36 << 0x1a) ^ (uVar36 >> 0xb | uVar36 << 0x15) ^
         (uVar36 >> 0x19 | uVar36 << 7)) +
        ctx->state[7] + (uVar38 ^ (uVar37 ^ uVar38) & uVar36) + uVar1 +
        0x428a2f98;
    ...
    uVar36 = (uVar41 & (uVar37 | uVar42) | uVar37 & uVar42) +
             ...
             iVar39;
    iVar39 = ((uVar34 >> 6 | uVar34 * 0x4000000) ^
              (uVar34 >> 0xb | uVar34 * 0x200000) ^
              (uVar34 >> 0x19 | uVar34 * 0x80)) +
             uVar40 + (uVar38 ^ (uVar35 ^ uVar38) & uVar34) + uVar9 +
             0x3956c25b;
    ...
    uVar40 = (uVar42 & (uVar36 | uVar37) | uVar36 & uVar37) +
             ...
             iVar39;
    iVar39 = ((uVar41 >> 6 | uVar41 * 0x4000000) ^
              (uVar41 >> 0xb | uVar41 * 0x200000) ^
              (uVar41 >> 0x19 | uVar41 * 0x80)) +
             uVar38 + (uVar35 ^ (uVar34 ^ uVar35) & uVar41) + uVar11 +
             0x59f111f1;
    ...
    uVar38 = (uVar37 & (uVar40 | uVar36) | uVar40 & uVar36) +
             ...
             iVar39;
    iVar39 = ((uVar42 >> 6 | uVar42 * 0x4000000) ^
              (uVar42 >> 0xb | uVar42 * 0x200000) ^
              (uVar42 >> 0x19 | uVar42 * 0x80)) +
             uVar35 + (uVar34 ^ (uVar41 ^ uVar34) & uVar42) + uVar13 +
             -0x6dc07d5c;
    ...
    iVar39 = ((uVar38 >> 6 | uVar38 * 0x4000000) ^
              (uVar38 >> 0xb | uVar38 * 0x200000) ^
              (uVar38 >> 0x19 | uVar38 * 0x80)) +
             uVar37 + (uVar36 ^ (uVar40 ^ uVar36) & uVar38) + uVar21 +
             0x243185be;
    uVar35 = iVar39 + uVar35;
    uVar37 = (uVar34 & (uVar42 | uVar41) | uVar42 & uVar41) +
             ((uVar42 >> 2 | uVar42 * 0x40000000) ^
    ...
    iVar39 = ((uVar35 >> 6 | uVar35 * 0x4000000) ^
              (uVar35 >> 0xb | uVar35 * 0x200000) ^
              (uVar35 >> 0x19 | uVar35 * 0x80)) +
             uVar36 + (uVar40 ^ (uVar38 ^ uVar40) & uVar35) + uVar23 +
             0x550c7dc3;
    uVar34 = iVar39 + uVar34;
    uVar36 = (uVar41 & (uVar37 | uVar42) | uVar37 & uVar42) +
             ((uVar37 >> 2 | uVar37 * 0x40000000) ^
    ...
    iVar39 = ((uVar34 >> 6 | uVar34 * 0x4000000) ^
              (uVar34 >> 0xb | uVar34 * 0x200000) ^
              (uVar34 >> 0x19 | uVar34 * 0x80)) +
             uVar40 + (uVar38 ^ (uVar35 ^ uVar38) & uVar34) + uVar25 +
             0x72be5d74;
    uVar41 = iVar39 + uVar41;
    uVar40 = (uVar42 & (uVar36 | uVar37) | uVar36 & uVar37) +
             ((uVar36 >> 2 | uVar36 * 0x40000000) ^
    ...
    iVar39 = ((uVar41 >> 6 | uVar41 * 0x4000000) ^
              (uVar41 >> 0xb | uVar41 * 0x200000) ^
              (uVar41 >> 0x19 | uVar41 * 0x80)) +
             uVar38 + (uVar35 ^ (uVar34 ^ uVar35) & uVar41) + uVar27 +
             -0x7f214e02;
    uVar42 = iVar39 + uVar42;
    uVar38 = (uVar37 & (uVar40 | uVar36) | uVar40 & uVar36) +
             ((uVar40 >> 2 | uVar40 * 0x40000000) ^
    ...
    iVar39 = ((uVar42 >> 6 | uVar42 * 0x4000000) ^
              (uVar42 >> 0xb | uVar42 * 0x200000) ^
              (uVar42 >> 0x19 | uVar42 * 0x80)) +
             uVar35 + (uVar34 ^ (uVar41 ^ uVar34) & uVar42) + uVar29 +
             -0x6423f959;
    uVar37 = iVar39 + uVar37;
    uVar35 = (uVar36 & (uVar38 | uVar40) | uVar38 & uVar40) +
             ((uVar38 >> 2 | uVar38 * 0x40000000) ^
    ...
    iVar39 = ((uVar37 >> 6 | uVar37 * 0x4000000) ^
              (uVar37 >> 0xb | uVar37 * 0x200000) ^
              (uVar37 >> 0x19 | uVar37 * 0x80)) +
             uVar34 + (uVar41 ^ (uVar42 ^ uVar41) & uVar37) + uVar31 +
             -0x3e640e8c;
    uVar36 = iVar39 + uVar36;
    uVar34 = (uVar40 & (uVar35 | uVar38) | uVar35 & uVar38) +
             ((uVar35 >> 2 | uVar35 * 0x40000000) ^
              ...
              (uVar35 >> 0x16 | uVar35 * 0x400)) +
             iVar39;
    uVar1 = ((uVar28 >> 0x11 | uVar29 << 0xf) ^
             (uVar28 >> 0x13 | uVar29 << 0xd) ^ uVar32 >> 10) +
            uVar19 +
            (uVar3 >> 3 ^ (uVar3 >> 7 | (uint)data[7] << 0x19) ^
             (uVar2 >> 0x12 | uVar3 << 0xe)) +
            uVar1;
    iVar39 = ((uVar36 >> 6 | uVar36 * 0x4000000) ^
              (uVar36 >> 0xb | uVar36 * 0x200000) ^
              (uVar36 >> 0x19 | uVar36 * 0x80)) +
             uVar41 + (uVar42 ^ (uVar37 ^ uVar42) & uVar36) + uVar1 +
             -0x1b64963f;
    uVar40 = iVar39 + uVar40;
    uVar2 = (uVar38 & (uVar34 | uVar35) | uVar34 & uVar35) +
            ((uVar34 >> 2 | uVar34 * 0x40000000) ^
             ...
             (uVar34 >> 0x16 | uVar34 * 0x400)) +
            iVar39;
    uVar3 = ((uVar30 >> 0x11 | uVar31 << 0xf) ^
             (uVar30 >> 0x13 | uVar31 << 0xd) ^ uVar33 >> 10) +
            uVar21 +
            (uVar5 >> 3 ^ (uVar5 >> 7 | (uint)data[0xb] << 0x19) ^
             (uVar4 >> 0x12 | uVar5 << 0xe)) +
            uVar3;
    iVar39 = ((uVar40 >> 6 | uVar40 * 0x4000000) ^
              (uVar40 >> 0xb | uVar40 * 0x200000) ^
              (uVar40 >> 0x19 | uVar40 * 0x80)) +
             uVar42 + (uVar37 ^ (uVar36 ^ uVar37) & uVar40) + uVar3 +
             -0x1041b87a;
    uVar38 = iVar39 + uVar38;
    uVar4 =
        (uVar35 & (uVar2 | uVar34) | uVar2 & uVar34) +
        ((uVar2 >> 2 | uVar2 * 0x40000000) ^ (uVar2 >> 0xd | uVar2 * 0x80000) ^
         (uVar2 >> 0x16 | uVar2 * 0x400)) +
        iVar39;
    uVar5 = ((uVar1 >> 0x11 | uVar1 * 0x8000) ^
             (uVar1 >> 0x13 | uVar1 * 0x2000) ^ uVar1 >> 10) +
            uVar23 +
            (uVar7 >> 3 ^ (uVar7 >> 7 | (uint)data[0xf] << 0x19) ^
             (uVar6 >> 0x12 | uVar7 << 0xe)) +
            uVar5;
    iVar39 = ((uVar38 >> 6 | uVar38 * 0x4000000) ^
              (uVar38 >> 0xb | uVar38 * 0x200000) ^
              (uVar38 >> 0x19 | uVar38 * 0x80)) +
    ...
    uVar35 = iVar39 + uVar35;
    uVar6 =
        (uVar34 & (uVar4 | uVar2) | uVar4 & uVar2) +
        ((uVar4 >> 2 | uVar4 * 0x40000000) ^ (uVar4 >> 0xd | uVar4 * 0x80000) ^
         (uVar4 >> 0x16 | uVar4 * 0x400)) +
        iVar39;
    uVar7 = ((uVar3 >> 0x11 | uVar3 * 0x8000) ^
             (uVar3 >> 0x13 | uVar3 * 0x2000) ^ uVar3 >> 10) +
            uVar25 +
            (uVar9 >> 3 ^ (uVar9 >> 7 | (uint)data[0x13] << 0x19) ^
             (uVar8 >> 0x12 | uVar9 << 0xe)) +
            uVar7;
    iVar39 = ((uVar35 >> 6 | uVar35 * 0x4000000) ^
              (uVar35 >> 0xb | uVar35 * 0x200000) ^
              (uVar35 >> 0x19 | uVar35 * 0x80)) +
    ...
    uVar34 = iVar39 + uVar34;
    uVar8 =
        (uVar2 & (uVar6 | uVar4) | uVar6 & uVar4) +
        ((uVar6 >> 2 | uVar6 * 0x40000000) ^ (uVar6 >> 0xd | uVar6 * 0x80000) ^
         (uVar6 >> 0x16 | uVar6 * 0x400)) +
        iVar39;
    uVar9 = ((uVar5 >> 0x11 | uVar5 * 0x8000) ^
             (uVar5 >> 0x13 | uVar5 * 0x2000) ^ uVar5 >> 10) +
            uVar27 +
            (uVar11 >> 3 ^ (uVar11 >> 7 | (uint)data[0x17] << 0x19) ^
             (uVar10 >> 0x12 | uVar11 << 0xe)) +
            uVar9;
    iVar39 = ((uVar34 >> 6 | uVar34 * 0x4000000) ^
              (uVar34 >> 0xb | uVar34 * 0x200000) ^
              (uVar34 >> 0x19 | uVar34 * 0x80)) +
    ...
    uVar2 = iVar39 + uVar2;
    uVar10 =
        (uVar4 & (uVar8 | uVar6) | uVar8 & uVar6) +
        ((uVar8 >> 2 | uVar8 * 0x40000000) ^ (uVar8 >> 0xd | uVar8 * 0x80000) ^
         (uVar8 >> 0x16 | uVar8 * 0x400)) +
        iVar39;
    uVar11 = ((uVar7 >> 0x11 | uVar7 * 0x8000) ^
              (uVar7 >> 0x13 | uVar7 * 0x2000) ^ uVar7 >> 10) +
             uVar29 +
             (uVar13 >> 3 ^ (uVar13 >> 7 | (uint)data[0x1b] << 0x19) ^
              (uVar12 >> 0x12 | uVar13 << 0xe)) +
             uVar11;
    iVar39 =
    ...
    uVar12 = (uVar6 & (uVar10 | uVar8) | uVar10 & uVar8) +
             ...
             iVar39;
    uVar13 = ((uVar9 >> 0x11 | uVar9 * 0x8000) ^
              (uVar9 >> 0x13 | uVar9 * 0x2000) ^ uVar9 >> 10) +
             uVar31 +
             (uVar15 >> 3 ^ (uVar15 >> 7 | (uint)data[0x1f] << 0x19) ^
              (uVar14 >> 0x12 | uVar15 << 0xe)) +
             uVar13;
    iVar39 =
    ...
    uVar14 = (uVar8 & (uVar12 | uVar10) | uVar12 & uVar10) +
             ...
             iVar39;
    uVar15 = ((uVar11 >> 0x11 | uVar11 * 0x8000) ^
              (uVar11 >> 0x13 | uVar11 * 0x2000) ^ uVar11 >> 10) +
             uVar1 +
             (uVar17 >> 3 ^ (uVar17 >> 7 | (uint)data[0x23] << 0x19) ^
              (uVar16 >> 0x12 | uVar17 << 0xe)) +
             uVar15;
    iVar39 =
    ...
    uVar16 = (uVar10 & (uVar14 | uVar12) | uVar14 & uVar12) +
             ...
             iVar39;
    uVar17 = ((uVar13 >> 0x11 | uVar13 * 0x8000) ^
              (uVar13 >> 0x13 | uVar13 * 0x2000) ^ uVar13 >> 10) +
             uVar3 +
             (uVar19 >> 3 ^ (uVar19 >> 7 | (uint)data[0x27] << 0x19) ^
              (uVar18 >> 0x12 | uVar19 << 0xe)) +
             uVar17;
    iVar39 =
    ...
    uVar2 = (uVar12 & (uVar16 | uVar14) | uVar16 & uVar14) +
            ...
            iVar39;
    uVar19 = ((uVar15 >> 0x11 | uVar15 * 0x8000) ^
              (uVar15 >> 0x13 | uVar15 * 0x2000) ^ uVar15 >> 10) +
             uVar5 +
             (uVar21 >> 3 ^ (uVar21 >> 7 | (uint)data[0x2b] << 0x19) ^
              (uVar20 >> 0x12 | uVar21 << 0xe)) +
             uVar19;
    iVar39 = ((uVar10 >> 6 | uVar10 * 0x4000000) ^
              (uVar10 >> 0xb | uVar10 * 0x200000) ^
              (uVar10 >> 0x19 | uVar10 * 0x80)) +
             uVar4 + (uVar6 ^ (uVar8 ^ uVar6) & uVar10) + uVar19 + -0x57ce3993;
    uVar12 = iVar39 + uVar12;
    uVar4 =
        (uVar14 & (uVar2 | uVar16) | uVar2 & uVar16) +
        ((uVar2 >> 2 | uVar2 * 0x40000000) ^ (uVar2 >> 0xd | uVar2 * 0x80000) ^
         (uVar2 >> 0x16 | uVar2 * 0x400)) +
        iVar39;
    uVar21 = ((uVar17 >> 0x11 | uVar17 * 0x8000) ^
              (uVar17 >> 0x13 | uVar17 * 0x2000) ^ uVar17 >> 10) +
             uVar7 +
             (uVar23 >> 3 ^ (uVar23 >> 7 | (uint)data[0x2f] << 0x19) ^
              (uVar22 >> 0x12 | uVar23 << 0xe)) +
             uVar21;
    iVar39 = ((uVar12 >> 6 | uVar12 * 0x4000000) ^
              (uVar12 >> 0xb | uVar12 * 0x200000) ^
              (uVar12 >> 0x19 | uVar12 * 0x80)) +
             uVar6 + (uVar8 ^ (uVar10 ^ uVar8) & uVar12) + uVar21 + -0x4ffcd838;
    uVar14 = iVar39 + uVar14;
    uVar6 =
        (uVar16 & (uVar4 | uVar2) | uVar4 & uVar2) +
        ((uVar4 >> 2 | uVar4 * 0x40000000) ^ (uVar4 >> 0xd | uVar4 * 0x80000) ^
         (uVar4 >> 0x16 | uVar4 * 0x400)) +
        iVar39;
    uVar23 = ((uVar19 >> 0x11 | uVar19 * 0x8000) ^
              (uVar19 >> 0x13 | uVar19 * 0x2000) ^ uVar19 >> 10) +
             uVar9 +
             (uVar25 >> 3 ^ (uVar25 >> 7 | (uint)data[0x33] << 0x19) ^
              (uVar24 >> 0x12 | uVar25 << 0xe)) +
             uVar23;
    iVar39 = ((uVar14 >> 6 | uVar14 * 0x4000000) ^
              (uVar14 >> 0xb | uVar14 * 0x200000) ^
              (uVar14 >> 0x19 | uVar14 * 0x80)) +
             uVar8 + (uVar10 ^ (uVar12 ^ uVar10) & uVar14) + uVar23 +
             -0x40a68039;
    ...
    uVar8 =
        ...
        ((uVar6 >> 2 | uVar6 * 0x40000000) ^ (uVar6 >> 0xd | uVar6 * 0x80000) ^
         (uVar6 >> 0x16 | uVar6 * 0x400)) +
        iVar39;
    uVar25 = ((uVar21 >> 0x11 | uVar21 * 0x8000) ^
              (uVar21 >> 0x13 | uVar21 * 0x2000) ^ uVar21 >> 10) +
             uVar11 +
             (uVar27 >> 3 ^ (uVar27 >> 7 | (uint)data[0x37] << 0x19) ^
              (uVar26 >> 0x12 | uVar27 << 0xe)) +
             uVar25;
    iVar39 = ((uVar16 >> 6 | uVar16 * 0x4000000) ^
              (uVar16 >> 0xb | uVar16 * 0x200000) ^
              (uVar16 >> 0x19 | uVar16 * 0x80)) +
             uVar10 + (uVar12 ^ (uVar14 ^ uVar12) & uVar16) + uVar25 +
             -0x391ff40d;
    uVar2 = iVar39 + uVar2;
    uVar10 =
        (uVar4 & (uVar8 | uVar6) | uVar8 & uVar6) +
        ((uVar8 >> 2 | uVar8 * 0x40000000) ^ (uVar8 >> 0xd | uVar8 * 0x80000) ^
         (uVar8 >> 0x16 | uVar8 * 0x400)) +
        iVar39;
    uVar27 = ((uVar23 >> 0x11 | uVar23 * 0x8000) ^
              (uVar23 >> 0x13 | uVar23 * 0x2000) ^ uVar23 >> 10) +
             uVar13 +
             (uVar29 >> 3 ^ (uVar29 >> 7 | (uint)data[0x3b] << 0x19) ^
              (uVar28 >> 0x12 | uVar29 << 0xe)) +
             uVar27;
    iVar39 =
        ((uVar2 >> 6 | uVar2 * 0x4000000) ^ (uVar2 >> 0xb | uVar2 * 0x200000) ^
         (uVar2 >> 0x19 | uVar2 * 0x80)) +
    ...
    uVar12 = (uVar6 & (uVar10 | uVar8) | uVar10 & uVar8) +
             ((uVar10 >> 2 | uVar10 * 0x40000000) ^
              ...
              (uVar10 >> 0x16 | uVar10 * 0x400)) +
             iVar39;
    uVar29 = ((uVar25 >> 0x11 | uVar25 * 0x8000) ^
              (uVar25 >> 0x13 | uVar25 * 0x2000) ^ uVar25 >> 10) +
             uVar15 +
             (uVar31 >> 3 ^ (uVar31 >> 7 | (uint)data[0x3f] << 0x19) ^
              (uVar30 >> 0x12 | uVar31 << 0xe)) +
             uVar29;
    iVar39 =
        ((uVar4 >> 6 | uVar4 * 0x4000000) ^ (uVar4 >> 0xb | uVar4 * 0x200000) ^
         (uVar4 >> 0x19 | uVar4 * 0x80)) +
    ...
    uVar14 = (uVar8 & (uVar12 | uVar10) | uVar12 & uVar10) +
             ((uVar12 >> 2 | uVar12 * 0x40000000) ^
              ...
              (uVar12 >> 0x16 | uVar12 * 0x400)) +
             iVar39;
    uVar31 = ((uVar27 >> 0x11 | uVar27 * 0x8000) ^
              (uVar27 >> 0x13 | uVar27 * 0x2000) ^ uVar27 >> 10) +
             uVar17 +
             (uVar1 >> 3 ^ (uVar1 >> 7 | uVar1 * 0x2000000) ^
              (uVar1 >> 0x12 | uVar1 * 0x4000)) +
             uVar31;
    iVar39 =
        ((uVar6 >> 6 | uVar6 * 0x4000000) ^ (uVar6 >> 0xb | uVar6 * 0x200000) ^
         (uVar6 >> 0x19 | uVar6 * 0x80)) +
    ...
    uVar16 = (uVar10 & (uVar14 | uVar12) | uVar14 & uVar12) +
             ((uVar14 >> 2 | uVar14 * 0x40000000) ^
              ...
              (uVar14 >> 0x16 | uVar14 * 0x400)) +
             iVar39;
    uVar1 = ((uVar29 >> 0x11 | uVar29 * 0x8000) ^
             (uVar29 >> 0x13 | uVar29 * 0x2000) ^ uVar29 >> 10) +
            uVar19 +
            (uVar3 >> 3 ^ (uVar3 >> 7 | uVar3 * 0x2000000) ^
    ...
    uVar2 = (uVar12 & (uVar16 | uVar14) | uVar16 & uVar14) +
            ((uVar16 >> 2 | uVar16 * 0x40000000) ^
             ...
             (uVar16 >> 0x16 | uVar16 * 0x400)) +
            iVar39;
    uVar3 = ((uVar31 >> 0x11 | uVar31 * 0x8000) ^
             (uVar31 >> 0x13 | uVar31 * 0x2000) ^ uVar31 >> 10) +
            uVar21 +
            (uVar5 >> 3 ^ (uVar5 >> 7 | uVar5 * 0x2000000) ^
             (uVar5 >> 0x12 | uVar5 * 0x4000)) +
            uVar3;
    iVar39 = ((uVar10 >> 6 | uVar10 * 0x4000000) ^
              (uVar10 >> 0xb | uVar10 * 0x200000) ^
              (uVar10 >> 0x19 | uVar10 * 0x80)) +
    ...
    uVar5 = ((uVar1 >> 0x11 | uVar1 * 0x8000) ^
             (uVar1 >> 0x13 | uVar1 * 0x2000) ^ uVar1 >> 10) +
            uVar23 +
            (uVar7 >> 3 ^ (uVar7 >> 7 | uVar7 * 0x2000000) ^
    ...
    uVar7 = ((uVar3 >> 0x11 | uVar3 * 0x8000) ^
             (uVar3 >> 0x13 | uVar3 * 0x2000) ^ uVar3 >> 10) +
            uVar25 +
            (uVar9 >> 3 ^ (uVar9 >> 7 | uVar9 * 0x2000000) ^
             (uVar9 >> 0x12 | uVar9 * 0x4000)) +
            uVar7;
    iVar39 = ((uVar14 >> 6 | uVar14 * 0x4000000) ^
              (uVar14 >> 0xb | uVar14 * 0x200000) ^
              (uVar14 >> 0x19 | uVar14 * 0x80)) +
    ...
    uVar9 = ((uVar5 >> 0x11 | uVar5 * 0x8000) ^
             (uVar5 >> 0x13 | uVar5 * 0x2000) ^ uVar5 >> 10) +
            uVar27 +
            (uVar11 >> 3 ^ (uVar11 >> 7 | uVar11 * 0x2000000) ^
             (uVar11 >> 0x12 | uVar11 * 0x4000)) +
            uVar9;
    iVar39 = ((uVar16 >> 6 | uVar16 * 0x4000000) ^
              (uVar16 >> 0xb | uVar16 * 0x200000) ^
              (uVar16 >> 0x19 | uVar16 * 0x80)) +
             uVar10 + (uVar12 ^ (uVar14 ^ uVar12) & uVar16) + uVar9 +
             0x650a7354;
    uVar2 = iVar39 + uVar2;
    uVar10 =
        (uVar4 & (uVar8 | uVar6) | uVar8 & uVar6) +
    ...
    uVar11 = ((uVar7 >> 0x11 | uVar7 * 0x8000) ^
              (uVar7 >> 0x13 | uVar7 * 0x2000) ^ uVar7 >> 10) +
             uVar29 +
             (uVar13 >> 3 ^ (uVar13 >> 7 | uVar13 * 0x2000000) ^
              (uVar13 >> 0x12 | uVar13 * 0x4000)) +
             uVar11;
    iVar39 =
        ((uVar2 >> 6 | uVar2 * 0x4000000) ^ (uVar2 >> 0xb | uVar2 * 0x200000) ^
         (uVar2 >> 0x19 | uVar2 * 0x80)) +
    ...
    uVar13 = ((uVar9 >> 0x11 | uVar9 * 0x8000) ^
              (uVar9 >> 0x13 | uVar9 * 0x2000) ^ uVar9 >> 10) +
             uVar31 +
             (uVar15 >> 3 ^ (uVar15 >> 7 | uVar15 * 0x2000000) ^
              (uVar15 >> 0x12 | uVar15 * 0x4000)) +
             uVar13;
    iVar39 =
        ((uVar4 >> 6 | uVar4 * 0x4000000) ^ (uVar4 >> 0xb | uVar4 * 0x200000) ^
         (uVar4 >> 0x19 | uVar4 * 0x80)) +
    ...
    uVar15 = ((uVar11 >> 0x11 | uVar11 * 0x8000) ^
              (uVar11 >> 0x13 | uVar11 * 0x2000) ^ uVar11 >> 10) +
             uVar1 +
             (uVar17 >> 3 ^ (uVar17 >> 7 | uVar17 * 0x2000000) ^
              (uVar17 >> 0x12 | uVar17 * 0x4000)) +
             uVar15;
    iVar39 =
        ((uVar6 >> 6 | uVar6 * 0x4000000) ^ (uVar6 >> 0xb | uVar6 * 0x200000) ^
         (uVar6 >> 0x19 | uVar6 * 0x80)) +
    ...
    uVar17 = ((uVar13 >> 0x11 | uVar13 * 0x8000) ^
              (uVar13 >> 0x13 | uVar13 * 0x2000) ^ uVar13 >> 10) +
             uVar3 +
             (uVar19 >> 3 ^ (uVar19 >> 7 | uVar19 * 0x2000000) ^
              (uVar19 >> 0x12 | uVar19 * 0x4000)) +
             uVar17;
    iVar39 =
        ((uVar8 >> 6 | uVar8 * 0x4000000) ^ (uVar8 >> 0xb | uVar8 * 0x200000) ^
         (uVar8 >> 0x19 | uVar8 * 0x80)) +
    ...
    uVar19 = ((uVar15 >> 0x11 | uVar15 * 0x8000) ^
              (uVar15 >> 0x13 | uVar15 * 0x2000) ^ uVar15 >> 10) +
             uVar5 +
             (uVar21 >> 3 ^ (uVar21 >> 7 | uVar21 * 0x2000000) ^
    ...
    uVar21 = ((uVar17 >> 0x11 | uVar17 * 0x8000) ^
              (uVar17 >> 0x13 | uVar17 * 0x2000) ^ uVar17 >> 10) +
             uVar7 +
             (uVar23 >> 3 ^ (uVar23 >> 7 | uVar23 * 0x2000000) ^
              (uVar23 >> 0x12 | uVar23 * 0x4000)) +
             uVar21;
    iVar39 = ((uVar12 >> 6 | uVar12 * 0x4000000) ^
              (uVar12 >> 0xb | uVar12 * 0x200000) ^
              (uVar12 >> 0x19 | uVar12 * 0x80)) +
    ...
    uVar23 = ((uVar19 >> 0x11 | uVar19 * 0x8000) ^
              (uVar19 >> 0x13 | uVar19 * 0x2000) ^ uVar19 >> 10) +
             uVar9 +
             (uVar25 >> 3 ^ (uVar25 >> 7 | uVar25 * 0x2000000) ^
              (uVar25 >> 0x12 | uVar25 * 0x4000)) +
             uVar23;
    iVar39 = ((uVar14 >> 6 | uVar14 * 0x4000000) ^
              (uVar14 >> 0xb | uVar14 * 0x200000) ^
              (uVar14 >> 0x19 | uVar14 * 0x80)) +
    ...
    uVar25 = ((uVar21 >> 0x11 | uVar21 * 0x8000) ^
              (uVar21 >> 0x13 | uVar21 * 0x2000) ^ uVar21 >> 10) +
             uVar11 +
             (uVar27 >> 3 ^ (uVar27 >> 7 | uVar27 * 0x2000000) ^
              (uVar27 >> 0x12 | uVar27 * 0x4000)) +
             uVar25;
    iVar39 = ((uVar16 >> 6 | uVar16 * 0x4000000) ^
              (uVar16 >> 0xb | uVar16 * 0x200000) ^
              (uVar16 >> 0x19 | uVar16 * 0x80)) +
    ...
    uVar27 = ((uVar23 >> 0x11 | uVar23 * 0x8000) ^
              (uVar23 >> 0x13 | uVar23 * 0x2000) ^ uVar23 >> 10) +
             uVar13 +
             (uVar29 >> 3 ^ (uVar29 >> 7 | uVar29 * 0x2000000) ^
              (uVar29 >> 0x12 | uVar29 * 0x4000)) +
             uVar27;
    iVar39 =
        ((uVar2 >> 6 | uVar2 * 0x4000000) ^ (uVar2 >> 0xb | uVar2 * 0x200000) ^
         (uVar2 >> 0x19 | uVar2 * 0x80)) +
    ...
    uVar29 = ((uVar25 >> 0x11 | uVar25 * 0x8000) ^
              (uVar25 >> 0x13 | uVar25 * 0x2000) ^ uVar25 >> 10) +
             uVar15 +
             (uVar31 >> 3 ^ (uVar31 >> 7 | uVar31 * 0x2000000) ^
              (uVar31 >> 0x12 | uVar31 * 0x4000)) +
             uVar29;
    iVar39 =
        ((uVar4 >> 6 | uVar4 * 0x4000000) ^ (uVar4 >> 0xb | uVar4 * 0x200000) ^
         (uVar4 >> 0x19 | uVar4 * 0x80)) +
...

{
    ...
    return v << 0x18 | (v >> 8 & 0xff) << 0x10 | (v >> 0x10 & 0xff) << 8 |
           v >> 0x18;
}
...

{
    ...
    rs.alive = 1;
    pthread_mutex_init((pthread_mutex_t *)&rs.reg_list_mutex,
                       (pthread_mutexattr_t *)0x0);
    rs.reg_list_items = (reg_list_item_t *)calloc(0xc, 100);
    for (id = 0; id < 100; id = id + 1) {
        rs.reg_list_items[id].age = -1;
    }
    pthread_create(&rs.p_reg_list, (pthread_attr_t *)0x0,
                   (__start_routine *)0x32869, (void *)0x0);
    return;
}
...

{
    ...
    while (nonceNum != 0) {
        ...
        memcpy(&runtime->nonce_verify_info, work,
               (runtime->nonce_verify_info).work_len);
        memcpy((runtime->nonce_verify_info).nonce, nonce_tmp.chip_nonce,
               (runtime->nonce_verify_info).nonce_len);
        memcpy((runtime->nonce_verify_info).sol, &nonce_tmp,
               (runtime->nonce_verify_info).sol_len);
        memset((runtime->nonce_verify_info).target, 0,
               (runtime->nonce_verify_info).target_len);
        ticket_mask = 0;
        valid = (*runtime->nonce_verify)(&runtime->nonce_verify_info,
                                         &ticket_mask, runtime->nonce_shift);
        if (runtime->new_block != false) {
            ...
            memset(
                ...
                0, runtime->chain_status[chainid].design_asic_num << 2);
            memset(runtime->chain_status[chainid]
                       .one_work_invalid_nonce_each_asic_type,
                   0, runtime->chain_status[chainid].design_asic_num * 0xc);
        }
        if (valid == 0) {
            runtime->valid_nonce_total = runtime->valid_nonce_total + 1;
            for (asic_index = 0; asic_index < 3; asic_index = asic_index + 1) {
                iVar2 =
                    __aeabi_idiv(nonce_tmp.chip_addr, runtime->addr_interval);
                if (iVar2 == asic_index) {
                    runtime->chain_status[chainid]
                        .one_work_nonce_each_asic[asic_index] =
                        runtime->chain_status[chainid]
                            .one_work_nonce_each_asic[asic_index] +
                        1;
                    runtime->chain_status[chainid]
                        .nonce_num_each_asic[asic_index] =
                        runtime->chain_status[chainid]
                            .nonce_num_each_asic[asic_index] +
                        1;
                    if (g_patten.start != 0) {
                        is_patten_match(asic_index, nonce_tmp.chip_nonce,
                                        nonce_tmp.Nonce);
                    }
                    if (((use_syslog != false) || (opt_log_output != false)) ||
                        (0 < opt_log_level)) {
                    ...
                    if ((opt_debug != false) &&
                        ...
                        snprintf(tmp42, 0x400, "SHA256:%02x%02x%02x%02x\n",
                                 ...
                                 (uint)nonce_tmp.sha256[1],
                                 (uint)nonce_tmp.sha256[2],
                                 (uint)nonce_tmp.sha256[3]);
                        _applog(4, tmp42, false);
                    }
                }
            }
            if ((app_conf->work_mode == 1) &&
                (_Var1 = (*runtime->nonce_verify_target_match)(
                     (runtime->nonce_verify_info).target, g_work_info.target),
                 _Var1)) {
                (*runtime->nonce_submit)(
                    nonce_tmp.Nonce, (runtime->nonce_verify_info).work,
                    g_work_info.fixed_nonce_bytes, (char *)0x4b608);
            }
        } else {
            ...
            for (asic = 0; asic < 3; asic = asic + 1) {
                ...
                if (iVar2 == asic) {
                    runtime->chain_status[chainid]
                        .nonce_invalid_num_each_asic[asic] =
                        runtime->chain_status[chainid]
                            .nonce_invalid_num_each_asic[asic] +
                        1;
                    *(int *)((runtime->nonce_verify_info).work +
                             (chainid * 0x24 + asic) * 4 + -0x4c) =
                        *(int *)((runtime->nonce_verify_info).work +
                                 (chainid * 0x24 + asic) * 4 + -0x4c) +
                        1;
                    if (valid == 1) {
                        runtime->chain_status[chainid]
                            .one_work_invalid_nonce_each_asic_type[asic][1] =
                            runtime->chain_status[chainid]
                                .one_work_invalid_nonce_each_asic_type[asic]
                                                                      [1] +
                            1;
                    } else if (valid == 2) {
                        runtime->chain_status[chainid]
                            .one_work_invalid_nonce_each_asic_type[asic][2] =
                            runtime->chain_status[chainid]
                                .one_work_invalid_nonce_each_asic_type[asic]
                                                                      [2] +
                            1;
                    ...
                    if (((use_syslog != false) || (opt_log_output != false)) ||
                        ...
                        snprintf(
                            ...
                            chainid, (uint)nonce_tmp.chip_addr,
                            *(undefined4 *)((runtime->nonce_verify_info).work +
                                            (chainid * 0x24 + asic) * 4 +
                                            -0x4c),
                            ticket_mask, valid);
                        _applog(0, tmp42, false);
...

{
    ...
    do {
        do {
            ...
            len = uart_receive((uchar)runtime->chain_status[chainid].fd,
                               receive_buf, resp_nonce_len);
            for (i = 0; i < len; i = i + 1) {
        ...
        while (2 < len) {
            ...
            if ((header[0] == 0xaa) && (header[1] == 'U')) {
                if ((header[2] & 0xf0) == 0xe0) {
                    if (len < (runtime->asic_data_info).resp_nonce_frame_len)
                        break;
                    for (i = 0;
                         i < (runtime->asic_data_info).resp_nonce_frame_len;
                         i = i + 1) {
                    ...
                    (*runtime->nonce_handle)(
                        tmp, (runtime->asic_data_info).resp_nonce_frame_len,
                        chainid, runtime->addr_interval);
                } else if (header[2] == 0xcc) {
                    if (len < (runtime->asic_data_info).resp_pm_len)
                        break;
                    for (i = 0; i < (runtime->asic_data_info).resp_pm_len;
                         i = i + 1) {
                        tmp[i] = data_buf[data_buf_rp];
                        add_point(&data_buf_rp, max);
                    }
                    len = len - (runtime->asic_data_info).resp_pm_len;
                    (*runtime->pm_handle)(tmp,
                                          (runtime->asic_data_info).resp_pm_len,
                                          (uint8_t)chainid);
                } else if (header[2] == 0xd0) {
                    if (len < (runtime->asic_data_info).resp_pt_len)
                        break;
                    for (i = 0; i < (runtime->asic_data_info).resp_pt_len;
                         i = i + 1) {
                        tmp[i] = data_buf[data_buf_rp];
                        add_point(&data_buf_rp, max);
                    }
                    len = len - (runtime->asic_data_info).resp_pt_len;
                    (*runtime->pt_handle)(tmp,
                                          (runtime->asic_data_info).resp_pt_len,
                                          (uint8_t)chainid);
                } else {
                    if (len < (runtime->asic_data_info).resp_reg_len)
                        break;
                    for (i = 0; i < (runtime->asic_data_info).resp_reg_len;
                         i = i + 1) {
                        tmp[i] = data_buf[data_buf_rp];
                        add_point(&data_buf_rp, max);
                    }
                    ...
                    (*runtime->reg_handle)(
                        tmp, (runtime->asic_data_info).resp_reg_len,
                        (uint8_t)chainid);
                }
            } else {
                add_point(&data_buf_rp, max);
...

{
    ...
    iVar1 = runtime->chain_id;
    sleep(1);
    pthread_create(&runtime->chain_status[iVar1].p_dispatch,
                   (pthread_attr_t *)0x0, (__start_routine *)0x330a5, runtime);
    pthread_create(&runtime->p_scanhash, (pthread_attr_t *)0x0,
                   (__start_routine *)0x33025, runtime);
    runtime->start_recv = 1;
    if (((use_syslog != false) || (opt_log_output != false)) ||
        (1 < opt_log_level)) {
        snprintf(tmp42, 0x400, "%s Done!\n", "runtime_init");
...

{
    ...
    pthread_mutex_init((pthread_mutex_t *)&work_list_info.work_list_mutex,
                       (pthread_mutexattr_t *)0x0);
    for (i = 0; i < 10; i = i + 1) {
...

{
    ...
    work_list_info.work_list[work_list_info.work_list_insert_index].workid =
        workid;
    memcpy(work_list_info.work_list[work_list_info.work_list_insert_index].work,
           work, work_list_info.work_len);
    work_list_info.work_list_insert_index =
        work_list_info.work_list_insert_index + 1;
...

{
    ...
    do {
        ...
        LAB_0003392c:
            pthread_mutex_unlock(
                (pthread_mutex_t *)&work_list_info.work_list_mutex);
            return;
        }
        if (workid == work_list_info.work_list[i].workid) {
            memcpy(work, work_list_info.work_list[i].work,
