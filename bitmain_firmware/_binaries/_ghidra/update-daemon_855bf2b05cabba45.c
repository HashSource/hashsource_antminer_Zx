  ...
  if (pcVar1 == (char *)0x0) {
    ...
    if (pcVar6 == (char *)0x0) {
      ...
      do {
        ...
        iVar5 = pthread_create((pthread_t *)(local_44 + 2),(pthread_attr_t *)0x0,FUN_00010c24,local_44);
      } while (iVar5 != -1);
...

{
  ...
  __libc_start_main(FUN_000108c8,in_stack_00000000,&stack0x00000004,0x10ed1,&DAT_00010f0d,param_1);
                    /* WARNING: Subroutine does not return */
  abort();
}
...
void FUN_00010ed0(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
