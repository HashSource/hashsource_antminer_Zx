...
LABEL_6:
  ...
  if ( v8 )
  {
    ...
    if ( v9 )
    {
      sub_AE0C(
        7,
        "/home/lol/workspace/A8_buildenv/build/tmp-angstrom_v2013_06-eglibc/work/armv7ahf-vfp-neon-angstrom-linux-gnueabi"
        "/systemd/1_208-r0/systemd-208/src/udev/accelerometer/accelerometer.c",
        337,
        "main",
...
LABEL_47:
          v32 = v30;
LABEL_48:
          _snprintf_chk(v34, 64, 1, 64, "ID_INPUT_ACCELEROMETER_ORIENTATION=%s", off_BB8C[v32]);
          puts(v34);
          goto LABEL_49;
        }
      }
