...
LABEL_43:
          ...
          else
          {
            while ( 1 )
            {
              ...
              sub_56E6C(v18, (int (__fastcall *)(const char *, int))v7, a5, a2);
              if ( v7(v35, v13, a5) )
                goto LABEL_22;
              v19 = (_DWORD *)sub_59F20((int)v14);
...
LABEL_44:
    ...
    case 2:
      ...
      return sub_56E6C(v24, (int (__fastcall *)(const char *, int))v7, a5, a2);
    case 3:
      v9 = sub_5A248((int)a1);
