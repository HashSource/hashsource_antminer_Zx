int __fastcall get_PIC16F1704_software_version_new(unsigned __int8 *version)
{
  ...
  _BYTE v14[3]; // [sp+1Dh] [bp-8h] BYREF
...
LABEL_21:
        LOWORD(v10) = -29720;
        HIWORD(v10) = (unsigned int)"15] = 0x%x, \t\tread_back_data[16] = 0x%x, read_back_data[17] = 0x%x, read_back_data[18] = 0x%x, read_back_data[19] = 0x%x\n" >> 16;
        snprintf(tmp42, 0x1000u, v10, "get_PIC16F1704_software_version_new", i2c_slave_addr);
        applog(3, tmp42, 0);
        if ( !use_syslog && !opt_log_output && opt_log_level <= 2 )
          return 0;
        LOWORD(v11) = -28524;
        HIWORD(v11) = (unsigned int)"back_data[14] = 0x%x, read_back_data[15] = 0x%x\n" >> 16;
        snprintf(
          tmp42,
          0x1000u,
          v11,
...
LABEL_26:
    ...
    LOWORD(v9) = -28524;
    HIWORD(v9) = (unsigned int)"back_data[14] = 0x%x, read_back_data[15] = 0x%x\n" >> 16;
    snprintf(
      tmp42,
      0x1000u,
      v9,
...
LABEL_12:
  ...
  if ( read_back_data[3] != HIBYTE(v7) || read_back_data[4] != (unsigned __int8)v7 )
  {
    if ( !use_syslog && !opt_log_output && opt_log_level <= 2 )
      return 0;
    LOWORD(v8) = -28572;
    HIWORD(v8) = (unsigned int)"ata[12] = 0x%x, read_back_data[13] = 0x%x, read_back_data[14] = 0x%x, read_back_data[15] = 0x%x\n" >> 16;
    snprintf(tmp42, 0x1000u, v8, "get_PIC16F1704_software_version_new", v7);
    goto LABEL_24;
  }
