void *__fastcall get_asic_response(void *arg)
{
  ...
  char v23; // [sp+17h] [bp-149CDh] BYREF
  ...
  {
    LOWORD(v13) = -22252;
    HIWORD(v13) = (unsigned int)"d reg_value_num = %d" >> 16;
    snprintf(tmp42, 0x1000u, v13, v3);
    applog(5, tmp42, 0);
    if ( !opt_debug )
      goto LABEL_5;
...
LABEL_30:
      LOWORD(v14) = 3828;
      HIWORD(v14) = (unsigned int)"d:%02d" >> 16;
      snprintf(tmp42, 0x1000u, v14, "get_asic_response", v3);
      applog(7, tmp42, 0);
      goto LABEL_5;
    }
LABEL_53:
