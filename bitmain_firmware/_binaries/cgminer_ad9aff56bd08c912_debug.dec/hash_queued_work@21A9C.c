...
LABEL_4:
      ...
      if ( pthread_rwlock_wrlock(&cgpu->qlock) )
      {
        ...
        LOWORD(v13) = -1020;
        LOWORD(v14) = -3136;
        HIWORD(v13) = (unsigned int)"d_rwlock_init errno=%d in %s %s():%d" >> 16;
        HIWORD(v14) = (unsigned int)"iner" >> 16;
        snprintf(tmp42, 0x1000u, v13, *v12, v14, "fill_queue", 8763);
        goto LABEL_28;
      }
...
LABEL_31:
        ...
        snprintf(tmp42, 0x1000u, v17, *v15, v16, "fill_queue", 8770);
LABEL_28:
        applog(3, tmp42, 1);
        _quit(1, 1);
      }
...
LABEL_21:
  ...
  {
    LOWORD(v18) = 3416;
    HIWORD(v18) = (unsigned int)" (1m):%s (5m):%s (15m):%s (avg):%sh/s" >> 16;
    snprintf(tmp42, 0x1000u, v18, drv->name, cgpu->device_id);
    applog(3, tmp42, 0);
  }
