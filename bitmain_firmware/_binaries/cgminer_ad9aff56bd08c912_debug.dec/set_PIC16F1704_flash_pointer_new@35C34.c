...
int __fastcall set_PIC16F1704_flash_pointer_new(unsigned __int8 flash_addr_h, unsigned __int8 flash_addr_l)
{
  ...
  unsigned __int8 v12; // [sp+15h] [bp-1007h]
  char v13; // [sp+16h] [bp-1006h]
  char v14; // [sp+17h] [bp-1005h]
  char tmp42[4100]; // [sp+18h] [bp-1004h] BYREF

  flash_addr_ha = flash_addr_h;
  v14 = flash_addr_l + 7 + flash_addr_h;
  v13 = (unsigned __int16)(flash_addr_l + 7 + flash_addr_h) >> 8;
  v12 = flash_addr_l;
  v10 = 17214037;
  v2 = (char *)&v10 + 1;
  ...
  if ( v7 )
  {
    ...
    {
      LOWORD(v9) = -30676;
      HIWORD(v9) = (unsigned int)"a[2] = 0x%02x, read_back_data[3] = 0x%02x\n" >> 16;
      snprintf(tmp42, 0x1000u, v9, "set_PIC16F1704_flash_pointer_new");
      applog(5, tmp42, 0);
      return 1;
    }
    else
