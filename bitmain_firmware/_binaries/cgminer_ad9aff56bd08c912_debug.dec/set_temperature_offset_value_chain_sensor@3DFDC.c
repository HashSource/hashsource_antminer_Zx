void __fastcall set_temperature_offset_value_chain_sensor(unsigned __int8 which_chain, unsigned __int8 which_sensor)
{
  ...
  if ( v4[3508] == v5 )
  {
    ...
    {
      LOWORD(v7) = -23600;
      HIWORD(v7) = (unsigned int)" temp offset value set error. It should be %02d, but read back is %02d\n" >> 16;
      snprintf(tmp42, 0x1000u, v7, "set_temperature_offset_value_chain_sensor", v2, v3, v4[3508]);
      applog(5, tmp42, 0);
    }
  }
  ...
  {
    LOWORD(v6) = -23692;
    HIWORD(v6) = (unsigned int)"ll" >> 16;
    snprintf(tmp42, 0x1000u, v6, "set_temperature_offset_value_chain_sensor", v2, v3, v5, v4[3508]);
    applog(3, tmp42, 0);
  }
}
