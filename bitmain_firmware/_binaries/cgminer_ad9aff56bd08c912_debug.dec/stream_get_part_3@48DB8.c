  ...
  else
  {
    ...
    if ( (unsigned int)(v7 - 128) <= 0x7F )
    {
      ...
      if ( v13 <= 1 )
      {
        LOWORD(v20) = -19996;
        LOWORD(v21) = -19908;
        HIWORD(v20) = (unsigned int)"scan_number" >> 16;
        HIWORD(v21) = (unsigned int)"os > 0" >> 16;
        _assert_fail(v21, v20, 0xAFu, "stream_get");
      }
...
LABEL_20:
        ...
        a1->stream.state = -2;
        v8 = -2;
        HIWORD(v18) = (unsigned int)"am->buffer[stream->buffer_pos] == c" >> 16;
        error_set(a2, a1, v18, v19);
        return v8;
      }
