int __fastcall phy_internal_bist_rvn(int a1, int a2, unsigned int a3, int a4)
{
  ...
  sub_98E68(a1, a3, 133, 255);
  usleep(0x64u);
  sub_98E68(a1, a3, 134, 255);
  usleep(0x64u);
  sub_98E68(a1, a3, 132, -2147483647);
  sleep(6u);
