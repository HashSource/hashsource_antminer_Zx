int __fastcall phy_pll_switch(int a1, int a2, int a3, int a4)
{
  ...
  sub_75DB4(a1, a3, 82, -1431655766);
  usleep(0x12Cu);
  sub_75DB4(a1, a3, 83, 16711935);
  if ( check_core_reg_with_expect_data(a1, a2, a3, 83, 0) )
    sub_7625C(a1, a3, (int)"check phy pstate 01");
  if ( a4 == 1 )
  {
    sub_75DB4(a1, a3, 86, 137955337);
    usleep(0x64u);
  }
  v8 = (char *)&v12 + 1;
  v9 = 91;
  ...
  while ( 1 )
  {
    sub_75DB4(a1, a3, v9, (a4 << 16) | (a4 << 24) | a4 | (a4 << 8));
    usleep(0x64u);
    if ( v8 == &vars0 )
      break;
  ...
  sub_75DB4(a1, a3, 83, 16711935);
  if ( check_core_reg_with_expect_data(a1, a2, a3, 83, 0) )
    sub_7625C(a1, a3, (int)"work mode select");
  sub_75DB4(a1, a3, 82, 0);
  sub_75DB4(a1, a3, 83, 16711935);
  if ( check_core_reg_with_expect_data(a1, a2, a3, 83, 0) )
    sub_7625C(a1, a3, (int)"check phy pstate 02");
