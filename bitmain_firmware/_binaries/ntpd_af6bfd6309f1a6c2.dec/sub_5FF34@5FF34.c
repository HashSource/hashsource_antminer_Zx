int sub_5FF34()
{
  ...
  if ( sys_residual < 0.0 )
  {
    ...
    v3 = -sub_8C010(LODWORD(v20), HIDWORD(v20));
  }
  else
  {
    ldexp(NAN, _stack_chk_guard);
    v3 = sub_8C010(LODWORD(v2), HIDWORD(v2));
  }
  v5 = v3;
  LODWORD(v3) = 32;
  ldexp(*(double *)&v3, v4);
  if ( v1 < 0.0 )
    v6 = -sub_8C010(COERCE_UNSIGNED_INT64(-v1), HIDWORD(COERCE_UNSIGNED_INT64(-v1)));
  else
    v6 = sub_8C010(LODWORD(v1), HIDWORD(v1));
  v7 = v5 + v6;
  ...
  v12 = sub_8BFD0(500000000, tv_nsec, 1000000000, 0);
  v13 = __CFADD__(v7, v12);
  v14 = v7 + v12;
  sub_65844((int)&v21, v8 + v9 + tv_sec + v13, &timer);
  v15 = (unsigned int)&unk_F4240 * (unsigned __int64)v14 + 0x80000000;
  v16 = v21;
  if ( (_UNKNOWN *)HIDWORD(v15) == &unk_F4240 )
  {
    v16 = v21 + 1;
    HIDWORD(v15) = 0;
  }
