char *__fastcall sub_648EC(char *result, char *s)
{
  char *v2; // r9
  int v4; // r5
  bool v5; // zf
  ...
  if ( msyslog_include_timestamp )
    v12 = (const char *)sub_78740(result);
  else
    v12 = 0;
  ...
  if ( v7 )
  {
    ...
    if ( msyslog_term_pid )
      _fprintf_chk(v10, 1, "%s[%d]: ", (const char *)dword_10710C, v8);
  ...
  if ( v6 )
  {
    ...
    _fprintf_chk(v11, 1, "%s[%d]: %s%s", (const char *)dword_10710C, v8, s, v9);
