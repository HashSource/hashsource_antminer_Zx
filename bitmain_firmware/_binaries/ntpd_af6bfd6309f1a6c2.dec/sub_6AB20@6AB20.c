...
LABEL_67:
    ...
    LODWORD(a1) = sub_6A520(v82, v7, a2, v83, a3, v28, a5);
    return LODWORD(a1);
  }
LABEL_7:
  v9 = -v6;
...
LABEL_35:
    ...
    a1 = COERCE_DOUBLE(sub_8BEC4(v17, HIDWORD(v17)));
    if ( v16 < a1 )
      --v17;
    if ( v17 == -1 )
    {
LABEL_94:
    ...
    for ( ; v18; v19 = v19 / 10.0 )
      ++v18;
    v20 = sub_8C010(LODWORD(v19), HIDWORD(v19));
    v21 = v16 - COERCE_DOUBLE(sub_8BEC4(v17, HIDWORD(v17)));
    a1 = COERCE_DOUBLE(sub_8BEC4(v20, HIDWORD(v20)));
    v22 = v21 * a1;
    if ( v22 < 1.84467441e19 )
    {
      v84 = sub_8C010(LODWORD(v22), HIDWORD(v22));
      a1 = COERCE_DOUBLE(sub_8BEC4(v84, HIDWORD(v84)));
      v23 = a1;
      v24 = v84;
      if ( v22 < a1 )
      {
        v85 = v84 - 1;
        a1 = COERCE_DOUBLE(sub_8BEC4(v85, HIDWORD(v85)));
        v24 = v85;
        v23 = a1;
      }
      if ( v22 - v23 >= 0.5 )
...
LABEL_211:
  ...
  {
    v74 = v73 + 1;
    sub_8BFD0(i, v72, 10, 0);
    v93[v73] = a0123456789abcd_2[v75];
    v73 = 1;
    v76 = sub_8BFD0(i, v72, 10, 0);
    v77 = v74 <= 1;
    i = v76;
    if ( !v76 )
      v77 = 0;
...
LABEL_96:
  ...
  do
  {
    sub_8BFD0(v17, HIDWORD(v17), 10, 0);
    ++v35;
    *v34++ = a0123456789abcd_2[v36];
    LODWORD(v37) = sub_8BFD0(v17, HIDWORD(v17), 10, 0);
  ...
  if ( v91 )
  {
    ...
    do
    {
      sub_8BFD0(v64, HIDWORD(v64), 10, 0);
      ++v66;
      *v65++ = a0123456789abcd_2[v67];
      v41 = sub_8BFD0(v64, HIDWORD(v64), 10, 0);
      v68 = v41 | HIDWORD(v41);
