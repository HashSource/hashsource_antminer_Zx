int __fastcall sub_72648(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, unsigned __int8 *a9, int *a10)
{
  int result; // r0
  int v12; // r11
  int v13; // r0
  ...
  if ( !v27 && *(_DWORD *)a1 != 1281586296 )
    sub_6ECC0(
      ...
      " << 16 | ('t') << 8 | ('x')))))");
  if ( !a2 )
    sub_6ECC0((int)"./../lib/isc/log.c", 1425, 0, "category != ((void *)0)");
  if ( !a3 )
    sub_6ECC0((int)"./../lib/isc/log.c", 1426, 0, "module != ((void *)0)");
  if ( !a4 )
    sub_6ECC0((int)"./../lib/isc/log.c", 1427, 0, "level != 0");
  if ( !a9 )
    sub_6ECC0((int)"./../lib/isc/log.c", 1428, 0, "format != ((void *)0)");
  if ( a1 )
  {
    if ( *(_DWORD *)(a2 + 4) >= *(_DWORD *)(a1 + 12) )
      sub_6ECC0((int)"./../lib/isc/log.c", 1438, 0, "category->id < lctx->category_count");
    if ( *(_DWORD *)(a3 + 4) >= *(_DWORD *)(a1 + 20) )
      sub_6ECC0((int)"./../lib/isc/log.c", 1439, 0, "module->id < lctx->module_count");
    result = sub_725B8(a1, a4);
    if ( result )
    {
      if ( a6 )
        v77 = (unsigned __int8 *)sub_73830(a6, a7, a8, a9);
      ...
      *(_BYTE *)(a1 + 56) = 0;
      ...
      while ( 1 )
      {
        ...
        if ( (v29 & 2) != 0 && !v89[0] )
        {
          if ( a4 < -5 )
          {
            v67 = (const char *)sub_73830(isc_msgcat, 10, 802, "level");
            sub_6C054((int)v89, 0x18u, "%s %d: ", v67, a4);
          }
          else if ( a4 <= 0 )
          {
            sub_6C054((int)v89, 0x18u, "%s: ", (const char *)*(&off_B51E8 - a4));
          }
          else
          {
            sub_6C054((int)v89, 0x18u, "%s %d: ", "debug", a4);
          }
        }
        v16 = *(unsigned __int8 *)(a1 + 56);
        if ( !*(_BYTE *)(a1 + 56) )
        {
          sub_6B6F8(a1 + 56, 0x2000u, v77, a10);
          if ( a5 )
          {
            sub_75CAC(v86, *(_DWORD *)(v75 + 24), v16);
            if ( sub_75FE8(v83) )
              sub_6F61C("./../lib/isc/log.c", 1562, "isc_time_now((&oldest)) == 0");
            if ( !sub_765A8(v83, v86, v83) )
            {
              v52 = *(_DWORD *)(a1 + 8248);
              while ( v52 )
              {
                while ( sub_76378(v52 + 4, v83) >= 0 )
                {
                ...
                else
                {
                  if ( *(_DWORD *)(a1 + 8252) != v52 )
                    sub_6ECC0((int)"./../lib/isc/log.c", 1592, 2, "(lctx->messages).tail == (message)");
                  v69 = *(_DWORD *)(v52 + 12);
                  *(_DWORD *)(a1 + 8252) = v69;
                }
                if ( v69 )
                ...
                else
                {
                  if ( *(_DWORD *)(a1 + 8248) != v52 )
                    sub_6ECC0((int)"./../lib/isc/log.c", 1592, 2, "(lctx->messages).head == (message)");
                  *(_DWORD *)(a1 + 8248) = v68;
                }
                v70 = (void *)v52;
                v52 = v68;
...
LABEL_86:
            ...
            v54 = (char *)sub_63BA4(0, v53 + 21, 0, 0);
            v55 = v54;
            if ( v54 )
            {
              *(_DWORD *)v54 = v54 + 20;
              sub_6D4DC(v54 + 20, (unsigned __int8 *)(a1 + 56), v53 + 1);
              if ( sub_75FE8(v55 + 4) )
        ...
        if ( *(_DWORD *)(v28 + 40) )
        {
          ...
          *(_DWORD *)(v28 + 40) = 0;
          if ( v31 != 3 )
            sub_6ECC0((int)"./../lib/isc/log.c", 1326, 0, "channel->type == 3");
        }
        else
        {
          v24 = *(_DWORD *)(v28 + 16);
        ...
        v32 = *(_BYTE **)(v28 + 20);
        if ( !v32 || !*v32 )
          sub_6ECC0((int)"./../lib/isc/log.c", 1331, 0, "path != ((void *)0) && *path != '\\0'");
        v79 = *(_DWORD *)(v28 + 20);
...
LABEL_144:
        v71 = sub_75654(v35, &off_99960, v28 + 16, v34);
        v72 = v71 == 0;
        if ( v71 )
          v72 = v71 == 58;
        v80 = v71;
...
LABEL_109:
          ...
          {
            if ( *(_DWORD *)(v28 + 4) != 3 )
              sub_6ECC0((int)"./../lib/isc/log.c", 1723, 2, "channel->type == 3");
