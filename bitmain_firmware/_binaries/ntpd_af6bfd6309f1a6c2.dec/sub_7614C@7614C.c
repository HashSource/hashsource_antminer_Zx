int __fastcall sub_7614C(int *a1, int *a2)
{
  ...
  if ( !a1 )
    sub_6ECC0((int)"./../lib/isc/unix/time.c", 192, 0, "t != ((void *)0)");
  if ( !a2 )
    sub_6ECC0((int)"./../lib/isc/unix/time.c", 193, 0, "i != ((void *)0)");
  if ( (unsigned int)a2[1] > 0x3B9AC9FF )
    sub_6ECC0((int)"./../lib/isc/unix/time.c", 194, 2, "i->nanoseconds < 1000000000");
