int __fastcall sub_525FC(_DWORD *a1)
{
  const char *v2; // r5
  const char *v3; // r7
  char *v4; // r0
  ...
  v2 = (const char *)a1[5];
  if ( a1[1] != 3 )
    off_7C9FC("./../lib/isc/log.c", 1156, 0, "channel->type == 3");
  v3 = (const char *)a1[5];
  v4 = strrchr(v3, 47);
  if ( v4 )
  {
