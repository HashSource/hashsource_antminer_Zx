int __fastcall sub_13DD8(_DWORD *a1, int *a2)
{
  int tv_usec; // r3
  int v5; // r12
  __time_t v6; // r2
  ...
  if ( !a1 )
    off_21DCC("./../lib/isc/unix/time.c", 192, 0, "t != ((void *)0)");
  if ( !a2 )
    off_21DCC("./../lib/isc/unix/time.c", 193, 0, "i != ((void *)0)");
  if ( (unsigned int)a2[1] > 0x3B9AC9FF )
    off_21DCC("./../lib/isc/unix/time.c", 194, 2, "i->nanoseconds < 1000000000");
  if ( gettimeofday(&v17, 0) == -1 )
  {
    v13 = _errno_location();
    sub_F7AC((char *)*v13, v18, 0x80u, v14);
    sub_FF48("./../lib/isc/unix/time.c", 198, "%s", v18);
    return 34;
  }
  tv_usec = v17.tv_usec;
  if ( v17.tv_usec < 0 )
