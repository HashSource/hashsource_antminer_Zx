int __fastcall sub_DB3C(const struct timeval *a1, const struct timezone *a2)
{
  __int64 v4; // r4
  int v5; // r8
  bool v6; // zf
  ...
  if ( dword_21F80 )
    puts("In ntp_set_tod");
  HIDWORD(v4) = dword_23FD4;
  if ( (unsigned int)dword_23FD4 <= 1 )
  {
    v13 = 1000 * a1->tv_usec;
    tp.tv_sec = a1->tv_sec;
    tp.tv_nsec = v13;
...
LABEL_10:
  if ( dword_21F80 )
  {
    HIDWORD(v4) = off_172FC[dword_23FD4];
    v8 = strerror(v5);
  ...
  {
    off_23FD8(off_172FC[dword_23FD4]);
    off_23FD8 = 0;
  }
  return v4;
}
