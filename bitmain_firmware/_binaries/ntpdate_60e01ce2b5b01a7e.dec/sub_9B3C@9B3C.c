int __fastcall sub_9B3C(const char *a1, int a2, _DWORD *a3)
{
  int v6; // r5
  ...
  if ( !a1 )
    sub_1073C("is_ip_address.c", 40, 0, "host != ((void *)0)");
  if ( !a3 )
    sub_1073C("is_ip_address.c", 41, 0, "addr != ((void *)0)");
  *a3 = 0;
  v6 = a2 == 0;
  a3[1] = 0;
  a3[2] = 0;
