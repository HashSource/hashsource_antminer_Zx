int __fastcall sub_9DCC(const struct timeval *a1, const struct timezone *a2)
{
  int *v4; // r6
  int v5; // r8
  int v6; // r3
  ...
  *v4 = 0;
  ...
  {
    v18 = *v4;
    sub_A750("ntp_set_tod: clock_settime: %d %m\n", v13);
    v5 = dword_33304;
    v6 = v18;
    if ( !(v7 | dword_33304) )
      goto LABEL_20;
...
LABEL_16:
    *v4 = v6;
    if ( debug > 0 )
      sub_A750("ntp_set_tod: Final result: %s: %d %m\n", set_tod_used[dword_33304], 0);
    goto LABEL_26;
  }
LABEL_6:
  if ( (v5 & 0xFFFFFFFD) != 0 )
  ...
  *v4 = v5 & 0xFFFFFFFD;
  ...
  v17 = *v4;
  sub_A750("ntp_set_tod: settimeofday: %d %m\n", v10);
  v6 = v17;
  v5 = dword_33304;
  if ( !(v7 | dword_33304) )
  {
...
LABEL_36:
  ...
  *v4 = 0;
  ...
  {
    v16 = *v4;
    sub_A750("ntp_set_tod: stime: %d %m\n", v15);
    v6 = v16;
    v5 = dword_33304;
  }
  *v4 = v6;
