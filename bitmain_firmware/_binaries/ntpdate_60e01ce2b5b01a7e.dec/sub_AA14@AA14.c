int __fastcall sub_AA14(const char *a1, int a2)
{
  const char *v2; // r5
  int result; // r0
  int v5; // r0
  ...
  v2 = a1;
  if ( !a1 )
    sub_1073C("msyslog.c", 469, 0, "fname != ((void *)0)");
  if ( syslog_file )
  {
    if ( syslog_fname )
    {
    ...
    if ( strcmp(v2, "stdout") )
    {
      ...
      else if ( v2 != (const char *)v7 && *v2 != 47 && getcwd(buf, 0x200u) )
      {
        ...
        if ( v8 > 1 && buf[v8 - 1] == 47 )
          v9 = v8 - 1;
        v14 = strlen(v2) + v9 + 2;
        v10 = (char *)sub_967C(0, v14, 0, 0);
        sub_F5F4(v10, v14, "%.*s%c%s", v9, buf, 47, v2);
        goto LABEL_18;
      }
      v10 = (char *)sub_97E0(v2);
LABEL_18:
      if ( debug > 0 )
        sub_A750("attempting to open log %s\n", v10);
      v11 = (FILE *)fopen64(v10, "a");
      goto LABEL_21;
    }
    v6 = (FILE ***)&stdout_ptr;
  }
...
LABEL_21:
  if ( v11 )
  {
    if ( a2 && (syslogit || (const char *)syslog_abs_fname != v2) )
      sub_A828(&byte_5, "switching logging to file %s", v10);
