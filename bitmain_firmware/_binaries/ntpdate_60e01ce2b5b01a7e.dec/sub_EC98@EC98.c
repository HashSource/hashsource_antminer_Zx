unsigned int __fastcall sub_EC98(int a1, unsigned int a2, unsigned __int8 *a3, int *a4)
{
  int v4; // lr
  unsigned int v6; // r7
  int v7; // lr
...
LABEL_74:
          ...
          case 'i':
            ...
            sub_DC5C(a1, &v43, v8, 10, v39, 10, v10, v14, HIDWORD(v14));
            break;
          case 'e':
LABEL_72:
            v26 = ((unsigned int)a4 + 7) & 0xFFFFFFF8;
            sub_E0C0(COERCE_DOUBLE(__PAIR64__(&v43, a1)), v8, v10, v14, HIDWORD(v14) | 0x200, &v44);
            goto LABEL_69;
          case 'g':
LABEL_65:
            v26 = ((unsigned int)a4 + 7) & 0xFFFFFFF8;
...
LABEL_68:
            LODWORD(v14) = a1;
            sub_E0C0(*(double *)&v14, v28, v27, v42, HIDWORD(v42), &v44);
LABEL_69:
            v16 = v44;
            a4 = (int *)(v26 + 8);
            if ( !v44 )
          ...
          case 'p':
            v32 = *a4++;
            if ( v32 )
              sub_DC5C(a1, &v43, v8, v32, (unsigned int)v32, 16, v10, v14, HIDWORD(v14) | 0x88);
            else
              sub_DAC0(a1, (int *)&v43, v8, "(nil)", v10, -1, SBYTE4(v14));
            break;
          case 's':
            v35 = (const char *)*a4++;
            sub_DAC0(a1, (int *)&v43, v8, v35, v10, v14, SBYTE4(v14));
            break;
          case 'u':
            v25 = 10;
            goto LABEL_63;
...
LABEL_63:
            ...
            sub_DC5C(a1, &v43, v8, v25, v30, v25, v10, v14, HIDWORD(v14));
            break;
          default:
            break;
        }
